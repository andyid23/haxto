...
<multiple-choice question="Apa kekurangan utama dari metode Membaca Vertikal dalam mengevaluasi informasi digital?" single-option="" randomize="" max-attempts="0" typeof="oer:Assessment" resource="#61697532-a004-cf10-f293-175bf8b1eada" prefix="oer:http://oerschema.org/ schema:http://schema.org/ dc:http://purl.org/dc/terms/ foaf:http://xmlns.com/foaf/0.1/ cc:http://creativecommons.org/ns# bib:http://bib.schema.org " quiz-name="default" data-hax-lock="data-hax-lock"><input type="checkbox" value="Membutuhkan waktu yang terlalu lama untuk membaca"><input type="checkbox" value="Hanya dapat digunakan untuk situs berbahasa Indonesia"><input type="checkbox" value="Mengandalkan elemen visual internal yang mudah dipalsukan" correct="correct"><input type="checkbox" value="Tidak dapat digunakan pada situs dengan protokol HTTPS"></multiple-choice>
...
<multiple-choice question="Metode triangulasi dalam verifikasi informasi bertujuan untuk..." single-option="" randomize="" max-attempts="0" typeof="oer:Assessment" resource="#61697532-a004-cf10-f293-175bf8b1eada" prefix="oer:http://oerschema.org/ schema:http://schema.org/ dc:http://purl.org/dc/terms/ foaf:http://xmlns.com/foaf/0.1/ cc:http://creativecommons.org/ns# bib:http://bib.schema.org " quiz-name="default" data-hax-lock="data-hax-lock"><input type="checkbox" value="Mempercepat proses pencarian informasi di internet"><input type="checkbox" value="Memperkuat validitas data dengan membandingkan beberapa sumber" correct="correct"><input type="checkbox" value="Menghindari penggunaan situs dengan protokol HTTPS"><input type="checkbox" value="Membuat konten menjadi lebih menarik secara visual"></multiple-choice>
...
<multiple-choice question="Mengapa metadata EXIF pada gambar tidak boleh dipercaya secara mutlak?" single-option="" randomize="" max-attempts="0" typeof="oer:Assessment" resource="#61697532-a004-cf10-f293-175bf8b1eada" prefix="oer:http://oerschema.org/ schema:http://schema.org/ dc:http://purl.org/dc/terms/ foaf:http://xmlns.com/foaf/0.1/ cc:http://creativecommons.org/ns# bib:http://bib.schema.org " quiz-name="default" data-hax-lock="data-hax-lock"><input type="checkbox" value="Karena metadata EXIF tidak pernah tersedia di file gambar digital"><input type="checkbox" value="Karena metadata EXIF sangat rentan dihapus atau dimanipulasi" correct="correct"><input type="checkbox" value="Karena metadata EXIF hanya tersedia pada foto yang diambil dengan kamera profesional"><input type="checkbox" value="Karena metadata EXIF tidak mengandung informasi yang berguna"></multiple-choice>
...
<multiple-choice question="Protokol HTTPS menjamin hal berikut, KECUALI..." single-option="" randomize="" max-attempts="0" typeof="oer:Assessment" resource="#61697532-a004-cf10-f293-175bf8b1eada" prefix="oer:http://oerschema.org/ schema:http://schema.org/ dc:http://purl.org/dc/terms/ foaf:http://xmlns.com/foaf/0.1/ cc:http://creativecommons.org/ns# bib:http://bib.schema.org " quiz-name="default" data-hax-lock="data-hax-lock"><input type="checkbox" value="Keamanan transmisi data dari penyadapan pihak ketiga"><input type="checkbox" value="Penggunaan enkripsi SSL/TLS untuk melindungi data"><input type="checkbox" value="Kebenaran dan validitas informasi di dalam situs" correct="correct"><input type="checkbox" value="Perlindungan data antara klien dan server"></multiple-choice>
