...
<multiple-choice question="Which is correct?" single-option="" randomize="" max-attempts="0" typeof="oer:Assessment" resource="#61697532-a004-cf10-f293-175bf8b1eada" prefix="oer:http://oerschema.org/ schema:http://schema.org/ dc:http://purl.org/dc/terms/ foaf:http://xmlns.com/foaf/0.1/ cc:http://creativecommons.org/ns# bib:http://bib.schema.org " quiz-name="default"><input type="checkbox" value="Answer 1" correct="correct"><input type="checkbox" value="Another potential answer"></multiple-choice>

    <multiple-choice-question randomize="" question="Apa kekurangan utama dari metode Membaca Vertikal dalam mengevaluasi informasi digital?"><input type="radio" value="Membutuhkan waktu yang terlalu lama untuk membaca"> <input type="radio" value="Hanya dapat digunakan untuk situs berbahasa Indonesia"> <input type="radio" value="Mengandalkan elemen visual internal yang mudah dipalsukan" correct="correct"> <input type="radio" value="Tidak dapat digunakan pada situs dengan protokol HTTPS"> </multiple-choice-question><multiple-choice-question randomize="" question="Metode triangulasi dalam verifikasi informasi bertujuan untuk..."><input type="radio" value="Mempercepat proses pencarian informasi di internet"> <input type="radio" value="Memperkuat validitas data dengan membandingkan beberapa sumber" correct="correct"> <input type="radio" value="Menghindari penggunaan situs dengan protokol HTTPS"> <input type="radio" value="Membuat konten menjadi lebih menarik secara visual"> </multiple-choice-question><multiple-choice-question randomize="" question="Mengapa metadata EXIF pada gambar tidak boleh dipercaya secara mutlak?"><input type="radio" value="Karena metadata EXIF tidak pernah tersedia di file gambar digital"> <input type="radio" value="Karena metadata EXIF sangat rentan dihapus atau dimanipulasi" correct="correct"> <input type="radio" value="Karena metadata EXIF hanya tersedia pada foto yang diambil dengan kamera profesional"> <input type="radio" value="Karena metadata EXIF tidak mengandung informasi yang berguna"> </multiple-choice-question><multiple-choice-question randomize="" question="Protokol HTTPS menjamin hal berikut, KECUALI..."><input type="radio" value="Keamanan transmisi data dari penyadapan pihak ketiga"> <input type="radio" value="Penggunaan enkripsi SSL/TLS untuk melindungi data"> <input type="radio" value="Kebenaran dan validitas informasi di dalam situs" correct="correct"> <input type="radio" value="Perlindungan data antara klien dan server"> </multiple-choice-question><multiple-choice-question randomize="" question="Jika Anda menemukan data statistik yang kontradiktif dari dua kementerian resmi, tindakan yang tepat adalah..."><input type="radio" value="Memilih data dari kementerian yang lebih terkenang"> <input type="radio" value="Mengabaikan kedua data tersebut dan mencari sumber lain"> <input type="radio" value="Memeriksa metodologi pengumpulan data dan konteks dari kedua sumber" correct="correct"> <input type="radio" value="Mengambil rata-rata dari kedua data tersebut"></multiple-choice-question>