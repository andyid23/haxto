...
/**
 * `CustomHaxkuisTheme`
 * `CustomHaxkuisTheme based on modern flex design system`
 ...
 * @element custom-haxkuis-theme
 */
class CustomHaxkuisTheme extends PolarisFlexTheme {
  //styles function
  static get styles() {
    return [
      super.styles,
...
customElements.define(CustomHaxkuisTheme.tag, CustomHaxkuisTheme);
export { CustomHaxkuisTheme };
