import{css as Ie,html as ht}from"@haxtheweb/haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{PolarisFlexTheme as Ce}from"@haxtheweb/polaris-theme/lib/polaris-flex-theme.js";import"@haxtheweb/haxcms-elements/lib/ui-components/blocks/site-children-block.js";import{DDDSuper as j}from"@haxtheweb/d-d-d/d-d-d.js";import{I18NMixin as O}from"@haxtheweb/i18n-manager/lib/I18NMixin.js";let Pt=class extends Ce{static get styles(){return[super.styles,Ie`
        :host {
          display: block;
        }
        aside {
      ...
      `]}renderHeaderSlot(){return ht``}renderSideBar(){return ht`
    <aside
          role="complementary"
    ...
    `}renderFooterContactInformation(){return ht``}renderFooterSecondarySlot(){return ht``}renderFooterPrimarySlot(){return ht``}static get tag(){return"custom-haxkuis-theme"}constructor(){super()}};customElements.define(Pt.tag,Pt);/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const yt=globalThis,Mt=yt.ShadowRoot&&(yt.ShadyCSS===void 0||yt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,It=Symbol(),Bt=new WeakMap;let jt=class{constructor(t,e,a){if(this._$cssResult$=!0,a!==It)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(Mt&&t===void 0){const a=e!==void 0&&e.length===1;a&&(t=Bt.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),a&&Bt.set(e,t))}return t}toString(){return this.cssText}};const Te=p=>new jt(typeof p=="string"?p:p+"",void 0,It),z=(p,...t)=>{const e=p.length===1?p[0]:t.reduce((a,i,r)=>a+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+p[r+1],p[0]);return new jt(e,p,It)},Ee=(p,t)=>{if(Mt)p.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const e of t){const a=document.createElement("style"),i=yt.litNonce;i!==void 0&&a.setAttribute("nonce",i),a.textContent=e.cssText,p.appendChild(a)}},Ot=Mt?p=>p:p=>p instanceof CSSStyleSheet?(t=>{let e="";for(const a of t.cssRules)e+=a.cssText;return Te(e)})(p):p;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:qe,defineProperty:ze,getOwnPropertyDescriptor:Le,getOwnPropertyNames:Ue,getOwnPropertySymbols:Ke,getPrototypeOf:Fe}=Object,G=globalThis,Gt=G.trustedTypes,Ne=Gt?Gt.emptyScript:"",Re=G.reactiveElementPolyfillSupport,ut=(p,t)=>p,Ct={toAttribute(p,t){switch(t){case Boolean:p=p?Ne:null;break;case Object:case Array:p=p==null?p:JSON.stringify(p)}return p},fromAttribute(p,t){let e=p;switch(t){case Boolean:e=p!==null;break;case Number:e=p===null?null:Number(p);break;case Object:case Array:try{e=JSON.parse(p)}catch{e=null}}return e}},Qt=(p,t)=>!qe(p,t),Jt={attribute:!0,type:String,converter:Ct,reflect:!1,useDefault:!1,hasChanged:Qt};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),G.litPropertyMetadata??(G.litPropertyMetadata=new WeakMap);let et=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=Jt){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){const a=Symbol(),i=this.getPropertyDescriptor(t,a,e);i!==void 0&&ze(this.prototype,t,i)}}static getPropertyDescriptor(t,e,a){const{get:i,set:r}=Le(this.prototype,t)??{get(){return this[e]},set(s){this[e]=s}};return{get:i,set(s){const d=i?.call(this);r?.call(this,s),this.requestUpdate(t,d,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Jt}static _$Ei(){if(this.hasOwnProperty(ut("elementProperties")))return;const t=Fe(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(ut("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(ut("properties"))){const e=this.properties,a=[...Ue(e),...Ke(e)];for(const i of a)this.createProperty(i,e[i])}const t=this[Symbol.metadata];if(t!==null){const e=litPropertyMetadata.get(t);if(e!==void 0)for(const[a,i]of e)this.elementProperties.set(a,i)}this._$Eh=new Map;for(const[e,a]of this.elementProperties){const i=this._$Eu(e,a);i!==void 0&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const a=new Set(t.flat(1/0).reverse());for(const i of a)e.unshift(Ot(i))}else t!==void 0&&e.push(Ot(t));return e}static _$Eu(t,e){const a=e.attribute;return a===!1?void 0:typeof a=="string"?a:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const a of e.keys())this.hasOwnProperty(a)&&(t.set(a,this[a]),delete this[a]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ee(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,a){this._$AK(t,a)}_$ET(t,e){const a=this.constructor.elementProperties.get(t),i=this.constructor._$Eu(t,a);if(i!==void 0&&a.reflect===!0){const r=(a.converter?.toAttribute!==void 0?a.converter:Ct).toAttribute(e,a.type);this._$Em=t,r==null?this.removeAttribute(i):this.setAttribute(i,r),this._$Em=null}}_$AK(t,e){const a=this.constructor,i=a._$Eh.get(t);if(i!==void 0&&this._$Em!==i){const r=a.getPropertyOptions(i),s=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:Ct;this._$Em=i;const d=s.fromAttribute(e,r.type);this[i]=d??this._$Ej?.get(i)??d,this._$Em=null}}requestUpdate(t,e,a,i=!1,r){if(t!==void 0){const s=this.constructor;if(i===!1&&(r=this[t]),a??(a=s.getPropertyOptions(t)),!((a.hasChanged??Qt)(r,e)||a.useDefault&&a.reflect&&r===this._$Ej?.get(t)&&!this.hasAttribute(s._$Eu(t,a))))return;this.C(t,e,a)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:a,reflect:i,wrapped:r},s){a&&!(this._$Ej??(this._$Ej=new Map)).has(t)&&(this._$Ej.set(t,s??e??this[t]),r!==!0||s!==void 0)||(this._$AL.has(t)||(this.hasUpdated||a||(e=void 0),this._$AL.set(t,e)),i===!0&&this._$Em!==t&&(this._$Eq??(this._$Eq=new Set)).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[i,r]of this._$Ep)this[i]=r;this._$Ep=void 0}const a=this.constructor.elementProperties;if(a.size>0)for(const[i,r]of a){const{wrapped:s}=r,d=this[i];s!==!0||this._$AL.has(i)||d===void 0||this.C(i,void 0,r,d)}}let t=!1;const e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(a=>a.hostUpdate?.()),this.update(e)):this._$EM()}catch(a){throw t=!1,this._$EM(),a}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&(this._$Eq=this._$Eq.forEach(e=>this._$ET(e,this[e]))),this._$EM()}updated(t){}firstUpdated(t){}};et.elementStyles=[],et.shadowRootOptions={mode:"open"},et[ut("elementProperties")]=new Map,et[ut("finalized")]=new Map,Re?.({ReactiveElement:et}),(G.reactiveElementVersions??(G.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ct=globalThis,Ht=p=>p,wt=ct.trustedTypes,Wt=wt?wt.createPolicy("lit-html",{createHTML:p=>p}):void 0,Vt="$lit$",Q=`lit$${Math.random().toFixed(9).slice(2)}$`,Yt="?"+Q,De=`<${Yt}>`,W=document,pt=()=>W.createComment(""),mt=p=>p===null||typeof p!="object"&&typeof p!="function",Tt=Array.isArray,Pe=p=>Tt(p)||typeof p?.[Symbol.iterator]=="function",Et=`[ 	
\f\r]`,gt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Xt=/-->/g,Zt=/>/g,V=RegExp(`>|${Et}(?:([^\\s"'>=/]+)(${Et}*=${Et}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),te=/'/g,ee=/"/g,ae=/^(?:script|style|textarea|title)$/i,Be=p=>(t,...e)=>({_$litType$:p,strings:t,values:e}),o=Be(1),at=Symbol.for("lit-noChange"),v=Symbol.for("lit-nothing"),ie=new WeakMap,Y=W.createTreeWalker(W,129);function re(p,t){if(!Tt(p)||!p.hasOwnProperty("raw"))throw Error("invalid template strings array");return Wt!==void 0?Wt.createHTML(t):t}const je=(p,t)=>{const e=p.length-1,a=[];let i,r=t===2?"<svg>":t===3?"<math>":"",s=gt;for(let d=0;d<e;d++){const l=p[d];let c,u,m=-1,w=0;for(;w<l.length&&(s.lastIndex=w,u=s.exec(l),u!==null);)w=s.lastIndex,s===gt?u[1]==="!--"?s=Xt:u[1]!==void 0?s=Zt:u[2]!==void 0?(ae.test(u[2])&&(i=RegExp("</"+u[2],"g")),s=V):u[3]!==void 0&&(s=V):s===V?u[0]===">"?(s=i??gt,m=-1):u[1]===void 0?m=-2:(m=s.lastIndex-u[2].length,c=u[1],s=u[3]===void 0?V:u[3]==='"'?ee:te):s===ee||s===te?s=V:s===Xt||s===Zt?s=gt:(s=V,i=void 0);const M=s===V&&p[d+1].startsWith("/>")?" ":"";r+=s===gt?l+De:m>=0?(a.push(c),l.slice(0,m)+Vt+l.slice(m)+Q+M):l+Q+(m===-2?d:M)}return[re(p,r+(p[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),a]};class vt{constructor({strings:t,_$litType$:e},a){let i;this.parts=[];let r=0,s=0;const d=t.length-1,l=this.parts,[c,u]=je(t,e);if(this.el=vt.createElement(c,a),Y.currentNode=this.el.content,e===2||e===3){const m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(i=Y.nextNode())!==null&&l.length<d;){if(i.nodeType===1){if(i.hasAttributes())for(const m of i.getAttributeNames())if(m.endsWith(Vt)){const w=u[s++],M=i.getAttribute(m).split(Q),k=/([.?@])?(.*)/.exec(w);l.push({type:1,index:r,name:k[2],strings:M,ctor:k[1]==="."?Ge:k[1]==="?"?Qe:k[1]==="@"?Je:xt}),i.removeAttribute(m)}else m.startsWith(Q)&&(l.push({type:6,index:r}),i.removeAttribute(m));if(ae.test(i.tagName)){const m=i.textContent.split(Q),w=m.length-1;if(w>0){i.textContent=wt?wt.emptyScript:"";for(let M=0;M<w;M++)i.append(m[M],pt()),Y.nextNode(),l.push({type:2,index:++r});i.append(m[w],pt())}}}else if(i.nodeType===8)if(i.data===Yt)l.push({type:2,index:r});else{let m=-1;for(;(m=i.data.indexOf(Q,m+1))!==-1;)l.push({type:7,index:r}),m+=Q.length-1}r++}}static createElement(t,e){const a=W.createElement("template");return a.innerHTML=t,a}}function it(p,t,e=p,a){if(t===at)return t;let i=a!==void 0?e._$Co?.[a]:e._$Cl;const r=mt(t)?void 0:t._$litDirective$;return i?.constructor!==r&&(i?._$AO?.(!1),r===void 0?i=void 0:(i=new r(p),i._$AT(p,e,a)),a!==void 0?(e._$Co??(e._$Co=[]))[a]=i:e._$Cl=i),i!==void 0&&(t=it(p,i._$AS(p,t.values),i,a)),t}class Oe{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:a}=this._$AD,i=(t?.creationScope??W).importNode(e,!0);Y.currentNode=i;let r=Y.nextNode(),s=0,d=0,l=a[0];for(;l!==void 0;){if(s===l.index){let c;l.type===2?c=new kt(r,r.nextSibling,this,t):l.type===1?c=new l.ctor(r,l.name,l.strings,this,t):l.type===6&&(c=new He(r,this,t)),this._$AV.push(c),l=a[++d]}s!==l?.index&&(r=Y.nextNode(),s++)}return Y.currentNode=W,i}p(t){let e=0;for(const a of this._$AV)a!==void 0&&(a.strings!==void 0?(a._$AI(t,a,e),e+=a.strings.length-2):a._$AI(t[e])),e++}}class kt{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,a,i){this.type=2,this._$AH=v,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=a,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=it(this,t,e),mt(t)?t===v||t==null||t===""?(this._$AH!==v&&this._$AR(),this._$AH=v):t!==this._$AH&&t!==at&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Pe(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==v&&mt(this._$AH)?this._$AA.nextSibling.data=t:this.T(W.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:a}=t,i=typeof a=="number"?this._$AC(t):(a.el===void 0&&(a.el=vt.createElement(re(a.h,a.h[0]),this.options)),a);if(this._$AH?._$AD===i)this._$AH.p(e);else{const r=new Oe(i,this),s=r.u(this.options);r.p(e),this.T(s),this._$AH=r}}_$AC(t){let e=ie.get(t.strings);return e===void 0&&ie.set(t.strings,e=new vt(t)),e}k(t){Tt(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let a,i=0;for(const r of t)i===e.length?e.push(a=new kt(this.O(pt()),this.O(pt()),this,this.options)):a=e[i],a._$AI(r),i++;i<e.length&&(this._$AR(a&&a._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const a=Ht(t).nextSibling;Ht(t).remove(),t=a}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class xt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,a,i,r){this.type=1,this._$AH=v,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=r,a.length>2||a[0]!==""||a[1]!==""?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=v}_$AI(t,e=this,a,i){const r=this.strings;let s=!1;if(r===void 0)t=it(this,t,e,0),s=!mt(t)||t!==this._$AH&&t!==at,s&&(this._$AH=t);else{const d=t;let l,c;for(t=r[0],l=0;l<r.length-1;l++)c=it(this,d[a+l],e,l),c===at&&(c=this._$AH[l]),s||(s=!mt(c)||c!==this._$AH[l]),c===v?t=v:t!==v&&(t+=(c??"")+r[l+1]),this._$AH[l]=c}s&&!i&&this.j(t)}j(t){t===v?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Ge extends xt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===v?void 0:t}}class Qe extends xt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==v)}}class Je extends xt{constructor(t,e,a,i,r){super(t,e,a,i,r),this.type=5}_$AI(t,e=this){if((t=it(this,t,e,0)??v)===at)return;const a=this._$AH,i=t===v&&a!==v||t.capture!==a.capture||t.once!==a.once||t.passive!==a.passive,r=t!==v&&(a===v||i);i&&this.element.removeEventListener(this.name,this,a),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class He{constructor(t,e,a){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(t){it(this,t)}}const We=ct.litHtmlPolyfillSupport;We?.(vt,kt),(ct.litHtmlVersions??(ct.litHtmlVersions=[])).push("3.3.3");const Ve=(p,t,e)=>{const a=e?.renderBefore??t;let i=a._$litPart$;if(i===void 0){const r=e?.renderBefore??null;a._$litPart$=i=new kt(t.insertBefore(pt(),r),r,void 0,e??{})}return i._$AI(p),i};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const bt=globalThis;class F extends et{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;const t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ve(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return at}}F._$litElement$=!0,F.finalized=!0,bt.litElementHydrateSupport?.({LitElement:F});const Ye=bt.litElementPolyfillSupport;Ye?.({LitElement:F}),(bt.litElementVersions??(bt.litElementVersions=[])).push("4.2.2");var qt={};(function p(t,e,a,i){var r=!!(t.Worker&&t.Blob&&t.Promise&&t.OffscreenCanvas&&t.OffscreenCanvasRenderingContext2D&&t.HTMLCanvasElement&&t.HTMLCanvasElement.prototype.transferControlToOffscreen&&t.URL&&t.URL.createObjectURL),s=typeof Path2D=="function"&&typeof DOMMatrix=="function",d=(function(){if(!t.OffscreenCanvas)return!1;try{var h=new OffscreenCanvas(1,1),n=h.getContext("2d");n.fillRect(0,0,1,1);var g=h.transferToImageBitmap();n.createPattern(g,"no-repeat")}catch{return!1}return!0})();function l(){}function c(h){var n=e.exports.Promise,g=n!==void 0?n:t.Promise;return typeof g=="function"?new g(h):(h(l,l),null)}var u=(function(h,n){return{transform:function(g){if(h)return g;if(n.has(g))return n.get(g);var f=new OffscreenCanvas(g.width,g.height),_=f.getContext("2d");return _.drawImage(g,0,0),n.set(g,f),f},clear:function(){n.clear()}}})(d,new Map),m=(function(){var h=Math.floor(16.666666666666668),n,g,f={},_=0;return typeof requestAnimationFrame=="function"&&typeof cancelAnimationFrame=="function"?(n=function(y){var S=Math.random();return f[S]=requestAnimationFrame(function b($){_===$||_+h-1<$?(_=$,delete f[S],y()):f[S]=requestAnimationFrame(b)}),S},g=function(y){f[y]&&cancelAnimationFrame(f[y])}):(n=function(y){return setTimeout(y,h)},g=function(y){return clearTimeout(y)}),{frame:n,cancel:g}})(),w=(function(){var h,n,g={};function f(_){function y(S,b){_.postMessage({options:S||{},callback:b})}_.init=function(b){var $=b.transferControlToOffscreen();_.postMessage({canvas:$},[$])},_.fire=function(b,$,I){if(n)return y(b,null),n;var E=Math.random().toString(36).slice(2);return n=c(function(C){function q(L){L.data.callback===E&&(delete g[E],_.removeEventListener("message",q),n=null,u.clear(),I(),C())}_.addEventListener("message",q),y(b,E),g[E]=q.bind(null,{data:{callback:E}})}),n},_.reset=function(){_.postMessage({reset:!0});for(var b in g)g[b](),delete g[b]}}return function(){if(h)return h;if(!a&&r){var _=["var CONFETTI, SIZE = {}, module = {};","("+p.toString()+")(this, module, true, SIZE);","onmessage = function(msg) {","  if (msg.data.options) {","    CONFETTI(msg.data.options).then(function () {","      if (msg.data.callback) {","        postMessage({ callback: msg.data.callback });","      }","    });","  } else if (msg.data.reset) {","    CONFETTI && CONFETTI.reset();","  } else if (msg.data.resize) {","    SIZE.width = msg.data.resize.width;","    SIZE.height = msg.data.resize.height;","  } else if (msg.data.canvas) {","    SIZE.width = msg.data.canvas.width;","    SIZE.height = msg.data.canvas.height;","    CONFETTI = module.exports.create(msg.data.canvas);","  }","}"].join(`
`);try{h=new Worker(URL.createObjectURL(new Blob([_])))}catch(y){return typeof console<"u"&&typeof console.warn=="function"&&console.warn("\u{1F38A} Could not load worker",y),null}f(h)}return h}})(),M={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function k(h,n){return n?n(h):h}function T(h){return h!=null}function x(h,n,g){return k(h&&T(h[n])?h[n]:M[n],g)}function P(h){return h<0?0:Math.floor(h)}function _t(h,n){return Math.floor(Math.random()*(n-h))+h}function tt(h){return parseInt(h,16)}function lt(h){return h.map(ne)}function ne(h){var n=String(h).replace(/[^0-9a-f]/gi,"");return n.length<6&&(n=n[0]+n[0]+n[1]+n[1]+n[2]+n[2]),{r:tt(n.substring(0,2)),g:tt(n.substring(2,4)),b:tt(n.substring(4,6))}}function le(h){var n=x(h,"origin",Object);return n.x=x(n,"x",Number),n.y=x(n,"y",Number),n}function he(h){h.width=document.documentElement.clientWidth,h.height=document.documentElement.clientHeight}function ue(h){var n=h.getBoundingClientRect();h.width=n.width,h.height=n.height}function ce(h){var n=document.createElement("canvas");return n.style.position="fixed",n.style.top="0px",n.style.left="0px",n.style.pointerEvents="none",n.style.zIndex=h,n}function pe(h,n,g,f,_,y,S,b,$){h.save(),h.translate(n,g),h.rotate(y),h.scale(f,_),h.arc(0,0,1,S,b,$),h.restore()}function me(h){var n=h.angle*(Math.PI/180),g=h.spread*(Math.PI/180);return{x:h.x,y:h.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:h.startVelocity*.5+Math.random()*h.startVelocity,angle2D:-n+(.5*g-Math.random()*g),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:h.color,shape:h.shape,tick:0,totalTicks:h.ticks,decay:h.decay,drift:h.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:h.gravity*3,ovalScalar:.6,scalar:h.scalar,flat:h.flat}}function ge(h,n){n.x+=Math.cos(n.angle2D)*n.velocity+n.drift,n.y+=Math.sin(n.angle2D)*n.velocity+n.gravity,n.velocity*=n.decay,n.flat?(n.wobble=0,n.wobbleX=n.x+10*n.scalar,n.wobbleY=n.y+10*n.scalar,n.tiltSin=0,n.tiltCos=0,n.random=1):(n.wobble+=n.wobbleSpeed,n.wobbleX=n.x+10*n.scalar*Math.cos(n.wobble),n.wobbleY=n.y+10*n.scalar*Math.sin(n.wobble),n.tiltAngle+=.1,n.tiltSin=Math.sin(n.tiltAngle),n.tiltCos=Math.cos(n.tiltAngle),n.random=Math.random()+2);var g=n.tick++/n.totalTicks,f=n.x+n.random*n.tiltCos,_=n.y+n.random*n.tiltSin,y=n.wobbleX+n.random*n.tiltCos,S=n.wobbleY+n.random*n.tiltSin;if(h.fillStyle="rgba("+n.color.r+", "+n.color.g+", "+n.color.b+", "+(1-g)+")",h.beginPath(),s&&n.shape.type==="path"&&typeof n.shape.path=="string"&&Array.isArray(n.shape.matrix))h.fill(fe(n.shape.path,n.shape.matrix,n.x,n.y,Math.abs(y-f)*.1,Math.abs(S-_)*.1,Math.PI/10*n.wobble));else if(n.shape.type==="bitmap"){var b=Math.PI/10*n.wobble,$=Math.abs(y-f)*.1,I=Math.abs(S-_)*.1,E=n.shape.bitmap.width*n.scalar,C=n.shape.bitmap.height*n.scalar,q=new DOMMatrix([Math.cos(b)*$,Math.sin(b)*$,-Math.sin(b)*I,Math.cos(b)*I,n.x,n.y]);q.multiplySelf(new DOMMatrix(n.shape.matrix));var L=h.createPattern(u.transform(n.shape.bitmap),"no-repeat");L.setTransform(q),h.globalAlpha=1-g,h.fillStyle=L,h.fillRect(n.x-E/2,n.y-C/2,E,C),h.globalAlpha=1}else if(n.shape==="circle")h.ellipse?h.ellipse(n.x,n.y,Math.abs(y-f)*n.ovalScalar,Math.abs(S-_)*n.ovalScalar,Math.PI/10*n.wobble,0,2*Math.PI):pe(h,n.x,n.y,Math.abs(y-f)*n.ovalScalar,Math.abs(S-_)*n.ovalScalar,Math.PI/10*n.wobble,0,2*Math.PI);else if(n.shape==="star")for(var A=Math.PI/2*3,K=4*n.scalar,N=8*n.scalar,R=n.x,B=n.y,H=5,D=Math.PI/H;H--;)R=n.x+Math.cos(A)*N,B=n.y+Math.sin(A)*N,h.lineTo(R,B),A+=D,R=n.x+Math.cos(A)*K,B=n.y+Math.sin(A)*K,h.lineTo(R,B),A+=D;else h.moveTo(Math.floor(n.x),Math.floor(n.y)),h.lineTo(Math.floor(n.wobbleX),Math.floor(_)),h.lineTo(Math.floor(y),Math.floor(S)),h.lineTo(Math.floor(f),Math.floor(n.wobbleY));return h.closePath(),h.fill(),n.tick<n.totalTicks}function be(h,n,g,f,_){var y=n.slice(),S=h.getContext("2d"),b,$,I=c(function(E){function C(){b=$=null,S.clearRect(0,0,f.width,f.height),u.clear(),_(),E()}function q(){a&&!(f.width===i.width&&f.height===i.height)&&(f.width=h.width=i.width,f.height=h.height=i.height),!f.width&&!f.height&&(g(h),f.width=h.width,f.height=h.height),S.clearRect(0,0,f.width,f.height),y=y.filter(function(L){return ge(S,L)}),y.length?b=m.frame(q):C()}b=m.frame(q),$=C});return{addFettis:function(E){return y=y.concat(E),I},canvas:h,promise:I,reset:function(){b&&m.cancel(b),$&&$()}}}function Ut(h,n){var g=!h,f=!!x(n||{},"resize"),_=!1,y=x(n,"disableForReducedMotion",Boolean),S=r&&!!x(n||{},"useWorker"),b=S?w():null,$=g?he:ue,I=h&&b?!!h.__confetti_initialized:!1,E=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,C;function q(A,K,N){for(var R=x(A,"particleCount",P),B=x(A,"angle",Number),H=x(A,"spread",Number),D=x(A,"startVelocity",Number),_e=x(A,"decay",Number),ye=x(A,"gravity",Number),we=x(A,"drift",Number),Ft=x(A,"colors",lt),xe=x(A,"ticks",Number),Nt=x(A,"shapes"),Se=x(A,"scalar"),$e=!!x(A,"flat"),Rt=le(A),Dt=R,At=[],Ae=h.width*Rt.x,Me=h.height*Rt.y;Dt--;)At.push(me({x:Ae,y:Me,angle:B,spread:H,startVelocity:D,color:Ft[Dt%Ft.length],shape:Nt[_t(0,Nt.length)],ticks:xe,decay:_e,gravity:ye,drift:we,scalar:Se,flat:$e}));return C?C.addFettis(At):(C=be(h,At,$,K,N),C.promise)}function L(A){var K=y||x(A,"disableForReducedMotion",Boolean),N=x(A,"zIndex",Number);if(K&&E)return c(function(D){D()});g&&C?h=C.canvas:g&&!h&&(h=ce(N),document.body.appendChild(h)),f&&!I&&$(h);var R={width:h.width,height:h.height};b&&!I&&b.init(h),I=!0,b&&(h.__confetti_initialized=!0);function B(){if(b){var D={getBoundingClientRect:function(){if(!g)return h.getBoundingClientRect()}};$(D),b.postMessage({resize:{width:D.width,height:D.height}});return}R.width=R.height=null}function H(){C=null,f&&(_=!1,t.removeEventListener("resize",B)),g&&h&&(document.body.contains(h)&&document.body.removeChild(h),h=null,I=!1)}return f&&!_&&(_=!0,t.addEventListener("resize",B,!1)),b?b.fire(A,R,H):q(A,R,H)}return L.reset=function(){b&&b.reset(),C&&C.reset()},L}var $t;function Kt(){return $t||($t=Ut(null,{useWorker:!0,resize:!0})),$t}function fe(h,n,g,f,_,y,S){var b=new Path2D(h),$=new Path2D;$.addPath(b,new DOMMatrix(n));var I=new Path2D;return I.addPath($,new DOMMatrix([Math.cos(S)*_,Math.sin(S)*_,-Math.sin(S)*y,Math.cos(S)*y,g,f])),I}function ve(h){if(!s)throw new Error("path confetti are not supported in this browser");var n,g;typeof h=="string"?n=h:(n=h.path,g=h.matrix);var f=new Path2D(n),_=document.createElement("canvas"),y=_.getContext("2d");if(!g){for(var S=1e3,b=S,$=S,I=0,E=0,C,q,L=0;L<S;L+=2)for(var A=0;A<S;A+=2)y.isPointInPath(f,L,A,"nonzero")&&(b=Math.min(b,L),$=Math.min($,A),I=Math.max(I,L),E=Math.max(E,A));C=I-b,q=E-$;var K=10,N=Math.min(K/C,K/q);g=[N,0,0,N,-Math.round(C/2+b)*N,-Math.round(q/2+$)*N]}return{type:"path",path:n,matrix:g}}function ke(h){var n,g=1,f="#000000",_='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof h=="string"?n=h:(n=h.text,g="scalar"in h?h.scalar:g,_="fontFamily"in h?h.fontFamily:_,f="color"in h?h.color:f);var y=10*g,S=""+y+"px "+_,b=new OffscreenCanvas(y,y),$=b.getContext("2d");$.font=S;var I=$.measureText(n),E=Math.ceil(I.actualBoundingBoxRight+I.actualBoundingBoxLeft),C=Math.ceil(I.actualBoundingBoxAscent+I.actualBoundingBoxDescent),q=2,L=I.actualBoundingBoxLeft+q,A=I.actualBoundingBoxAscent+q;E+=q+q,C+=q+q,b=new OffscreenCanvas(E,C),$=b.getContext("2d"),$.font=S,$.fillStyle=f,$.fillText(n,L,A);var K=1/g;return{type:"bitmap",bitmap:b.transferToImageBitmap(),matrix:[K,0,0,K,-E*K/2,-C*K/2]}}e.exports=function(){return Kt().apply(this,arguments)},e.exports.reset=function(){Kt().reset()},e.exports.create=Ut,e.exports.shapeFromPath=ve,e.exports.shapeFromText=ke})((function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}})(),qt,!1);var ft=qt.exports;qt.exports.create;class zt extends O(j(F)){static get tag(){return"timer-kuis"}static get properties(){return{...super.properties,duration:{type:Number,attribute:"duration",reflect:!0},remaining:{type:Number,attribute:"remaining",reflect:!0},autostart:{type:Boolean,attribute:"autostart",reflect:!0},kdMateri:{type:String,attribute:"kd-materi"},studentId:{type:String,attribute:"student-id"},_remaining:{state:!0},_running:{state:!0},hideControls:{type:Boolean,attribute:"hide-controls",reflect:!0}}}constructor(){super(),this.duration=300,this.autostart=!1,this.hideControls=!1,this._remaining=this.duration,this._running=!1,this._intervalId=null,this.t={...this.t,title:"Waktu Kuis",start:"Mulai",pause:"Jeda",reset:"Ulang",done:"Waktu habis"}}connectedCallback(){super.connectedCallback(),this.remaining!=null&&!isNaN(this.remaining)&&this.remaining>0?this._remaining=this.remaining:this._remaining=this.duration,this._onVisChange=this._onVisChange.bind(this),globalThis.addEventListener("visibilitychange",this._onVisChange),this.autostart&&this._remaining>0&&this.start()}disconnectedCallback(){globalThis.removeEventListener("visibilitychange",this._onVisChange),this._clearInterval(),super.disconnectedCallback()}_onVisChange(){document.hidden?this._running&&this.pause():(this._remaining>0&&!this._running&&this.autostart&&this.start(),this._remaining<=0&&!this._running&&(this._remaining=0,this._running=!1,this._clearInterval(),this._clearStartTime(),this._onExpire()))}_startKey(){return`timer_kuis_start_${this.kdMateri||"default"}_${this.studentId||"default"}`}_saveStartTime(t){try{globalThis.localStorage.setItem(this._startKey(),String(t))}catch{}}_loadStartTime(){try{const t=parseInt(globalThis.localStorage.getItem(this._startKey())||"0",10);return isNaN(t)?0:t}catch{return 0}}_clearStartTime(){try{globalThis.localStorage.removeItem(this._startKey())}catch{}}updated(t){t.has("remaining")&&this.remaining!=null&&!isNaN(this.remaining)&&(this._remaining=this.remaining,this._running&&(this._clearInterval(),this._running=!1,this.start())),t.has("duration")&&!this._running&&this.remaining==null&&(this._remaining=this.duration)}start(){this._running||(this._remaining<=0&&(this._remaining=this.duration),this._running=!0,this._clearInterval(),this._saveStartTime(Date.now()-(this.duration-this._remaining)*1e3),this._intervalId=setInterval(()=>this._tick(),1e3))}pause(){this._running=!1,this._clearInterval();const t=this._loadStartTime();if(t>0){const e=Math.floor((Date.now()-t)/1e3);this._remaining=Math.max(0,this.duration-e),this._saveStartTime(Date.now()-(this.duration-this._remaining)*1e3)}}reset(){this._clearInterval(),this._running=!1,this._remaining=this.duration,this._clearStartTime()}_clearInterval(){this._intervalId&&(clearInterval(this._intervalId),this._intervalId=null)}_tick(){const t=this._loadStartTime();if(t>0){const e=Math.floor((Date.now()-t)/1e3);this._remaining=Math.max(0,this.duration-e)}else this._remaining>0&&(this._remaining-=1);this._remaining<=0&&(this._remaining=0,this._running=!1,this._clearInterval(),this._clearStartTime(),this._onExpire())}_onExpire(){this.dispatchEvent(new CustomEvent("timer-kuis-expired",{detail:{duration:this.duration},bubbles:!0,composed:!0}))}_format(t){const e=Math.floor(t/60),a=t%60;return`${String(e).padStart(2,"0")}:${String(a).padStart(2,"0")}`}static get styles(){return[super.styles,z`
        :host { display: block; }
        .timer-card {
    ...
    `}static get haxProperties(){return{api:"1",canScale:!0,canPosition:!0,canEditSource:!1,type:"element",designSystem:{accent:!0,primary:!0,card:!0,text:!0,designTreatment:!1},gizmo:{title:"Timer Kuis",description:"Timer hitung mundur untuk kuis dengan auto-submit via event timer-kuis-expired",icon:"icons:timer",color:"purple",tags:["Education","Timer","Quiz"]},settings:{configure:[{property:"duration",title:"Durasi (detik)",inputMethod:"number",description:"Lama waktu pengerjaan kuis dalam detik",default:300},{property:"autostart",title:"Mulai Otomatis",inputMethod:"boolean",default:!1}]},saveOptions:{unsetAttributes:[]},demoSchema:[{tag:"timer-kuis",properties:{duration:300,autostart:!1},content:""},{tag:"timer-kuis",properties:{duration:60,autostart:!0},content:""}]}}}customElements.get(zt.tag)||globalThis.customElements.define(zt.tag,zt);class Xe{constructor(t){this._host=t,this._questionStartTime=null}getAnswerTime(){return this._host._questionStartTime?Date.now()-this._host._questionStartTime:0}resetQuestionTimer(){this._questionStartTime=Date.now()}isSuspiciousTiming(t,e=3e3){return t>0&&t<e}getTimingData(){return{questionStartTime:this._questionStartTime,currentTime:Date.now()}}calculateScore(t,e=1){return t?e:0}}class se{static renderMC(t,e){const{selected:a,selectedAnswers:i,answered:r,editable:s,feedbackText:d,feedbackPositive:l,hideAnswers:c}=e,u=e.isMulti,m=t.choices||[],w=t._correctMap?(e.correctAnswers||[]).map(M=>t._correctMap.indexOf(M)):e.correctAnswers||[];return o`
      <div class="choices-container">
        ${m.map((M,k)=>{const T=u?i.has(k):a===k,x=w.includes(k);let P="choice-row";T&&r&&!c?P+=x?" correct":" wrong":T&&(P+=" selected");const _t=r&&!s,tt=e.pilihanImages&&e.pilihanImages[k],lt=["A","B","C","D","E","F"];return o`
            <button
              class="${P} ${_t?"disabled":""}"
              ?disabled=${_t}
              @click=${()=>e.onSelect(k)}
              aria-label="Pilihan ${lt[k]||k+1}: ${M}"
            >${T&&r&&!c&&x?"\u2713 ":""}${lt[k]||k+1}. ${M}
            ${tt?o`<br /><img class="choice-image" src="${tt}" alt="Gambar pilihan ${lt[k]||k+1}" loading="lazy" />`:""}
            </button>
          `})}
      </div>
      ${c?"":d?o`<div class="feedback ${l?"correct":"wrong"}">${d}</div>`:""}
      ${u&&(!r||s)?o`<button class="btn-submit" @click=${e.onSubmit}>Kirim Jawaban (${i.size} dipilih)</button>`:""}
    `}static renderPGKompleks(t,e){const{selectedAnswers:a,answered:i,editable:r,feedbackText:s,feedbackPositive:d,hideAnswers:l}=e,c=a||new Set,u=i&&!r;return o`
      <div class="choices-container">
        ${t.choices.map((m,w)=>{const M=c.has(w),k=(t.correctAnswers||[]).includes(w);let T="choice-row multi-correct";return i&&!l?(k&&(T+=" correct"),M&&!k&&(T+=" wrong")):M&&(T+=" selected"),o`
            <button
              class="${T} ${u?"disabled":""}"
              ?disabled=${u}
              @click=${()=>e.onToggle(w)}
              aria-label="Pilihan ${huruf[w]||w+1}: ${m} ${M?"(dipilih)":""}"
            >${!l&&M&&i&&k?"\u2713 ":""}${huruf[w]||w+1}. ${m}
            </button>
          `})}
      </div>
      ${!i||r?o`<button class="btn-submit" @click=${e.onSubmit}>Kirim Jawaban</button>`:""}
      ${l?"":s?o`<div class="feedback ${d?"correct":"wrong"}">${s}</div>`:""}
    `}static renderPGK(t,e){const{pgkAnswers:a,answered:i,editable:r,feedbackText:s,feedbackPositive:d,hideAnswers:l}=e;return o`
      <div class="pgk-container">
        ${(t.statements||[]).map((c,u)=>{const m=a?a[u]:null;return o`
            <div class="pgk-statement">
              <div class="statement-text">${u+1}. ${c.text}</div>
              <div class="statement-options">
                <button class="pgk-btn ${m===!0?"selected":""}" 
                  @click=${()=>e.onPGK(u,!0)}
                  ?disabled=${i&&!r}>
                  ${i&&!l&&c.answer===!0?"\u2713 ":""}Benar
                </button>
                <button class="pgk-btn ${m===!1?"selected":""}" 
                  @click=${()=>e.onPGK(u,!1)}
                  ?disabled=${i&&!r}>
                  ${i&&!l&&c.answer===!1?"\u2713 ":""}Salah
                </button>
              </div>
            </div>
          `})}
      ...
      ${!i||r?o`<button class="btn-submit" @click=${e.onSubmit}>Kirim Jawaban</button>`:""}
      ${l?"":s?o`<div class="feedback ${d?"correct":"wrong"}">${s}</div>`:""}
    `}static renderMatching(t,e){const{matchAnswers:a,answered:i,editable:r,feedbackText:s,feedbackPositive:d,hideAnswers:l}=e;return o`
      <div class="matching-container">
        <div class="matching-left">
          ${(t.leftItems||[]).map((c,u)=>o`
            <div class="match-item left">${c}</div>
          `)}
        </div>
        <div class="matching-right">
          ${(t.rightItems||[]).map((c,u)=>{const m=a?a[u]:null;return o`
              <div class="match-item right ${m!==null?"matched":""}" 
                @click=${()=>e.onMatchRight(u)}>
...
${!i||r?o`<button class="btn-submit" @click=${e.onSubmit}>Kirim Jawaban</button>`:""}
    ...
    `}}class de{static calculatePercentage(t,e){return!e||e===0?0:Math.round(t/e*100)}static formatScore(t,e){const a=this.calculatePercentage(t,e);return`${t}/${e} (${a}%)`}static hasPassed(t,e,a=70){return this.calculatePercentage(t,e)>=a}calculateScore(t,e=1){return t?e:0}static prepareSubmission(t){const{studentId:e,kdMateri:a,kategori:i,judul:r,score:s,maxPoints:d,answerTimings:l}=t;return{student_id:e,kd_materi:a,kategori:i||"sumatif_lm",metadata_kuis:r,skor:s,skor_maks:d,persentase:this.calculatePercentage(s,d),timestamp:new Date().toISOString(),answer_timings:l||[]}}static getGrade(t){return t>=90?"A":t>=80?"B":t>=70?"C":t>=60?"D":"E"}static needsRemediation(t,e=70){return t<e}}const St=[{q:"Apa kegunaan utama metode connectedCallback pada LitElement?",a:"Menginisialisasi nilai variabel dasar",b:"Mendeteksi elemen saat berhasil diinjeksikan ke struktur DOM",c:"Menghapus event listener global",k:"b"},{q:"Bagaimana cara mencegah timeout 6 menit pada Google Apps Script?",a:"Menggunakan penulisan masal berbasis batch I/O",b:"Menulis ke banyak sheet terpisah",c:"Memperbanyak rumus formula cell",k:"a"}];class Z extends O(j(F)){static get tag(){return"kuis-ledakan"}static get haxProperties(){return{api:"1",canScale:!0,canPosition:!1,canEditSource:!0,type:"element",designSystem:{accent:!0,primary:!0,card:!0,text:!0,designTreatment:!1},gizmo:{title:"Kuis Ledakan (Evaluasi Mandiri)",description:"Kuis interaktif evaluasi mandiri yang mengunci skor dan mengirim aktivitas ke dasbor Apps Script.",icon:"icons:question-answer",color:"cyan",tags:["Kuis","Evaluasi","Interaktif"],meta:{author:"andyinformatika23-hash"}},settings:{configure:[{property:"judul",title:"Judul Kuis",description:"Judul yang tampil di kartu kuis.",inputMethod:"textfield",required:!0},{property:"appsScriptUrl",title:"URL Web App Google Apps Script",description:"URL /exec Apps Script untuk mengirim hasil kuis (action=logActivity).",inputMethod:"textfield"},{property:"kdMateri",title:"Kode Topik / Pertemuan",description:"Kode materi yang tercatat pada log aktivitas.",inputMethod:"textfield"},{property:"kategori",title:"Kategori Kuis",description:"sumatif_lm \u2192 skor masuk rapor (db_asesmen); formatif \u2192 progres saja, tidak masuk rapor (db_aktivitas).",inputMethod:"select",options:{sumatif_lm:"Sumatif (Rapor LM)",formatif:"Formatif (Progres)"},default:"sumatif_lm"},{property:"mode",title:"Mode Tampilan",description:"Mode guru menampilkan tombol ulang; mode siswa fokus mengerjakan.",inputMethod:"select",options:{guru:"Guru - Pantauan",dosen:"Dosen - Bimbingan",siswa:"Siswa - Evaluasi Mandiri"}},{property:"questions",title:"Soal (JSON)",description:"Array soal AKM: PG {question, choices, correctIndex}, PG kompleks {correctAnswers:[0,2]}, PGK {type:'pgk', statements:[{text,answer}]}, menjodohkan {type:'matching', leftItems, rightItems, correctPairs}, isian {type:'shortAnswer', acceptedAnswers}, gambar soal {image}, pilihan bergambar {text,image}. Skor: PGK 1 poin per pernyataan benar, menjodohkan 1 poin per pasangan benar. Format lama {q,a,b,c,k} tetap didukung. Field opsional: {hint} \u2014 petunjuk yang muncul sebagai <details>.",inputMethod:"code-editor"},{property:"shuffleChoices",title:"Acak Pilihan Jawaban",description:"Mengacak urutan pilihan jawaban setiap kali kuis dimulai",inputMethod:"boolean"},{property:"hideAnswers",title:"Sembunyikan Jawaban",description:"Tidak menampilkan jawaban benar/salah setelah menjawab",inputMethod:"boolean"},{property:"hideScore",title:"Sembunyikan Nilai",description:"Menyembunyikan angka skor berjalan di layar soal dan lingkaran nilai akhir (pesan selesai tetap tampil)",inputMethod:"boolean"},{property:"hideConfetti",title:"Nonaktifkan Konfeti",description:"Tidak menampilkan efek konfeti saat jawaban benar",inputMethod:"boolean"},{property:"showQuestionNav",title:"Tampilkan Navigasi Nomor Soal",description:"Tampilkan tombol navigasi nomor soal di atas kuis. Setelah maju otomatis, navigasi mundur ke soal yang sudah dijawab dinonaktifkan.",inputMethod:"boolean",default:!0},{property:"allowBackwardNav",title:"Izinkan Navigasi Mundur",description:"true = siswa boleh melompat ke soal yang sudah dijawab. Default false (nav maju saja setelah submit).",inputMethod:"boolean",default:!1},{property:"practiceMode",title:"Mode Latihan",description:"Aktifkan untuk mode latihan: tidak ada auto-advance, tombol Berikutnya/Kembali tersedia, navigasi bebas.",inputMethod:"boolean",default:!1},{property:"questionDelay",title:"Jeda Soal (ms)",description:"Jeda dalam milidetik sebelum auto-advance ke soal berikutnya. Hanya berlaku mode kuis (bukan practice mode). Default 1800.",inputMethod:"number",default:1800},{property:"reviewAnswers",title:"Tinjau Jawaban di Akhir",description:"Tampilkan tombol 'Tinjau Jawaban' di layar hasil untuk mereview semua soal & jawaban yang diberikan.",inputMethod:"boolean",default:!0},{property:"timerDuration",title:"Durasi Timer (detik)",description:"0 = tanpa timer. >0 menampilkan <timer-kuis> & auto-submit saat habis.",inputMethod:"number",default:0},{property:"timerAutostart",title:"Timer Mulai Otomatis",inputMethod:"boolean",default:!0}],advanced:[],developer:[]},saveOptions:{wipeSlot:!1,unsetAttributes:["_screen","_currentIdx","_selected","_answered","_score","_advanceTimer","_editing","_tempQuestions","_editingIndex","_tempQuestionText","_tempQuestionImage","_tempQuestionType","_tempQuestionPoints","_tempChoice0","_tempChoice1","_tempChoice2","_tempChoice3","_tempChoiceImage0","_tempChoiceImage1","_tempChoiceImage2","_tempChoiceImage3","_tempCorrectIndex","_tempCorrectAnswers","_tempLeftItems","_tempRightItems","_tempCorrectPairs","_tempAcceptedAnswers","_tempAcceptedStatements","_tempStatements","_editorOrigin","_importText","_importStatus","_reviewMode","_userAnswers","_answeredSet","_sessionToken","_sessionExpired"]},demoSchema:[{tag:"kuis-ledakan",properties:{judul:"Evaluasi Kuis Interaktif",mode:"siswa",kdMateri:"Pertemuan 1",questions:[{q:"Apa kepanjangan AKM?",a:"Asesmen Kompetensi Minimum",b:"Akademik Kurikulum Merdeka",c:"Analisis Kebutuhan Materi",k:"a"},{q:"Apa benefit utama AKM?",a:"Mengukur literasi & numerasi siswa",b:"Menentukan ranking kelas",c:"Menghapus ujian nasional",k:"a"},{q:"Format soal AKM meliputi?",a:"PG, PGK, Isian, Menjolong",b:"Hanya pilihan ganda",c:"Essai saja",k:"a"}]},content:""},{tag:"kuis-ledakan",properties:{judul:"Kuis PG Kompleks",mode:"siswa",kdMateri:"PGK-Demo",questions:[{q:"Pilih semua pernyataan yang benar tentang Asesmen Nasional:",type:"pgk",statements:[{text:" Terdiri dari AKM, Survei Karakter, dan Survei Lingkungan Belajar",answer:!0},{text:"Hasilnya langsung menentukan nilai rapor siswa",answer:!1},{text:"Dirancang untuk mengukur kualitas pembelajaran",answer:!0},{text:"Dilaksanakan setiap semester",answer:!1}]}]},content:""}]}}static get properties(){return{...super.properties,questions:{type:Array,attribute:"questions",reflect:!0,converter:{fromAttribute(t){if(t==null||t==="")return;if(Array.isArray(t)||typeof t=="object")return t;const e=String(t).trim();if(!(!e||e.includes("[object Object]"))&&(e.startsWith("[")||e.startsWith("{")))try{const a=JSON.parse(e);return Array.isArray(a)?a:a&&typeof a=="object"&&Array.isArray(a.questions)?a.questions:void 0}catch{return}},toAttribute(t){if(!Array.isArray(t))return null;try{return JSON.stringify(t)}catch{return null}}}},judul:{type:String,attribute:"judul",reflect:!0},appsScriptUrl:{type:String,attribute:"apps-script-url",reflect:!0},kdMateri:{type:String,attribute:"kd-materi",reflect:!0},kategori:{type:String,attribute:"kategori",reflect:!0},mode:{type:String,attribute:"mode",reflect:!0},hideConfetti:{type:Boolean,attribute:"hide-confetti",reflect:!0},hideAnswers:{type:Boolean,attribute:"hide-answers",reflect:!0},hideScore:{type:Boolean,attribute:"hide-score",reflect:!0},editable:{type:Boolean,attribute:!0,reflect:!0},shuffleChoices:{type:Boolean,attribute:"shuffle-choices",reflect:!0},shuffleQuestions:{type:Boolean,attribute:"shuffle-questions",reflect:!0},lockAfterComplete:{type:Boolean,attribute:"lock-after-complete",reflect:!0},showQuestionNav:{type:Boolean,attribute:"show-question-nav",reflect:!0},allowBackwardNav:{type:Boolean,attribute:"allow-backward-nav",reflect:!0},practiceMode:{type:Boolean,attribute:"practice-mode",reflect:!0},questionDelay:{type:Number,attribute:"question-delay",reflect:!0},reviewAnswers:{type:Boolean,attribute:"review-answers",reflect:!0},_locked:{state:!0},_questionStartTime:{state:!0},_lockChecked:{state:!0},studentId:{type:String,attribute:"student-id",reflect:!0},studentName:{type:String,attribute:"student-name",reflect:!0},studentNis:{type:String,attribute:"student-nis",reflect:!0},studentAbsen:{type:String,attribute:"student-absen",reflect:!0},studentKelas:{type:String,attribute:"student-kelas",reflect:!0},timerDuration:{type:Number,attribute:"timer-duration",reflect:!0},timerMinutes:{type:Number,attribute:"timer-minutes",reflect:!0},timerSeconds:{type:Number,attribute:"timer-seconds",reflect:!0},timerAutostart:{type:Boolean,attribute:"timer-autostart",reflect:!0},hidePauseRestart:{type:Boolean,attribute:"hide-pause-restart",reflect:!0},_attemptStart:{state:!0},_sessionToken:{state:!0},_sessionExpired:{state:!0},_resumeRemaining:{state:!0},_screen:{state:!0},_currentIdx:{state:!0},_selected:{state:!0},_selectedAnswers:{state:!0},_matchAnswers:{state:!0},_shortAnswerText:{state:!0},_answered:{state:!0},_answeredSet:{state:!0},_userAnswers:{state:!0},_score:{state:!0},_maxPoints:{state:!0},_feedbackText:{state:!0},_feedbackPositive:{state:!0},_advanceTimer:{state:!0},_megaConfettiFrameId:{state:!0},_bankStatus:{state:!0},_shuffledQuestions:{state:!0},_autoSaveInterval:{state:!0},_editing:{state:!0},_tempQuestions:{state:!0},_editingIndex:{state:!0},_tempQuestionText:{state:!0},_tempQuestionImage:{state:!0},_tempQuestionType:{state:!0},_tempQuestionPoints:{state:!0},_tempChoice0:{state:!0},_tempChoice1:{state:!0},_tempChoice2:{state:!0},_tempChoice3:{state:!0},_tempChoice4:{state:!0},_tempChoiceImage0:{state:!0},_tempChoiceImage1:{state:!0},_tempChoiceImage2:{state:!0},_tempChoiceImage3:{state:!0},_tempChoiceImage4:{state:!0},_tempCorrectIndex:{state:!0},_tempCorrectAnswers:{state:!0},_tempLeftItems:{state:!0},_tempRightItems:{state:!0},_tempCorrectPairs:{state:!0},_tempAcceptedAnswers:{state:!0},_tempAcceptedStatements:{state:!0},_tempStatements:{state:!0},_editorOrigin:{state:!0},_importText:{state:!0},_importStatus:{state:!0},_reviewMode:{state:!0}}}constructor(){super(),this.t={...this.t,importTitle:"Impor Soal (JSON / .txt)",importFromText:"Impor dari Teks",importPlaceholder:'[{"question":"...","choices":["A","B"],"correctIndex":0}]'};let t=ft;t&&typeof t!="function"&&typeof t.default=="function"&&(t=t.default),this._confettiFn=t,this.questions=St,this.judul="Evaluasi Kuis Interaktif",this.appsScriptUrl="",this.kdMateri="Pertemuan 1",this.kategori="sumatif_lm",this.mode="siswa",this.hideConfetti=!1,this.hideAnswers=!1,this.hideScore=!1,this.shuffleChoices=!1,this.shuffleQuestions=!1,this.lockAfterComplete=!0,this.showQuestionNav=!0,this.allowBackwardNav=!1,this.practiceMode=!1,this.questionDelay=1800,this.reviewAnswers=!0,this.editable=!1,this.studentId="",this.studentName="",this.studentNis="",this.studentAbsen="",this.studentKelas="",this.timerDuration=0,this.timerAutostart=!0,this.timerMinutes=0,this.timerSeconds=0,this.hidePauseRestart=!0,this._screen="start",this._currentIdx=0,this._selected=-1,this._quizEngine=new Xe(this),this._questionRenderer=new se,this._scoreCalculator=new de,this._selectedAnswers=new Set,this._matchAnswers={},this._shortAnswerText="",this._answered=!1,this._answeredSet=new Set,this._userAnswers=new Map,this._score=0,this._maxPoints=0,this._feedbackText="",this._feedbackPositive=!1,this._advanceTimer=null,this._megaConfettiFrameId=null,this._bankStatus="",this._bankLoaded=!1,this._confettiFired=!1,this._shuffledQuestions=[],this._locked=!1,this._lockChecked=!1,this._attemptStart=0,this._sessionToken=null,this._sessionExpired=!1,this._resumeRemaining=0,this._editing=!1,this._tempQuestions=[],this._editingIndex=-1,this._editorOrigin="result",this._importText="",this._importStatus="",this._reviewMode=!1,this._resetEditorForm(),this._autoSaveInterval=null,this._authHandler=this._authHandler.bind(this)}static get styles(){return[super.styles,z`
        ...
        .locked-box {
          text-align: center;
          border: 2px dashed var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c));
        }
        .lock-icon { font-size: 40px; }
        .lock-msg { color: var(--ddd-theme-secondary, rgba(0, 0, 0, 0.75)); font-weight: 600; }
        .quiz-title { color: var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c)); font-size: var(--ddd-font-size-l); font-weight: 800; margin-top: 0; text-align: center; }
        .btn-start {
          display: block; width: 100%; padding: var(--ddd-spacing-4); background-color: var(--ddd-theme-polaris-primary, var(--ddd-primary-1, #1e407c)); color: var(--ddd-theme-on-primary, var(--ddd-theme-bgContrast, var(--lowContrast-override, #ffffff)));
        ...
        .btn-start:hover { background-color: var(--ddd-theme-accent, var(--ddd-accent-0, #96bee6)); }
        .question-text { font-size: var(--ddd-font-size-s); font-weight: 700; color: var(--ddd-theme-on-surface, var(--ddd-theme-default-text, var(--ddd-theme-default-coalyGray, #1e293b))); margin-bottom: var(--ddd-spacing-4); }
        .hint-box { margin-bottom: var(--ddd-spacing-7); border: var(--ddd-border-xs); border-radius: var(--ddd-radius-sm); padding: var(--ddd-spacing-3); background: var(--ddd-theme-polaris-surface-hover, var(--ddd-theme-default-white, #ffffff)); }
        .hint-box summary { cursor: pointer; font-weight: 700; font-size: var(--ddd-font-size-s); color: var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c)); list-style: none; }
        .hint-box summary::before { content: "💡 "; }
        .hint-box div { margin-top: var(--ddd-spacing-2); font-size: var(--ddd-font-size-4xs); color: var(--ddd-theme-default-text, var(--ddd-theme-default-coalyGray, #1e293b)); }
        .hint-box div {
            ...
            /*
              FIX PRAW COMPLIANT:
              1. Memprioritaskan token teks dinamis luar jika ada.
              2. Jika mati, lari ke token primer resmi HAX PRAW (--ddd-theme-primary).
              3. Jika seluruh token HAX mati, light-dark() native langsung aktif:
                 Terang = Abu gelap pekat (#1e293b) | Gelap = Abu terang redup (#94a3b8)
            */
            color: var(--ddd-theme-on-surface, var(--ddd-theme-primary, light-dark(#1e293b, #94a3b8)));
        }

        .question-nav {
            display: flex; flex-direction: column; gap: var(--ddd-spacing-3); margin-bottom: var(--ddd-spacing-4);
            padding: var(--ddd-spacing-4);
            background: var(--ddd-theme-polaris-surface-hover, var(--ddd-theme-default-white, #ffffff));
            border: var(--ddd-border-xs);
            border-radius: var(--ddd-radius-md);
          }
          .question-nav .nav-label {
            font-size: var(--ddd-font-size-3xs); font-weight: 700; color: var(--ddd-theme-on-surface, var(--ddd-theme-default-text, var(--ddd-theme-default-coalyGray, #1e293b)));
            text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: var(--ddd-spacing-1);
            padding-bottom: var(--ddd-spacing-2); border-bottom: 1px solid var(--ddd-theme-polaris-border, var(--ddd-theme-default-limestoneLight, #e4e5e7));
          }
          ...
          .question-nav .q-dot {
            ...
            border: var(--ddd-border-sm); background: var(--ddd-theme-default-white, var(--ddd-theme-default-background, #ffffff));
            color: var(--ddd-theme-on-surface, var(--ddd-theme-default-text, var(--ddd-theme-default-coalyGray, #1e293b)));
            border-radius: var(--ddd-radius-md);
            font-weight: 700; font-size: var(--ddd-font-size-3xs);
            cursor: pointer; transition: background 0.15s, color 0.15s, border-color 0.15s;
            font-family: inherit; display: flex; align-items: center; justify-content: center;
          }
          .question-nav .q-dot:hover:not(.disabled) { border-color: var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c)); background: var(--ddd-theme-polaris-surface-hover, var(--ddd-theme-default-white, #ffffff)); }
          .question-nav .q-dot.current {
            background: var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c));
          ...
          .question-nav .q-dot.answered:not(.current) {
            border-color: var(--ddd-theme-success, var(--ddd-theme-default-success, #1e4620));
          ...
          .question-nav .q-dot.disabled {
            ...
            border-color: var(--ddd-theme-polaris-border, var(--ddd-theme-default-limestoneLight, #e4e5e7));
          }
          .question-nav .q-dot.unanswered {
            background: var(--ddd-theme-warning-light, var(--ddd-theme-default-warningLight, #fff4e5));
            border-color: var(--ddd-theme-warning, var(--ddd-theme-default-warning, #663c00));
            color: var(--ddd-theme-warning-text, var(--ddd-theme-default-warning, #663c00));
          }
        ...
        .choice-row {
          ...
          /*
            FIX BACKGROUND TEMA ADAPTIF:
            1. Cek token hover polaris eksternal bawaan HAX.
            2. Jika mati (not defined), jalankan fungsi core light-dark() secara native:
               - Mode Terang: warna putih bersih (#ffffff)
               - Mode Gelap: warna permukaan gelap resmi PRAW (#111827)
          */
          background: var(--ddd-theme-polaris-surface-hover, light-dark(#ffffff, var(--ddd-theme-surface, #111827)));

          /*
            TAMBAHKAN PERBAIKAN TEKS (COLOR):
            Agar warna teks otomatis kontras (Hitam di background putih, Putih di background gelap)
          */
        ...
        .choice-row:hover:not(.disabled) { border-color: var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c)); background: var(--ddd-theme-polaris-surface-hover, var(--ddd-theme-default-white, #ffffff)); }
        ...
        .choice-row.correct { border-color: var(--ddd-theme-success, var(--ddd-theme-default-success, #1e4620)); background: var(--ddd-theme-success-light, var(--ddd-theme-default-successLight, #edf7ed)); color: var(--ddd-theme-success-text, var(--ddd-theme-default-success, #1e4620)); font-weight: 700; }
        .choice-row.wrong { border-color: var(--ddd-theme-error, var(--ddd-theme-default-error, #5f2120)); background: var(--ddd-theme-error-light, var(--ddd-theme-default-errorLight, #fdeded)); color: var(--ddd-theme-error-text, var(--ddd-theme-default-error, #5f2120)); }
        ...
        .score-circle {
          width: 100px; height: 100px; border-radius: var(--ddd-radius-circle); background: var(--ddd-theme-polaris-surface-hover, var(--ddd-theme-default-white, #ffffff)); color: var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c));
        ...
        .err-chip {
          display: block; margin: var(--ddd-spacing-3) auto 0; max-width: 640px; background: var(--ddd-theme-error-light, var(--ddd-theme-default-errorLight, #fdeded)); border: var(--ddd-border-xs);
          color: var(--ddd-theme-error-text, var(--ddd-theme-default-error, #5f2120)); border-radius: var(--ddd-radius-md); padding: var(--ddd-spacing-2) var(--ddd-spacing-3); font-size: var(--ddd-font-size-4xs); font-weight: 600;
        }

        .pgk-table { width: 100%; border-collapse: collapse; margin: var(--ddd-spacing-3) 0; }
        .pgk-table th { text-align: left; padding: var(--ddd-spacing-3) var(--ddd-spacing-4); background: var(--ddd-theme-polaris-surface-hover, var(--ddd-theme-default-white, #ffffff)); border-bottom: var(--ddd-border-sm); font-size: var(--ddd-font-size-3xs); color: var(--ddd-theme-secondary, rgba(0, 0, 0, 0.75)); }
        .pgk-table td { padding: var(--ddd-spacing-3) var(--ddd-spacing-4); border-bottom: 1px solid var(--ddd-theme-polaris-border, var(--ddd-theme-default-limestoneLight, #e4e5e7)); font-size: var(--ddd-font-size-3xs); transition: background 0.15s; cursor: default; }
        .pgk-table td:hover { background: var(--ddd-theme-polaris-surface-hover, var(--ddd-theme-default-white, #ffffff)); }
        ...
        .btn-submit:hover { background-color: var(--ddd-theme-accent, var(--ddd-accent-0, #96bee6)); }
        .practice-nav .btn-back { flex: 1; padding: var(--ddd-spacing-3); background: var(--ddd-theme-polaris-surface, var(--ddd-theme-default-white, #ffffff)); color: var(--ddd-theme-on-surface, var(--ddd-theme-default-text, var(--ddd-theme-default-coalyGray, #1e293b))); border: var(--ddd-border-xs); border-radius: var(--ddd-radius-sm); font-size: var(--ddd-font-size-4xs); font-weight: 700; cursor: pointer; }
        .practice-nav .btn-back:disabled { opacity: 0.4; cursor: not-allowed; }
        .practice-nav .btn-next { flex: 2; padding: var(--ddd-spacing-3); background: var(--ddd-theme-polaris-primary, var(--ddd-primary-1, #1e407c)); color: var(--ddd-theme-on-primary, var(--ddd-theme-bgContrast, var(--lowContrast-override, #ffffff))); border: none; border-radius: var(--ddd-radius-sm); font-size: var(--ddd-font-size-4xs); font-weight: 700; cursor: pointer; }
        ...
        .feedback-area.positive { background: var(--ddd-theme-success-light, var(--ddd-theme-default-successLight, #edf7ed)); color: var(--ddd-theme-success-text, var(--ddd-theme-default-success, #1e4620)); border: var(--ddd-border-xs); }
        .feedback-area.negative { background: var(--ddd-theme-error-light, var(--ddd-theme-default-errorLight, #fdeded)); color: var(--ddd-theme-error-text, var(--ddd-theme-default-error, #5f2120)); border: var(--ddd-border-xs); }
        ...
        .review-stat-label { display: block; font-size: var(--ddd-font-size-4xs); color: var(--ddd-theme-secondary, rgba(0, 0, 0, 0.75)); font-weight: 600; }
        .review-stat-value { display: block; font-size: var(--ddd-font-size-3xs); font-weight: 800; }
        .review-stat-value.positive { color: var(--ddd-theme-success-text, var(--ddd-theme-default-success, #1e4620)); }
        .review-stat-value.negative { color: var(--ddd-theme-error-text, var(--ddd-theme-default-error, #5f2120)); }
        .review-questions { display: flex; flex-direction: column; gap: var(--ddd-spacing-3); margin: var(--ddd-spacing-4) 0; }
        .review-question { border: var(--ddd-border-xs); border-radius: var(--ddd-radius-md); padding: var(--ddd-spacing-3); background: var(--ddd-theme-polaris-surface-hover, var(--ddd-theme-default-white, #ffffff)); }
        .review-qnum { font-size: var(--ddd-font-size-4xs); font-weight: 800; color: var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c)); margin-bottom: var(--ddd-spacing-2); }
        .review-qtext { font-size: var(--ddd-font-size-4xs); font-weight: 700; color: var(--ddd-theme-on-surface, var(--ddd-theme-default-text, var(--ddd-theme-default-coalyGray, #1e293b))); margin-bottom: var(--ddd-spacing-3); }
        ...
        .review-mc li.review-correct { background: var(--ddd-theme-success-light, var(--ddd-theme-default-successLight, #edf7ed)); color: var(--ddd-theme-success-text, var(--ddd-theme-default-success, #1e4620)); font-weight: 700; }
        .review-mc li.review-selected-wrong { background: var(--ddd-theme-error-light, var(--ddd-theme-default-errorLight, #fdeded)); color: var(--ddd-theme-error-text, var(--ddd-theme-default-error, #5f2120)); font-weight: 700; }
        .review-short { margin: var(--ddd-spacing-2) 0; font-size: var(--ddd-font-size-4xs); }
        .review-label { font-weight: 700; color: var(--ddd-theme-secondary, rgba(0, 0, 0, 0.75)); }
        .review-value { color: var(--ddd-theme-on-surface, var(--ddd-theme-default-text, var(--ddd-theme-default-coalyGray, #1e293b))); }
        ...
        .review-badge.positive { background: var(--ddd-theme-success-light, var(--ddd-theme-default-successLight, #edf7ed)); color: var(--ddd-theme-success-text, var(--ddd-theme-default-success, #1e4620)); }
        .review-badge.negative { background: var(--ddd-theme-error-light, var(--ddd-theme-default-errorLight, #fdeded)); color: var(--ddd-theme-error-text, var(--ddd-theme-default-error, #5f2120)); }

        .btn-edit-soal {
          display: block; width: 100%; padding: var(--ddd-spacing-3); margin-top: var(--ddd-spacing-3); background-color: var(--ddd-theme-secondary, rgba(0, 0, 0, 0.75));
          color: var(--ddd-theme-on-primary, var(--ddd-theme-bgContrast, var(--lowContrast-override, #ffffff))); border: none; border-radius: var(--ddd-radius-sm); font-size: var(--ddd-font-size-4xs); font-weight: 700; cursor: pointer; transition: background 0.2s;
        }
        ...
        .editor-select { padding: 6px 10px; border-radius: 6px; border: 1px solid var(--ddd-theme-polaris-border, var(--ddd-theme-default-limestoneLight, #e4e5e7)); font-size: 13px; font-family: inherit; }
        .editor-input { padding: 6px 10px; border-radius: 6px; border: 1px solid var(--ddd-theme-polaris-border, var(--ddd-theme-default-limestoneLight, #e4e5e7)); font-size: 13px; font-family: inherit; box-sizing: border-box; }
        .editor-textarea { width: 100%; padding: 8px; border-radius: 6px; border: 1px solid var(--ddd-theme-polaris-border, var(--ddd-theme-default-limestoneLight, #e4e5e7)); font-size: 12px; font-family: monospace; box-sizing: border-box; }
      ...
      `,z`
        ...
        :host-context(body.dark-mode) .btn-start { background-color: var(--ddd-theme-polaris-primary, var(--ddd-primary-1, #1e407c)); color: var(--ddd-theme-on-primary, var(--ddd-theme-bgContrast, var(--lowContrast-override, #ffffff))); }
        :host-context(body.dark-mode) .btn-start:hover { background-color: var(--ddd-theme-accent, var(--ddd-accent-0, #96bee6)); }
        :host-context(body.dark-mode) .choice-row { background: var(--dk-soft); color: var(--dk-text); border-color: var(--dk-border); }
        :host-context(body.dark-mode) .choice-row.correct { border-color: var(--ddd-theme-success, var(--ddd-theme-default-success, #1e4620)); background: var(--ddd-theme-success-light, var(--ddd-theme-default-successLight, #edf7ed)); color: var(--ddd-theme-success-text, var(--ddd-theme-default-success, #1e4620)); }
        :host-context(body.dark-mode) .choice-row.wrong { border-color: var(--ddd-theme-error, var(--ddd-theme-default-error, #5f2120)); background: var(--ddd-theme-error-light, var(--ddd-theme-default-errorLight, #fdeded)); color: var(--ddd-theme-error-text, var(--ddd-theme-default-error, #5f2120)); }
        :host-context(body.dark-mode) .choice-row.selected { border-color: var(--ddd-theme-selected-border, var(--ddd-theme-default-link, #005fa9)); background: var(--ddd-theme-selected-bg, var(--ddd-theme-default-info, #e5f6fd)); color: var(--ddd-theme-on-primary, var(--ddd-theme-bgContrast, var(--lowContrast-override, #ffffff))); }
        ...
        :host-context(body.dark-mode) .err-chip { background: var(--ddd-theme-error-light, var(--ddd-theme-default-errorLight, #fdeded)); color: var(--ddd-theme-error-text, var(--ddd-theme-default-error, #5f2120)); border-color: var(--ddd-theme-error-dark, var(--ddd-theme-default-error, #5f2120)); }
        :host-context(body.dark-mode) .btn-submit { background: var(--ddd-theme-polaris-primary, var(--ddd-primary-1, #1e407c)); color: var(--ddd-theme-on-primary, var(--ddd-theme-bgContrast, var(--lowContrast-override, #ffffff))); }
        :host-context(body.dark-mode) .btn-submit:hover { background: var(--ddd-theme-accent, var(--ddd-accent-0, #96bee6)); }
        ...
        :host-context(body.dark-mode) .score-circle { background: linear-gradient(135deg, #312e81, var(--ddd-theme-polaris-primary, #4f46e5)); color: var(--ddd-theme-on-primary, var(--ddd-theme-bgContrast, var(--lowContrast-override, #ffffff))); }
        ...
        :host-context(body.dark-mode) .question-nav .q-dot:hover:not(.disabled) { background: var(--dk-soft); border-color: var(--ddd-theme-selected-border, var(--ddd-theme-default-link, #005fa9)); }
      ...
      `]}updated(t){if(super.updated(t),t.has("questions")&&!Array.isArray(this.questions)&&(this.questions=void 0),t.has("timerMinutes")||t.has("timerSeconds")){const e=(this.timerMinutes||0)*60+(this.timerSeconds||0);this.timerDuration!==e&&(this.timerDuration=e)}else if(t.has("timerDuration")){const e=Math.floor((this.timerDuration||0)/60),a=(this.timerDuration||0)%60;this.timerMinutes!==e&&(this.timerMinutes=e),this.timerSeconds!==a&&(this.timerSeconds=a)}this._screen==="question"&&this._resumeRemaining>0&&(this._resumeRemaining=0)}connectedCallback(){if(super.connectedCallback(),globalThis.HaxStore&&typeof globalThis.HaxStore.requestAvailability=="function"){const t=globalThis.HaxStore.requestAvailability();t&&!t.elementList[Z.tag]&&(t.elementList[Z.tag]=Z.haxProperties)}globalThis.addEventListener("quiz-user-login",this._authHandler),globalThis.addEventListener("quiz-user-session-changed",this._authHandler),this._loadSession(),this._resumeAttemptIfAny(),this._handleKeyboard=this._handleKeyboard.bind(this),globalThis.addEventListener("keydown",this._handleKeyboard)}disconnectedCallback(){this._advanceTimer&&(clearTimeout(this._advanceTimer),this._advanceTimer=null),globalThis.removeEventListener("quiz-user-login",this._authHandler),globalThis.removeEventListener("quiz-user-session-changed",this._authHandler),globalThis.removeEventListener("keydown",this._handleKeyboard),this._cancelMegaConfetti(),super.disconnectedCallback()}_authHandler(t){const e=t&&t.detail||{};e.studentId&&(this.studentId=e.studentId),e.nama&&(this.studentName=e.nama),e.nis&&(this.studentNis=e.nis),e.absen&&(this.studentAbsen=e.absen),e.kelas&&(this.studentKelas=e.kelas)}_handleKeyboard(t){if(this._screen!=="question")return;const e=this._getActiveQuestions();if(!e||e.length===0)return;const a=t.target&&t.target.tagName;if(!(a==="INPUT"||a==="TEXTAREA"||a==="SELECT"))switch(t.key){case"ArrowLeft":t.preventDefault(),this._goToPrevQuestion();break;case"ArrowRight":t.preventDefault(),this._goToNextQuestion();break;case"Enter":!this._answered&&this._screen==="question"&&(t.preventDefault(),this._submitCurrentAnswer());break;default:const i=parseInt(t.key,10);!isNaN(i)&&i>=1&&i<=e.length&&(t.preventDefault(),this._goToQuestion(i-1));break}}_submitCurrentAnswer(){if(this._answered)return;const t=this._getActiveQuestions()[this._currentIdx];if(!t)return;const e=this._siapkanSoal(t);switch(e.type||"mc"){case"shortAnswer":this._submitShortAnswer();break;case"pgk":this._submitPGK();break;case"matching":this._submitMatching();break;case"mc":e.isMulti&&this._submitMultiAnswers();break}}_loadSession(){try{const t=JSON.parse(globalThis.localStorage.getItem("quiz_user_session"));if(!t||!t.studentId)return;if(t.expiresAt&&Date.now()>t.expiresAt){globalThis.localStorage.removeItem("quiz_user_session");return}this.studentId=t.studentId||"",this.studentName=t.nama||"",this.studentNis=t.nis||"",this.studentAbsen=t.absen||"",this.studentKelas=t.kelas||""}catch{}}_cancelMegaConfetti(){this._megaConfettiFrameId&&(globalThis.cancelAnimationFrame(this._megaConfettiFrameId),this._megaConfettiFrameId=null)}_onTimerExpired(){this._screen==="question"&&this._selesaiKuis()}forceFinish(){this._selesaiKuis()}async _muatBankSoal(){if(!(this._bankLoaded||!this.appsScriptUrl||this.hasAttribute("questions"))){this._bankLoaded=!0;try{const t=this.appsScriptUrl.includes("?")?"&":"?",e=await fetch(this.appsScriptUrl+t+"action=getBankSoal");if(!e.ok)return;const a=await e.text(),i=JSON.parse(a);if(i&&i.status==="ok"&&Array.isArray(i.soal)){const r=i.soal.filter(s=>s&&(s.soal||s.question)&&(Array.isArray(s.choices)?s.choices.length>=2:!0));r.length>0&&(this.questions=r.slice(0,10),this._bankStatus="Soal dimuat dari Bank Soal (AKM).",this.requestUpdate())}}catch{}}}_getChoiceText(t){return typeof t=="string"?t:t&&t.text||""}_getChoiceImage(t){return t&&typeof t=="object"&&t.image||""}_normalisasiSoal(t){if(!t)return null;if(t&&Array.isArray(t.choices)&&t.choices.length)return t;const e=[t.a,t.b,t.c,t.d,t.e,t.f].filter(i=>i!==""&&i!=null&&i!==void 0);if(!e.length)return t;const a=["a","b","c","d","e","f"];return{...t,question:t.question||t.q||"",choices:e,correctIndex:typeof t.correctIndex=="number"?t.correctIndex:a.indexOf(String(t.k).toLowerCase())}}_siapkanSoal(t){if(!t)return null;const e=this._normalisasiSoal(t);let a=[],i=[];Array.isArray(e.choices)&&e.choices.length&&(a=e.choices.map(l=>this._getChoiceText(l)),i=e.choices.map(l=>this._getChoiceImage(l))),a.length||(a=["Pilihan A","Pilihan B"]),i.length||(i=a.map(()=>""));let r=null,s=[];const d=["a","b","c","d","e","f"];if(Array.isArray(e.correctAnswers))s=e.correctAnswers;else if(typeof e.correctIndex=="number"&&e.correctIndex>=0&&e.correctIndex<a.length)s=[e.correctIndex];else if(e.correctIndex!=null&&!isNaN(parseInt(e.correctIndex,10))){const l=parseInt(e.correctIndex,10);l>=0&&l<a.length&&(s=[l])}else e.k!=null&&d.includes(String(e.k).toLowerCase())&&(s=[d.indexOf(String(e.k).toLowerCase())]);return s[0]!=null&&(r=a[s[0]]),r===null&&(r=a[0]),{type:e.type||"mc",teks:e.question||e.q||e.soal||"",image:e.image||"",pilihan:a,pilihanImages:i,kunci:r,correctAnswers:s,isMulti:s.length>1,statements:Array.isArray(e.statements)?e.statements:[],leftItems:Array.isArray(e.leftItems)?e.leftItems:[],rightItems:Array.isArray(e.rightItems)?e.rightItems:[],correctPairs:e.correctPairs||{},acceptedAnswers:Array.isArray(e.acceptedAnswers)?e.acceptedAnswers:[],hint:e.hint||"",originalIndex:e._originalIndex>=0?e._originalIndex:null}}_fireConfetti(){if(!(this.hideConfetti||typeof this._confettiFn!="function"))try{const t={ticks:220,gravity:.85,decay:.92,startVelocity:42,zIndex:9999};this._confettiFn({...t,particleCount:70,spread:85,scalar:1.05,origin:{x:.5,y:.62}}),this._confettiFn({...t,particleCount:45,angle:58,spread:65,scalar:1.1,origin:{x:.1,y:.7}}),this._confettiFn({...t,particleCount:45,angle:122,spread:65,scalar:1.1,origin:{x:.9,y:.7}})}catch(t){console.error("[kuis-ledakan] Konfeti gagal dieksekusi",t)}}_fireMegaConfetti(){if(!(this.hideConfetti||typeof this._confettiFn!="function"))try{this._cancelMegaConfetti();const t=Date.now()+900,e=()=>{this._confettiFn({particleCount:3,angle:60,spread:55,origin:{x:0,y:.7},colors:["#ff0000","#00ff00","#0000ff","#ffff00"]}),this._confettiFn({particleCount:3,angle:120,spread:55,origin:{x:1,y:.7},colors:["#ff0000","#00ff00","#0000ff","#ffff00"]}),Date.now()<t?this._megaConfettiFrameId=globalThis.requestAnimationFrame(e):this._megaConfettiFrameId=null};this._megaConfettiFrameId=globalThis.requestAnimationFrame(e)}catch(t){console.error("[kuis-ledakan] Mega konfeti gagal dieksekusi",t)}}_shuffleArray(t){const e=[...t];for(let a=e.length-1;a>0;a--){const i=Math.floor(Math.random()*(a+1));[e[a],e[i]]=[e[i],e[a]]}return e}get _inHaxEditor(){return!!(globalThis.HaxStore&&typeof globalThis.HaxStore.requestAvailability=="function"&&globalThis.HaxStore.requestAvailability().editMode)}_maxPoinSoal(t){if(!t)return 1;if(t.type==="pgk"){const e=Array.isArray(t.statements)?t.statements.length:0;return t.points!=null?t.points:e||1}if(t.type==="matching"){const e=Array.isArray(t.leftItems)?t.leftItems.length:0;return t.points!=null?t.points:e||1}return t.points||1}_startQuiz(){this._screen="question",this._currentIdx=0,this._score=0,this._confettiFired=!1,this._answeredSet=new Set,this._userAnswers=new Map,this._reviewMode=!1,this._questionStartTime=Date.now();const t=Array.isArray(this._shuffledQuestions)&&this._shuffledQuestions.length>0;let e=Array.isArray(this.questions)?this.questions:St;t?e=this._shuffledQuestions:(this.shuffleQuestions&&(e=this._shuffleArray(e)),Array.isArray(e)||(e=St)),this._maxPoints=(this.questions||[]).reduce((a,i)=>a+this._maxPoinSoal(i),0)||1,t||(this._buatSessionToken(),this._saveSessionToken(),this.shuffleChoices?this._shuffledQuestions=e.map((a,i)=>{if(!Array.isArray(a.choices)||a.type==="pgk"||a.type==="matching")return{...a,_originalIndex:i};const r=a.choices.map((d,l)=>({text:d,origIndex:l})),s=this._shuffleArray(r);return{...a,choices:s.map(d=>d.text),_correctMap:s.map(d=>d.origIndex),_originalIndex:i}}):this._shuffledQuestions=e.map((a,i)=>({...a,_originalIndex:a._originalIndex??i}))),Array.isArray(this._shuffledQuestions)||(this._shuffledQuestions=[]),this._resetState(),this._autoSaveInterval=setInterval(()=>{this._screen==="question"&&this.lockAfterComplete&&this.studentId&&this.kdMateri&&this._saveAttempt()},15e3),this.lockAfterComplete&&this.studentId&&this.kdMateri&&(this._attemptStart=Date.now(),this._saveAttempt()),!t&&this.lockAfterComplete&&this.studentId&&this.kdMateri&&this.kategori!=="formatif"&&this._logActivity("timer_mulai",{kategori:this.kategori||"sumatif_lm",kdMateri:this.kdMateri,metadataKuis:this.judul,timestamp:new Date().toISOString(),durasiUlangan:this.timerDuration||this.duration||300})}_saveAttempt(){if(!(!this.lockAfterComplete||!this.studentId||!this.kdMateri))try{const t=Array.from(this._userAnswers.entries()).map(([e,a])=>[e,a]);localStorage.setItem(this._attemptKey(),JSON.stringify({start:this._attemptStart,duration:this.timerDuration,questions:this._shuffledQuestions,userAnswers:t,currentIdx:this._currentIdx,sessionToken:this._sessionToken}))}catch{}}_sessionTokenKey(){return`kuis-ledakan:session:${this.studentId}:${this.kdMateri}`}_buatSessionToken(){try{const t=new Uint8Array(16);globalThis.crypto.getRandomValues(t);let e="";return t.forEach(a=>e+=a.toString(16).padStart(2,"0")),this._sessionToken=`${Date.now()}-${e}`,this._sessionToken}catch{return this._sessionToken=`sess-${Date.now()}-${Math.random().toString(36).slice(2,10)}`,this._sessionToken}}_saveSessionToken(){if(!(!this.studentId||!this.kdMateri||!this._sessionToken))try{localStorage.setItem(this._sessionTokenKey(),JSON.stringify({token:this._sessionToken,start:Date.now(),duration:this.timerDuration||this.duration||300}))}catch{}}_loadSessionToken(){if(!this.studentId||!this.kdMateri)return null;try{const t=JSON.parse(localStorage.getItem(this._sessionTokenKey())||"null");return!t||!t.token?null:Date.now()-t.start>t.duration*1e3+6e4?(localStorage.removeItem(this._sessionTokenKey()),null):(this._sessionToken=t.token,t.token)}catch{return null}}_clearSessionToken(){if(this._sessionToken=null,this.studentId&&this.kdMateri)try{localStorage.removeItem(this._sessionTokenKey())}catch{}}_cekSesiAktif(){const t=this._loadSessionToken();return t?(this._sessionExpired=!1,{active:!0,token:t}):(this._sessionExpired=!0,{active:!1,token:null})}_getActiveQuestions(){return this._shuffledQuestions.length>0?this._shuffledQuestions:this.questions}_resetState(){this._selected=-1,this._selectedAnswers=new Set,this._matchAnswers={},this._shortAnswerText="",this._answered=!1,this._feedbackText="",this._feedbackPositive=!1}_pilihJawaban(t,e){if(!this.editable&&(this._answered||this._userAnswers.has(this._currentIdx)))return;const a=this._getActiveQuestions(),i=this._normalisasiSoal(a[this._currentIdx]),r=this._siapkanSoal(i);let s=!1;if(r.isMulti){const m=new Set(this._selectedAnswers);m.has(t)?m.delete(t):m.add(t),this._selectedAnswers=m,this._selected=t,this.requestUpdate();return}const d=this._userAnswers.get(this._currentIdx);d&&d.points&&(this._score-=d.points),this._selected=t,this._answered=!0;const l=i._correctMap?r.correctAnswers.map(m=>i._correctMap.indexOf(m)):r.correctAnswers;if(s=l.includes(t),s)this._score+=i.points||1,this._fireConfetti(),this.hideAnswers||(this._feedbackText="Mantap, Benar!",this._feedbackPositive=!0);else if(!this.hideAnswers){const m=l.map(w=>r.pilihan[w]).join(", ");this._feedbackText=`Yah, Salah. Jawaban benar: ${m}`,this._feedbackPositive=!1}this._answeredSet.add(this._currentIdx);const c=this._quizEngine.getAnswerTime();this._quizEngine.isSuspiciousTiming(c)&&this._logActivity("suspicious_timing",{questionIndex:this._currentIdx,answerTimeMs:c,minThresholdMs:3e3});const u=this._scoreCalculator.calculateScore(s,i.points||1);this._userAnswers.set(this._currentIdx,{selected:t,isCorrect:s,points:s?i.points||1:0,score:u,answerTime:c,timestamp:new Date().toISOString()}),this._saveAttempt(),this._autoAdvance()}_toggleMultiAnswer(t){if(this._answered&&!this.editable)return;const e=new Set(this._selectedAnswers);e.has(t)?e.delete(t):e.add(t),this._selectedAnswers=e,this.requestUpdate()}_submitMultiAnswers(){if(this._selectedAnswers.size===0||!this.editable&&(this._answered||this._userAnswers.has(this._currentIdx)))return;const t=this._getActiveQuestions(),e=this._normalisasiSoal(t[this._currentIdx]),a=this._siapkanSoal(e),i=this._userAnswers.get(this._currentIdx);i&&i.points&&(this._score-=i.points),this._answered=!0;const r=new Set(a.correctAnswers),s=e._correctMap?new Set([...this._selectedAnswers].map(l=>e._correctMap[l])):this._selectedAnswers,d=r.size===s.size&&[...r].every(l=>s.has(l));if(d)this._score+=e.points||1,this._fireConfetti(),this.hideAnswers||(this._feedbackText="Mantap, Benar!",this._feedbackPositive=!0);else if(!this.hideAnswers){const l=[...r].map(c=>{const u=e._correctMap?e._correctMap.indexOf(c):c;return a.pilihan[u]}).join(", ");this._feedbackText=`Jawaban belum tepat. Kunci: ${l}`,this._feedbackPositive=!1}this._answeredSet.add(this._currentIdx),this._userAnswers.set(this._currentIdx,{selectedAnswers:new Set(this._selectedAnswers),isCorrect:d,points:d?e.points||1:0}),this._saveAttempt(),this._autoAdvance()}_setPGK(t,e){this._answered&&!this.editable||(this._matchAnswers={...this._matchAnswers,[t]:e})}_submitPGK(){if(!this.editable&&(this._answered||this._userAnswers.has(this._currentIdx)))return;const t=this._getActiveQuestions()[this._currentIdx],e=this._siapkanSoal(t).statements||[];if(Object.keys(this._matchAnswers).length<e.length){this._feedbackText="Pilih Benar atau Salah untuk semua pernyataan.",this._feedbackPositive=!1,this.requestUpdate();return}const a=this._userAnswers.get(this._currentIdx);a&&a.points&&(this._score-=a.points),this._answered=!0;const i=e.map(d=>d.answer);let r=0;for(let d=0;d<e.length;d++)this._matchAnswers[d]===i[d]&&r++;const s=e.length;if(r===s)this._score+=this._maxPoinSoal(t),this._fireConfetti(),this.hideAnswers||(this._feedbackText="Mantap, semua pernyataan benar!",this._feedbackPositive=!0);else if(this._score+=r,!this.hideAnswers){const d=e.map((l,c)=>`${c+1}: ${l.answer?"Benar":"Salah"}`).join(", ");this._feedbackText=`${r}/${s} pernyataan benar (+${r} poin). Kunci: ${d}`,this._feedbackPositive=r>0}this._answeredSet.add(this._currentIdx),this._userAnswers.set(this._currentIdx,{selected:{...this._matchAnswers},isCorrect:r===s,points:r,correctAnswers:e.map((d,l)=>d.answer)}),this._saveAttempt(),this._autoAdvance()}_submitMatching(){if(!this.editable&&(this._answered||this._userAnswers.has(this._currentIdx)))return;const t=this._getActiveQuestions()[this._currentIdx],e=this._siapkanSoal(t),a=e.leftItems||[];if(Object.keys(this._matchAnswers).length<a.length){this._feedbackText="Pilih pasangan untuk semua item kiri.",this._feedbackPositive=!1,this.requestUpdate();return}const i=this._userAnswers.get(this._currentIdx);i&&i.points&&(this._score-=i.points),this._answered=!0;let r=0;for(let l=0;l<a.length;l++)this._matchAnswers[l]===e.correctPairs[l]&&r++;const s=this._maxPoinSoal(t),d=Math.min(r,s);if(this._score+=d,!this.hideAnswers)if(r===a.length)this._feedbackText=`Mantap, Benar! (${r}/${a.length} pasangan, +${d} poin)`,this._feedbackPositive=!0;else if(r>0)this._feedbackText=`${r}/${a.length} pasangan benar (+${d} poin). Lanjutkan!`,this._feedbackPositive=!0;else{const l=Object.entries(e.correctPairs).map(([c,u])=>`${parseInt(c)+1}\u2192${String.fromCharCode(65+u)}`).join(", ");this._feedbackText=`Yah, Salah. Kunci: ${l}`,this._feedbackPositive=!1}!this.hideConfetti&&r===a.length&&this._fireConfetti(),this._answeredSet.add(this._currentIdx),this._userAnswers.set(this._currentIdx,{selected:{...this._matchAnswers},isCorrect:r===a.length,points:d,correctPairs:e.correctPairs}),this._saveAttempt(),this._autoAdvance()}_submitShortAnswer(){if(!this.editable&&(this._answered||this._userAnswers.has(this._currentIdx)))return;const t=this._shortAnswerText.trim().toLowerCase();if(!t){this._feedbackText="Ketik jawaban terlebih dahulu.",this._feedbackPositive=!1,this.requestUpdate();return}const e=this._getActiveQuestions()[this._currentIdx],a=this._siapkanSoal(e),i=this._userAnswers.get(this._currentIdx);i&&i.points&&(this._score-=i.points),this._answered=!0;const r=(a.acceptedAnswers||[]).map(s=>s.toLowerCase()).some(s=>t.includes(s));r?(this._score+=e.points||1,this._fireConfetti(),this.hideAnswers||(this._feedbackText="Mantap, Benar!",this._feedbackPositive=!0)):this.hideAnswers||(this._feedbackText=`Yah, Salah. Jawaban benar: ${(a.acceptedAnswers||[]).join(" / ")}`,this._feedbackPositive=!1),this._answeredSet.add(this._currentIdx),this._userAnswers.set(this._currentIdx,{text:this._shortAnswerText,isCorrect:r,points:r?e.points||1:0,correctAnswers:a.acceptedAnswers||[]}),this._saveAttempt(),this._autoAdvance()}_restoreAnswerState(t){const e=this._userAnswers.get(t);if(!e)return;const a=i=>i instanceof Set?i:Array.isArray(i)?new Set(i):i&&typeof i=="object"?new Set(Object.values(i)):new Set;if(e.selectedAnswers?(this._selectedAnswers=a(e.selectedAnswers),this._answered=!0):typeof e.selected=="number"?(this._selected=e.selected,this._answered=!0):e.text?(this._shortAnswerText=e.text,this._answered=!0):e.selected&&typeof e.selected=="object"&&(this._matchAnswers={...e.selected},this._answered=!0),this._answered&&(this._answeredSet.add(t),!this.hideAnswers)){const i=this._getActiveQuestions()[t],r=i?this._siapkanSoal(this._normalisasiSoal(i)):null;if(e.isCorrect)this._feedbackText=r&&r.type==="pgk"?"Mantap, semua pernyataan benar!":(r&&r.type,"Mantap, Benar!"),this._feedbackPositive=!0;else if(e.isCorrect===!1){if(r&&r.type==="shortAnswer"){const s=(r.acceptedAnswers||[]).join(" / ");this._feedbackText=s?"Yah, Salah. Jawaban benar: "+s:"Yah, Salah."}else if(r&&r.type==="pgk")this._feedbackText="Jawaban belum tepat. Periksa kembali pernyataan Anda.";else if(r&&r.type==="matching")this._feedbackText="Yah, Salah. Periksa kembali pasangan Anda.";else{const s=r?r.correctAnswers.map(function(d){return r.pilihan[d]}).join(", "):"";this._feedbackText=s?"Yah, Salah. Jawaban benar: "+s:"Yah, Salah."}this._feedbackPositive=!1}}}_resetForNavigation(){this._answered=!1,this._feedbackText="",this._feedbackPositive=!1}_canNavigateTo(t){const e=this._getActiveQuestions();return!(t<0||t>=e.length||this._screen==="result"||this.timerDuration>0&&this._resumeRemaining!==void 0&&this._resumeRemaining<=0&&t!==this._currentIdx||!this.practiceMode&&!this.allowBackwardNav&&this._answeredSet.has(t)&&t<this._currentIdx)}_goToQuestion(t){if(!this._canNavigateTo(t))return;const e=this._getActiveQuestions();t>=e.length||t!==this._currentIdx&&(this._advanceTimer&&(clearTimeout(this._advanceTimer),this._advanceTimer=null),this._currentIdx=t,this._questionStartTime=Date.now(),this._resetState(),this._restoreAnswerState(t),this.requestUpdate())}_goToPrevQuestion(){this._currentIdx>0&&this._goToQuestion(this._currentIdx-1)}_goToNextQuestion(){const t=this._getActiveQuestions();if(this._currentIdx<t.length-1){if(!this._answered&&this._currentIdx>=0){this._feedbackText="Silakan jawab soal ini terlebih dahulu.",this._feedbackPositive=!1,this.requestUpdate();return}this._currentIdx++,this._resetState(),this._restoreAnswerState(this._currentIdx),this.requestUpdate()}else this._currentIdx===t.length-1&&this._selesaiKuis()}_autoAdvance(){this.practiceMode||(this._advanceTimer&&clearTimeout(this._advanceTimer),this._advanceTimer=setTimeout(()=>{this._advanceTimer=null;const t=this._getActiveQuestions();this._currentIdx<t.length-1&&(this._currentIdx++,this._resetState(),this._restoreAnswerState(this._currentIdx),this.requestUpdate())},this.questionDelay||1800))}_buatIdLog(){try{const t=new Uint8Array(8);globalThis.crypto.getRandomValues(t);let e="";return t.forEach(a=>e+=a.toString(16).padStart(2,"0")),`LOG-${Date.now()}-${e.toUpperCase()}`}catch{return`LOG-${Date.now()}-${Math.random().toString(36).substr(2,10).toUpperCase()}`}}_selesaiKuis(){if(this._screen==="result")return;this._advanceTimer&&(clearTimeout(this._advanceTimer),this._advanceTimer=null),this._autoSaveInterval&&(clearInterval(this._autoSaveInterval),this._autoSaveInterval=null),this._screen="result",this._maxPoints=(this.questions||[]).reduce((s,d)=>s+this._maxPoinSoal(d),0)||1;const t=de.calculatePercentage(this._score,this._maxPoints),e=Math.max(0,Math.min(100,t));!this._confettiFired&&!this.hideConfetti&&(this._confettiFired=!0,e>=80?this._fireMegaConfetti():this._fireConfetti());const a=this._buatIdLog(),i=Array.from(this._userAnswers.entries()).map(([s,d])=>({questionIndex:s,answerTime:d.answerTime||0,timestamp:d.timestamp})),r=this._bacaAuditSingkat();this.dispatchEvent(new CustomEvent("dasbor-kuis-log",{detail:{id_log:a,tipe:"quiz",payload:{score:e,jenisKuis:this.kategori,kdMateri:this.kdMateri,kategori:this.kategori,metadataKuis:this.judul,timestamp:new Date().toISOString(),answerTimings:i,sessionToken:this._sessionToken,audit_singkat:r}},bubbles:!0,composed:!0})),this.closest("dasbor-kuis")||this._kirimHasilLangsung(a,e),this.lockAfterComplete&&(this._locked=!0),this._clearSessionToken();try{localStorage.removeItem(this._attemptKey())}catch{}}_logActivity(t,e={}){try{if(["timer_mulai","suspicious_timing","tab_switch","window_blur","window_focus"].includes(t)){this._enqueueAudit(t,e);return}this.dispatchEvent(new CustomEvent("dasbor-kuis-log",{detail:{tipe:t,payload:{...e,studentId:this.studentId,kdMateri:this.kdMateri}},bubbles:!0,composed:!0}))}catch{}}_auditQueueKey(){return`kuisAuditQueue_${this.studentId}_${this.kdMateri}`}_bacaAuditQueue(){try{const t=localStorage.getItem(this._auditQueueKey());return t?JSON.parse(t):null}catch{return null}}_simpanAuditQueue(t){try{localStorage.setItem(this._auditQueueKey(),JSON.stringify(t))}catch{}}_enqueueAudit(t,e={}){if(!this.studentId||!this.kdMateri)return null;const a=Date.now();let i=this._bacaAuditQueue();return(!i||i.state==="done")&&(i={id_log:this._buatIdLogAudit(),studentId:this.studentId,kdMateri:this.kdMateri,snapshot:{mulai_detik:this._attemptStart||a,durasi_detik:0,total_restart:0,tab_switch:0},events:[],state:"draft",versi:1}),i.events=i.events||[],i.events.push({t,ts:a,d:e}),i.events.length>200&&i.events.splice(0,i.events.length-200),(t==="tab_switch"||t==="window_blur")&&(i.snapshot.tab_switch=(i.snapshot.tab_switch||0)+1),this._simpanAuditQueue(i),i}_buatIdLogAudit(){try{const t=new Uint8Array(8);globalThis.crypto.getRandomValues(t);let e="";return t.forEach(a=>e+=a.toString(16).padStart(2,"0")),`LOG-${Date.now()}-${e.toUpperCase()}`}catch{return`LOG-${Date.now()}-${Math.random().toString(36).substr(2,10).toUpperCase()}`}}_bacaAuditSingkat(){const t=this._bacaAuditQueue();if(!t)return{total_restart:0,tab_switch:0,durasi_detik:this._attemptStart?Math.floor((Date.now()-this._attemptStart)/1e3):0};const e=t.snapshot&&t.snapshot.mulai_detik?t.snapshot.mulai_detik:this._attemptStart||Date.now(),a=Math.max(0,Math.floor((Date.now()-e)/1e3));return{total_restart:t.snapshot&&t.snapshot.total_restart||0,tab_switch:t.snapshot&&t.snapshot.tab_switch||0,durasi_detik:a}}_finalisasiAudit(){const t=this._bacaAuditQueue();t&&(t.snapshot=t.snapshot||{},t.snapshot.durasi_detik=this._bacaAuditSingkat().durasi_detik,t.state="ready",this._simpanAuditQueue(t))}_selesaiAudit(){const t=this._bacaAuditQueue();t&&(t.state="done",this._simpanAuditQueue(t))}async _kirimHasilLangsung(t,e){if(!this.appsScriptUrl||!this.studentId)return;const a=new Date().toISOString(),i={action:"logActivity",studentId:this.studentId,nama:this.studentName||"",nis:this.studentNis||"",absen:this.studentAbsen||"",kelas:this.studentKelas||"",type:"quiz",description:JSON.stringify({score:e,jenisKuis:this.kategori||"sumatif_lm",kdMateri:this.kdMateri||"",metadataKuis:this.judul,timestamp:a,audit_singkat:this._bacaAuditSingkat()}),timestamp:a,kdMateri:this.kdMateri||"",kategori:this.kategori||"sumatif_lm",id_log:t,sessionToken:this._sessionToken||"",audit_singkat:JSON.stringify(this._bacaAuditSingkat()||{})};try{const r=await(await fetch(`${this.appsScriptUrl}?${new URLSearchParams(i).toString()}`,{method:"GET",mode:"cors"})).text();let s=null;try{s=JSON.parse(r)}catch{}this._bankStatus=s&&s.status==="ok"?s.duplikat?"\u2705 Skor sudah tercatat sebelumnya (duplikat dilewati).":"\u2705 Skor & status kuis terkirim ke database V5.":s&&s.message?"\u26A0\uFE0F "+s.message:"\u26A0\uFE0F Backend merespons non-JSON \u2014 cek atribut apps-script-url.",this.requestUpdate()}catch{this._bankStatus="\u26A0\uFE0F Hasil tersimpan lokal; kirim ulang saat online.",this.requestUpdate()}}async _cekKunci(){if(!this.lockAfterComplete||!this.appsScriptUrl||!this.studentId||!this.kdMateri){this._lockChecked=!0;return}try{const t=`${this.appsScriptUrl}${this.appsScriptUrl.includes("?")?"&":"?"}action=getQuizLock&studentId=${encodeURIComponent(this.studentId)}&kdMateri=${encodeURIComponent(this.kdMateri)}`,e=await(await fetch(t,{method:"GET",mode:"cors"})).json();this._locked=!!(e&&e.locked)}catch{this._locked=!1}this._lockChecked=!0,this.requestUpdate()}async _bukaKunci(){if(!(!this.appsScriptUrl||!this.studentId||!this.kdMateri)){try{const t=`${this.appsScriptUrl}${this.appsScriptUrl.includes("?")?"&":"?"}action=resetQuizLock&studentId=${encodeURIComponent(this.studentId)}&kdMateri=${encodeURIComponent(this.kdMateri)}`;await fetch(t,{method:"GET",mode:"cors"})}catch{}this._locked=!1,this._autoSaveInterval&&(clearInterval(this._autoSaveInterval),this._autoSaveInterval=null),this._screen="start";try{localStorage.removeItem(this._attemptKey())}catch{}this.requestUpdate()}}async _onStartClick(){if(!this._starting){this._starting=!0,this.requestUpdate();try{if(!this.studentId){this._redirectToLogin();return}if(await this._cekKunci(),this._locked){this.requestUpdate();return}this._cekSesiAktif().active&&!this._locked&&(this._bankStatus="\u26A0\uFE0F Sesi kuis masih aktif. Jika Anda me-refresh, sesi sebelumnya akan dilanjutkan.",this.requestUpdate()),await this._muatBankSoal(),this._startQuiz()}finally{this._starting=!1,this.requestUpdate()}}}_redirectToLogin(){const t=document.querySelector("quiz-user-auth");t&&(t.scrollIntoView({behavior:"smooth",block:"center"}),typeof t.focus=="function"&&t.focus()),this.dispatchEvent(new CustomEvent("kuis-need-login",{bubbles:!0,composed:!0,detail:{kdMateri:this.kdMateri}})),this.requestUpdate()}_attemptKey(){return`kuis-ledakan:attempt:${this.studentId}:${this.kdMateri}`}_resumeAttemptIfAny(){if(!this.lockAfterComplete||!this.studentId||!this.kdMateri)return;let t=null;try{t=JSON.parse(localStorage.getItem(this._attemptKey())||"null")}catch{}if(!t)return;if(!Array.isArray(t.questions)||t.questions.length===0){try{localStorage.removeItem(this._attemptKey())}catch{}return}const e=Math.floor((Date.now()-t.start)/1e3),a=(t.duration||0)-e;if(a<=0){try{localStorage.removeItem(this._attemptKey())}catch{}return}this._shuffledQuestions=t.questions,this._attemptStart=t.start,this._resumeRemaining=a,this._sessionToken=t.sessionToken||this._loadSessionToken(),typeof t.currentIdx=="number"&&(this._currentIdx=t.currentIdx),Array.isArray(t.userAnswers)&&(this._userAnswers=new Map(t.userAnswers),this._restoreAnswerState(this._currentIdx)),this._screen="question",this.requestUpdate()}render(){if(this._screen==="start")return this._locked&&this.mode!=="guru"?o`
        ...
        <div class="quiz-card">
          <h3 class="quiz-title">📝 ${this.judul}</h3>
          <p style="color: var(--ddd-theme-secondary, rgba(0, 0, 0, 0.75)); text-align: center; margin-bottom: var(--ddd-spacing-5);">Selesaikan seluruh pertanyaan kuis di bawah ini secara mandiri untuk mengunci status kelulusan nilai pada lembar kendali dasbor.</p>
      ...
      `;if(this._screen==="editor")return this._renderEditorScreen();if(this._reviewMode&&this._screen==="question")return this._renderReviewScreen();if(this._screen==="question")return this._renderQuestionScreen();if(this._screen==="result"){const t=Math.round(this._score/this._maxPoints*100),e=Math.max(0,Math.min(100,t));return o`
        <div class="quiz-card result-box">
          ...
          <p class="err-chip" style="background:var(--ddd-theme-polaris-surface-hover, var(--ddd-theme-default-white, #ffffff));border-color:var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c));color:var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c));">ℹ️ Siswa: ${this.studentName||"-"} (NIS ${this.studentNis||"-"}, Kelas ${this.studentKelas||"-"})</p>
          ${this.mode==="guru"&&!this.hidePauseRestart?o`<button class="btn-start" style="background-color:var(--ddd-theme-secondary, rgba(0, 0, 0, 0.75));" @click=${()=>{this._screen="start",this.requestUpdate()}}>Ulangi Kuis</button>`:o`<span class="err-chip">ℹ️ Kuis terkunci. Hubungi guru untuk mengulang.</span>`}
    ...
    `}_renderReviewQuestion(t,e){const a=this._normalisasiSoal(e),i=this._siapkanSoal(a);if(!i)return o``;const r=this._userAnswers.get(t)||{},s=i.type||"mc",d=["A","B","C","D","E","F"],l=a._correctMap?i.correctAnswers.map(c=>a._correctMap.indexOf(c)):i.correctAnswers;return o`
      <div class="review-question">
        <div class="review-qnum">Soal ${t+1}</div>
        <div class="review-qtext">${i.teks}</div>
        ${s==="mc"?o`<ul class="review-mc">${i.pilihan.map((c,u)=>{let m="";return this.hideAnswers||(l.includes(u)?m="review-correct":(!i.isMulti&&r.selected===u||i.isMulti&&r.selectedAnswers&&r.selectedAnswers.has(u))&&(m="review-selected-wrong")),o`<li class="${m}">${d[u]||u+1}. ${c}</li>`})}</ul>`:""}
    ...
    `}_renderQuestionScreen(){const t=this._getActiveQuestions(),e=this._normalisasiSoal(t[this._currentIdx]),a=this._siapkanSoal(e);if(!a)return o`<div class="quiz-card result-box">Soal tidak valid.</div>`;const i=a.type||"mc";return o`
      <div class="quiz-card">
        <div style="display:flex; justify-content:space-between; font-size:12px; font-weight:bold; color:var(--ddd-theme-secondary, rgba(0, 0, 0, 0.75)); margin-bottom:10px;">
        ...
        ${this.showQuestionNav&&t.length>1?o`<nav class="question-nav" aria-label="Navigasi nomor soal">
              ...
              <div class="nav-grid">
              ${t.map((r,s)=>{const d=s===this._currentIdx,l=this._answeredSet.has(s),c=!l&&!d,u=!this.allowBackwardNav&&l&&s<this._currentIdx;return o`<button
                  type="button"
                  class="${`q-dot ${d?"current":""} ${l?"answered":""} ${c?"unanswered":""} ${u?"disabled":""}`}"
                  ?disabled=${u}
      ...
      <div class="matching-container">
        ${e.map((i,r)=>o`
            <div class="matching-row">
              ...
              <span>→</span>
              <select name="matching-${r}" class="matching-select" ?disabled=${this._answered&&!this.editable}
      ...
      <div class="quiz-card editor-screen">
        <header class="edit-header">
          ...
          <div style="display:flex;gap:8px;">
            ...
            <button class="btn-edit-soal" style="margin:0;background-color:var(--ddd-theme-success, var(--ddd-theme-default-success, #1e4620));" @click=${this._saveAll}>💾 Simpan</button>
          </div>
        </header>
        ...
        <div class="editor-content">
          <form class="add-question-form">
            <div style="display:flex;gap:8px;margin-bottom:8px;align-items:center;flex-wrap:wrap;">
              ...
              <label style="font-size:12px;color:var(--ddd-theme-secondary, rgba(0, 0, 0, 0.75));white-space:nowrap;">Poin:</label>
            ...
            ${this._tempQuestionImage?o`<div style="text-align:center;margin:8px 0;"><img src=${this._tempQuestionImage} style="max-width:200px;border-radius:6px;border:1px solid var(--ddd-theme-polaris-border, var(--ddd-theme-default-limestoneLight, #e4e5e7));" alt="Pratinjau gambar soal" /></div>`:""}
                ...
                ${this._editingIndex===a?o`
                  <div class="edit-form">
                    ...
                    <div style="display:flex;gap:8px;margin-top:8px;">
                      ...
                      <button type="button" class="btn-submit" style="background:var(--ddd-theme-secondary, rgba(0, 0, 0, 0.75));" @click=${this._cancelEditQuestion}>Batal</button>
                    </div>
                  </div>
                `:o`
                  <div style="display:flex;justify-content:space-between;align-items:center;gap:8px;flex-wrap:wrap;">
                    <div>
                      <strong style="color:var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c));">[${(e.type||"mc").toUpperCase()}]</strong> ${e.question}
                      ${e.image?o`<span style="font-size:11px;color:var(--ddd-theme-secondary, rgba(0, 0, 0, 0.75));">[gambar]</span>`:""}
                      <span style="font-size:11px;color:var(--ddd-theme-success, var(--ddd-theme-default-success, #1e4620));font-weight:bold;">[${e.points||1} poin]</span>
                    </div>
                    <div style="display:flex;gap:6px;">
                      <button class="btn-edit-soal" style="margin:0;padding:4px 10px;" @click=${()=>this._startEditQuestion(a)}>✏️ Edit</button>
                      <button class="btn-edit-soal" style="margin:0;padding:4px 10px;background-color:var(--ddd-theme-error, var(--ddd-theme-default-error, #5f2120));" @click=${()=>this._deleteQuestion(a)}>🗑️</button>
                    </div>
                  </div>
                `}
              </div>
    ...
    `}_renderEditorMC(){return this._tempCorrectAnswers.length>1,o`
      ...
      ${this._tempCorrectAnswers.length<=1?o`<div style="font-size:11px;color:var(--ddd-theme-secondary, rgba(0, 0, 0, 0.75));margin-top:4px;">Centang 1 jawaban benar. Centang lebih dari 1 untuk mode PG Kompleks.</div>`:o`<div style="font-size:11px;color:var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c));margin-top:4px;font-weight:bold;">Mode PG Kompleks: ${this._tempCorrectAnswers.length} jawaban benar dipilih</div>`}
    `}_renderEditorPGK(){const t=Array.isArray(this._tempStatements)?this._tempStatements:[];return o`<div style="margin:8px 0;font-size:13px;">
      ...
      ${t.map((e,a)=>o`
        <div style="display:flex;gap:6px;align-items:center;margin-bottom:6px;flex-wrap:wrap;">
          ...
          <button type="button" style="font-size:11px;padding:2px 8px;border-radius:4px;border:1px solid var(--ddd-theme-polaris-border, var(--ddd-theme-default-limestoneLight, #e4e5e7));cursor:pointer;background:var(--ddd-theme-error-light, var(--ddd-theme-default-errorLight, #fdeded));color:var(--ddd-theme-error, var(--ddd-theme-default-error, #5f2120));"
            @click=${()=>{this._tempStatements=this._tempStatements.filter((i,r)=>r!==a)}}>🗑️</button>
        </div>
      `)}
      <button type="button" style="font-size:11px;margin-top:4px;padding:2px 8px;border-radius:4px;border:1px solid var(--ddd-theme-polaris-border, var(--ddd-theme-default-limestoneLight, #e4e5e7));cursor:pointer;"
    ...
    `}_renderKehadiran(){const t=this._weekly(),e=this._streak(),a=this._heatmap(),i=this._logs||[],r=this.thresholds,s=64,d=2*Math.PI*s,l=d-t.pct/100*d,c=["Sen","Sel","Rab","Kam","Jum","Sab","Min"];return o`
      <div class="c">
  ...
  a      @media (prefers-color-scheme: dark) {
    ...
    `}static get haxProperties(){return{api:"1",canScale:!0,canPosition:!0,canEditSource:!1,type:"element",designSystem:{accent:!0,primary:!0,card:!0,text:!0,designTreatment:!1},gizmo:{title:"Timer Materi & Kuis",description:"Dua timer terpisah untuk membaca materi dan mengerjakan kuis",icon:"icons:timer",color:"purple",tags:["Education","Timer","Quiz","Materi"]},settings:{configure:[{property:"durasiMateri",title:"Durasi Materi (detik)",inputMethod:"number",description:"Lama waktu membaca materi dalam detik",default:600},{property:"durasiKuis",title:"Durasi Kuis (detik)",inputMethod:"number",description:"Lama waktu mengerjakan kuis dalam detik",default:300},{property:"autostartMateri",title:"Mulai Timer Materi Otomatis",inputMethod:"boolean",default:!1}]},saveOptions:{unsetAttributes:[]},demoSchema:[{tag:"timer-materi-kuis",properties:{durasiMateri:600,durasiKuis:300,autostartMateri:!1},content:""},{tag:"timer-materi-kuis",properties:{durasiMateri:30,durasiKuis:15,autostartMateri:!0},content:""}]}}}customElements.get(Lt.tag)||globalThis.customElements.define(Lt.tag,Lt);class ea{constructor(t,e={}){this.host=t,this.tabSwitchThreshold=e.tabSwitchThreshold||3,this.tabSwitchCount=0,this.visibilityChangeCount=0,this.windowBlurCount=0,this.windowFocusCount=0,this.warningCount=0,this.cheatLogged=!1,this.forceChoiceDialog=!1,this.tabSwitchWarning=!1,this.fullscreenWarning=!1,this.sessionToken="",this.waktuMulai=null,this._onVisibilityChange=this._onVisibilityChange.bind(this),this._onWindowBlur=this._onWindowBlur.bind(this),this._onWindowFocus=this._onWindowFocus.bind(this),this._onFullscreenChange=this._onFullscreenChange.bind(this),this._preventCopy=this._preventCopy.bind(this),this._preventPaste=this._preventPaste.bind(this),this._preventContext=this._preventContext.bind(this),this._preventSelect=this._preventSelect.bind(this),this._handleWarningKeydown=this._handleWarningKeydown.bind(this)}get studentId(){return this.host.studentId||""}get kdMateri(){return this.host.kdMateri||""}get appsScriptUrl(){return this.host.appsScriptUrl||""}get kategori(){return this.host.kategori||"sumatif_lm"}get duration(){return this.host.duration||300}_antiCheatKey(){return`latihan_kuis_anticheat_${this.studentId}_${this.kdMateri}`}_timerKey(){return`latihan_kuis_time_${this.studentId}_${this.kdMateri}`}_auditQueueKey(){return`kuisAuditQueue_${this.studentId}_${this.kdMateri}`}saveState(){if(!(!this.studentId||!this.kdMateri))try{const t={windowBlurCount:this.windowBlurCount||0,windowFocusCount:this.windowFocusCount||0,tabSwitchCount:this.tabSwitchCount||0,visibilityChangeCount:this.visibilityChangeCount||0,timestamp:Date.now()};globalThis.localStorage.setItem(this._antiCheatKey(),JSON.stringify(t))}catch{}}restoreState(){if(!(!this.studentId||!this.kdMateri))try{const t=JSON.parse(globalThis.localStorage.getItem(this._antiCheatKey()));t&&(this.windowBlurCount=t.windowBlurCount||0,this.windowFocusCount=t.windowFocusCount||0,this.tabSwitchCount=t.tabSwitchCount||0,this.visibilityChangeCount=t.visibilityChangeCount||0)}catch{}}clearState(){if(!(!this.studentId||!this.kdMateri))try{globalThis.localStorage.removeItem(this._antiCheatKey())}catch{}}simpanWaktuMulai(t){if(!(!this.studentId||!this.kdMateri))try{globalThis.localStorage.setItem(this._timerKey(),JSON.stringify({start:t,duration:this.duration}))}catch{}}bacaSisaWaktu(){if(!this.studentId||!this.kdMateri)return 0;try{const t=JSON.parse(globalThis.localStorage.getItem(this._timerKey())||"null");if(!t)return 0;const e=t.duration-Math.floor((Date.now()-t.start)/1e3);return e>0?e:0}catch{return 0}}hapusWaktuMulai(){try{globalThis.localStorage.removeItem(this._timerKey())}catch{}}cekWaktuSerakah(){const t=this.bacaSisaWaktu();return t>60?(this._dispatchSelf("time-manipulation",{sisaWaktu:t,tabSwitchCount:this.tabSwitchCount||0,visibilityChanges:this.visibilityChangeCount||0,message:"Timer expired but client still has significant time remaining (>60s). Possible causes: browser throttling (normal) or time manipulation (cheating).",timestamp:Date.now()}),!0):!1}_bacaAuditQueue(){try{const t=JSON.parse(globalThis.localStorage.getItem(this._auditQueueKey())||"null");return t&&t.versi===1?t:null}catch{return null}}_simpanAuditQueue(t){try{globalThis.localStorage.setItem(this._auditQueueKey(),JSON.stringify(t))}catch{}}enqueueAudit(t,e={}){if(!this.studentId||!this.kdMateri)return null;const a=Date.now();let i=this._bacaAuditQueue();return(!i||i.state==="done")&&(i={id_log:this._buatIdLog(),studentId:this.studentId,kdMateri:this.kdMateri,snapshot:{mulai_detik:this.waktuMulai||a,durasi_detik:0,total_restart:0,tab_switch:0},events:[],state:"draft",versi:1}),i.events=i.events||[],i.events.push({t,ts:a,d:e}),i.events.length>200&&i.events.splice(0,i.events.length-200),t==="tab_switch"&&(i.snapshot.tab_switch=(i.snapshot.tab_switch||0)+1),t==="restart"&&(i.snapshot.total_restart=(i.snapshot.total_restart||0)+1,i.snapshot.mulai_detik=a),this._simpanAuditQueue(i),i}enqueueTabSwitch(){this.enqueueAudit("tab_switch",{timestamp:new Date().toISOString()})}_buatIdLog(){try{const t=new Uint8Array(8);globalThis.crypto.getRandomValues(t);let e="";return t.forEach(a=>e+=a.toString(16).padStart(2,"0")),`LOG-${Date.now()}-${e.toUpperCase()}`}catch{return`LOG-${Date.now()}-${Math.random().toString(36).substr(2,10).toUpperCase()}`}}bacaAuditSingkat(){const t=this._bacaAuditQueue();if(!t)return{total_restart:0,tab_switch:0,durasi_detik:0};const e=t.snapshot.durasi_detik||(t.snapshot.mulai_detik?Math.max(0,Math.floor((Date.now()-t.snapshot.mulai_detik)/1e3)):0);return{total_restart:t.snapshot.total_restart||0,tab_switch:t.snapshot.tab_switch||0,durasi_detik:e}}finalisasiAudit(){const t=this._bacaAuditQueue();t&&(t.snapshot.mulai_detik&&(t.snapshot.durasi_detik=Math.max(0,Math.floor((Date.now()-t.snapshot.mulai_detik)/1e3))),t.state="ready",this._simpanAuditQueue(t))}selesaiAudit(){const t=this._bacaAuditQueue();t&&(t.state="done",this._simpanAuditQueue(t))}generateSessionToken(){try{const t=new Uint8Array(16);globalThis.crypto.getRandomValues(t);let e="";return t.forEach(a=>e+=a.toString(16).padStart(2,"0")),`${Date.now()}-${e}`}catch{return`sess-${Date.now()}-${Math.random().toString(36).slice(2,10)}`}}requestFullscreen(){try{const t=this.host.shadowRoot||this.host;t.requestFullscreen?t.requestFullscreen().catch(()=>{}):t.mozRequestFullScreen?t.mozRequestFullScreen().catch(()=>{}):t.webkitRequestFullscreen?t.webkitRequestFullscreen():t.msRequestFullscreen&&t.msRequestFullscreen()}catch{}}_dispatchSelf(t,e){this.host.dispatchEvent(new CustomEvent("anti-cheat-event",{detail:{type:t,...e},bubbles:!0,composed:!0}))}attach(){globalThis.addEventListener("visibilitychange",this._onVisibilityChange),globalThis.addEventListener("blur",this._onWindowBlur,!0),globalThis.addEventListener("focus",this._onWindowFocus,!0),globalThis.addEventListener("fullscreenchange",this._onFullscreenChange),globalThis.addEventListener("mozfullscreenchange",this._onFullscreenChange),globalThis.addEventListener("webkitfullscreenchange",this._onFullscreenChange),globalThis.addEventListener("MSFullscreenChange",this._onFullscreenChange),this.host.addEventListener("copy",this._preventCopy),this.host.addEventListener("paste",this._preventPaste),this.host.addEventListener("contextmenu",this._preventContext),this.host.addEventListener("selectstart",this._preventSelect),document.addEventListener("keydown",this._handleWarningKeydown)}detach(){globalThis.removeEventListener("visibilitychange",this._onVisibilityChange),globalThis.removeEventListener("blur",this._onWindowBlur,!0),globalThis.removeEventListener("focus",this._onWindowFocus,!0),globalThis.removeEventListener("fullscreenchange",this._onFullscreenChange),globalThis.removeEventListener("mozfullscreenchange",this._onFullscreenChange),globalThis.removeEventListener("webkitfullscreenchange",this._onFullscreenChange),globalThis.removeEventListener("MSFullscreenChange",this._onFullscreenChange),this.host.removeEventListener("copy",this._preventCopy),this.host.removeEventListener("paste",this._preventPaste),this.host.removeEventListener("contextmenu",this._preventContext),this.host.removeEventListener("selectstart",this._preventSelect),document.removeEventListener("keydown",this._handleWarningKeydown)}_onVisibilityChange(){this.visibilityChangeCount=(this.visibilityChangeCount||0)+1;const t=this.host._mulai&&!this.host._selesai;if(document.visibilityState==="hidden"&&t){const e=this.host._bacaSisaWaktu?this.host._bacaSisaWaktu():this.bacaSisaWaktu();if(e>0)try{const i=`latihan_kuis_remaining_${this.studentId}_${this.kdMateri}`;globalThis.localStorage.setItem(i,String(e))}catch{}this.tabSwitchCount=(this.tabSwitchCount||0)+1,this.windowBlurCount=(this.windowBlurCount||0)+1,this.tabSwitchWarning=!0,this.enqueueTabSwitch(),this._dispatchSelf("tab-switch",{count:this.tabSwitchCount});const a=this.host.shadowRoot&&this.host.shadowRoot.querySelector("kuis-ledakan");if(a&&typeof a._saveAttempt=="function")try{a._saveAttempt()}catch{}this.saveState(),this.warningCount=(this.warningCount||0)+1,this.warningCount>=this.tabSwitchThreshold&&!this.forceChoiceDialog&&(this.forceChoiceDialog=!0,this._dispatchSelf("force-choice",{warningCount:this.warningCount}))}else if(document.visibilityState==="visible"&&t){try{const e=`latihan_kuis_remaining_${this.studentId}_${this.kdMateri}`,a=globalThis.localStorage.getItem(e);if(a){const i=parseInt(a,10);!isNaN(i)&&i>0&&(this.host._resumeRemaining=i,globalThis.localStorage.removeItem(e),this.host.requestUpdate())}}catch{}this.windowFocusCount=(this.windowFocusCount||0)+1,this.saveState(),this._cekThresholdCurang()}}_onWindowBlur(){this.host._mulai&&!this.host._selesai&&document.hidden&&(this.tabSwitchWarning=!0,this._dispatchSelf("tab-warning"))}_onWindowFocus(){this.host._mulai&&!this.host._selesai&&(this.windowBlurCount||0)>0&&(this.tabSwitchWarning=!1,this._dispatchSelf("tab-warning-clear"),this._cekThresholdCurang())}_cekThresholdCurang(){const t=this.tabSwitchThreshold,e=this.tabSwitchCount||0;e>=t&&!this.cheatLogged&&(this.cheatLogged=!0,this._dispatchSelf("cheat",{count:e,timestamp:new Date().toISOString(),studentId:this.studentId,kdMateri:this.kdMateri,threshold:t}))}_onFullscreenChange(){document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement||document.msFullscreenElement?(this.fullscreenWarning=!1,this._dispatchSelf("fullscreen-enter")):this.host._mulai&&!this.host._selesai&&(this.fullscreenWarning=!0,this._dispatchSelf("fullscreen-exit",{timestamp:new Date().toISOString(),waktuMulai:this.waktuMulai}))}_handleWarningKeydown(t){t.key==="Escape"&&this.tabSwitchWarning?(this.tabSwitchWarning=!1,this._dispatchSelf("tab-warning-dismiss")):t.key==="Escape"&&this.fullscreenWarning&&(this.fullscreenWarning=!1,this._dispatchSelf("fullscreen-dismiss"))}_preventCopy(t){this._guardAndPrevent("copy",t)}_preventPaste(t){this._guardAndPrevent("paste",t)}_preventContext(t){this._guardAndPrevent("contextmenu",t)}_preventSelect(t){this._guardAndPrevent("selectstart",t)}_guardAndPrevent(t,e){this.host._mulai&&!this.host._selesai&&(e.preventDefault(),e.stopPropagation(),this._dispatchSelf("copy-paste-attempt",{eventType:t,timestamp:new Date().toISOString()}))}resetCounters(){this.tabSwitchCount=0,this.visibilityChangeCount=0,this.windowBlurCount=0,this.windowFocusCount=0,this.warningCount=0,this.cheatLogged=!1,this.forceChoiceDialog=!1,this.tabSwitchWarning=!1,this.fullscreenWarning=!1,this.clearState()}get isActive(){return!!(this.host._mulai&&!this.host._selesai)}}class dt extends O(j(F)){static get tag(){return"quiz-user-auth"}static get properties(){return{...super.properties,appsScriptUrl:{type:String,attribute:"apps-script-url",reflect:!0},autoLogin:{type:Boolean,attribute:"auto-login",reflect:!0},_screen:{state:!0},_nama:{state:!0},_email:{state:!0},_nis:{state:!0},_absen:{state:!0},_kelas:{state:!0},_role:{state:!0},_studentId:{state:!0},_errorMsg:{state:!0},_successMsg:{state:!0},_loading:{state:!0},_verifyError:{state:!0},_verifyMsg:{state:!0}}}constructor(){super(),this.basePath=new URL(".",import.meta.url).href,this.appsScriptUrl="",this.autoLogin=!0,this._screen="check",this._nama="",this._email="",this._nis="",this._absen="",this._kelas="",this._role="",this._studentId="",this._errorMsg="",this._successMsg="",this._loading=!1,this._verifyError=!1,this._verifyMsg="",this._sessionInterval=null}connectedCallback(){if(super.connectedCallback(),globalThis.HaxStore&&typeof globalThis.HaxStore.requestAvailability=="function"){const e=globalThis.HaxStore.requestAvailability();e&&!e.elementList[dt.tag]&&(e.elementList[dt.tag]=dt.haxProperties)}this.registerLocalization({context:this,localesPath:`${this.basePath}locales/`});const t=this._load("quiz_user_session");if(t&&t.studentId){if(this._studentId=t.studentId,this._nama=t.nama,this._email=t.email||"",this._nis=t.nis||"",this._absen=t.absen||"",this._kelas=t.kelas||"",this._role=t.role||"",this._role)try{sessionStorage.setItem("hax_role",this._role)}catch{}this._screen="logged-in",this.autoLogin&&this._dispatchLogin(),this._startSessionWatch(),!this._absen&&this._nis&&setTimeout(()=>this._verifySession(),300)}else this._screen="login"}disconnectedCallback(){this._sessionInterval&&(clearInterval(this._sessionInterval),this._sessionInterval=null),super.disconnectedCallback()}_load(t){try{const e=JSON.parse(localStorage.getItem(t));return e&&e.expiresAt&&Date.now()>e.expiresAt?(this._clear(t),null):e}catch{return null}}_save(t,e){try{const a={...e,expiresAt:Date.now()+864e5};localStorage.setItem(t,JSON.stringify(a))}catch{}}_clear(t){try{localStorage.removeItem(t)}catch{}}_normalizeAppsScriptUrl(){const t=String(this.appsScriptUrl||"").trim();if(!t)throw new Error("URL Apps Script belum dikonfigurasi.");let e;try{e=new URL(t)}catch{throw new Error("URL Apps Script tidak valid. Gunakan URL /exec dari deployment Web App.")}if(e.protocol!=="https:"||!/\/exec\/?$/.test(e.pathname))throw new Error("URL Apps Script harus berupa URL HTTPS /exec dari deployment Web App.");return e.toString().replace(/\/$/,"")}async _api(t,e,{maxAttempts:a=3}={}){const i=[200,400,800],r=this._normalizeAppsScriptUrl();let s=0,d=null;for(;s<a;){s++;const l=new AbortController,c=setTimeout(()=>l.abort(),6e4),u=new URLSearchParams(e);try{s>1&&console.log("retry",s),this._loading=!0;const m=await fetch(`${r}?action=${t}&${u.toString()}`,{mode:"cors",redirect:"follow",signal:l.signal});if(!m.ok)throw new Error(`Backend merespons HTTP ${m.status}.`);const w=await m.text();if(!w||w.trim().charAt(0)!=="{")throw new Error("Respon backend bukan JSON. Periksa URL /exec & deployment.");return this._loading=!1,JSON.parse(w)}catch(m){const w=m instanceof TypeError;if(m&&m.name==="AbortError")d=new Error("Waktu habis (timeout 60 detik) menghubungi server.");else if(w){let M="endpoint tidak valid";try{M=new URL(r).host}catch{}d=new Error(`Backend tidak dapat diakses dari ${globalThis.location?.origin||"origin tidak dikenal"} (action=${t}). Periksa URL /exec, redeploy Apps Script, dan set akses Web App ke Anyone. Host: ${M}.`)}else d=m;if(console.log(`retry ${s} gagal (${d.message||d})`),w)break;if(s<a){const M=i[Math.min(s-1,i.length-1)];await new Promise(k=>setTimeout(k,M))}}finally{clearTimeout(c)}}throw this._loading=!1,d}_ekstrakOk(t){const e=t&&(t.status==="ok"||t.status==="success"),a=t&&t.data||t||{};return{ok:!!e,studentId:a.student_id||a.studentId||"",nis:a.nis||"",nama:a.nama||"",email:a.email||"",absen:a.absen||"",kelas:a.kelas||"",role:a.role||"siswa",message:t&&t.message||""}}async _verifySession(){if(this.appsScriptUrl){this._loading=!0,this._verifyError=!1,this._verifyMsg="";try{const t=await this._api("verify",{studentId:this._studentId}),e=this._ekstrakOk(t);e.ok?(this._nama=e.nama||this._nama,this._nis=e.nis||this._nis,this._absen=e.absen||this._absen,this._kelas=e.kelas||this._kelas,this._screen="logged-in",this._mutasiProfilKunci(),this._dispatchLogin()):(this._verifyError=!0,this._verifyMsg=e.message||"Sesi belum terverifikasi di server.")}catch{this._verifyError=!0,this._verifyMsg="Tidak dapat memverifikasi sesi (offline?). Sesi lokal tetap aktif."}this._loading=!1}}async _handleLogin(t){if(t.preventDefault(),this._errorMsg="",!this.appsScriptUrl){this._errorMsg="URL Apps Script belum dikonfigurasi.";return}this._loading=!0;try{const e=await this._api("login",{nis:this._nis.trim(),email:this._email.trim().toLowerCase()}),a=this._ekstrakOk(e);if(a.ok&&a.studentId){this._studentId=a.studentId,this._nama=a.nama||this._nama,this._nis=a.nis||this._nis,this._absen=a.absen||this._absen,this._kelas=a.kelas||this._kelas,this._role=a.role||"siswa",this._save("quiz_user_session",{studentId:this._studentId,nama:this._nama,email:this._email.trim().toLowerCase(),nis:this._nis,absen:this._absen,kelas:this._kelas,role:this._role});try{sessionStorage.setItem("hax_role",this._role)}catch{}this._mutasiProfilKunci(),this._screen="logged-in",this._dispatchLogin(),this._startSessionWatch()}else this._errorMsg=a.message||"Login gagal"}catch(e){this._errorMsg=e.message||"Gagal menghubungi server"}this._loading=!1}async _handleRegister(t){if(t.preventDefault(),this._errorMsg="",this._successMsg="",!this.appsScriptUrl){this._errorMsg="URL Apps Script belum dikonfigurasi.";return}this._loading=!0;try{const e=await this._api("register",{nama:this._nama.trim(),email:this._email.trim().toLowerCase(),nis:this._nis.trim(),absen:this._absen.trim(),kelas:this._kelas.trim(),role:this._role||"siswa"}),a=this._ekstrakOk(e);a.ok?(this._successMsg="Pendaftaran berhasil! Silakan masuk.",this._screen="login"):this._errorMsg=a.message||"Gagal mendaftar"}catch(e){this._errorMsg=e.message||"Gagal menghubungi server."}this._loading=!1}_startSessionWatch(){this._sessionInterval&&clearInterval(this._sessionInterval),this._sessionInterval=setInterval(()=>{const t=this._load("quiz_user_session");(!t||!t.studentId)&&(this._clear("quiz_user_session"),this._studentId="",this._screen="login",globalThis.dispatchEvent(new CustomEvent("quiz-user-logout",{bubbles:!0,composed:!0})),this._dispatchSessionChanged())},6e4)}_handleLogout(){this._sessionInterval&&(clearInterval(this._sessionInterval),this._sessionInterval=null),this._clear("quiz_user_session"),this._clear("a3_v5_student_profile");try{sessionStorage.removeItem("hax_role")}catch{}this._studentId="",this._nama="",this._email="",this._nis="",this._absen="",this._kelas="",this._screen="login",globalThis.dispatchEvent(new CustomEvent("quiz-user-logout",{bubbles:!0,composed:!0})),this._dispatchSessionChanged()}_mutasiProfilKunci(){try{localStorage.setItem("a3_v5_student_profile",JSON.stringify({student_id:this._studentId,nama:this._nama,kelas:this._kelas,nis:this._nis,absen:this._absen}))}catch{}}_dispatchLogin(){globalThis.dispatchEvent(new CustomEvent("quiz-user-login",{detail:{studentId:this._studentId,nama:this._nama,email:this._email,nis:this._nis,absen:this._absen,kelas:this._kelas,role:this._role},bubbles:!0,composed:!0})),this._dispatchSessionChanged()}_dispatchSessionChanged(){const t=this._load("quiz_user_session");globalThis.dispatchEvent(new CustomEvent("quiz-user-session-changed",{detail:t,bubbles:!0,composed:!0}))}static get styles(){return[super.styles,z`
        :host {
          display: block;
          margin-bottom: var(--ddd-spacing-4);
        ...
        <div class="user-bar">
          <div class="user-info">
            ...
            <div class="user-details">
              ...
              <div class="user-meta">NIS: ${this._nis} | Absen: ${this._absen} | Kelas: ${this._kelas}${this._role?o` | <strong>${this._role==="guru"?"\u{1F468}\u200D\u{1F3EB} Guru":"\u{1F393} Siswa"}</strong>`:v}</div>
              ${this._verifyError?o`<div class="verify-note">${this._verifyMsg}</div>`:v}
            </div>
          </div>
      ...
      <div class="auth-card">
        ...
        ${this._errorMsg?o`<div class="msg msg-error">${this._errorMsg}</div>`:v}
        ${this._successMsg?o`<div class="msg msg-success">${this._successMsg}</div>`:v}
    ...
    `}static get haxProperties(){return{canScale:!1,canPosition:!0,canEditSource:!1,gizmo:{title:"Quiz User Auth",description:"Sistem login/registrasi siswa untuk dasbor-kuis",icon:"icons:account-circle",color:"purple",tags:["Education","Auth"]},settings:{configure:[{property:"appsScriptUrl",title:"Apps Script URL",inputMethod:"textfield",required:!0}],advanced:[],developer:[]},saveOptions:{unsetAttributes:["_screen","_nama","_email","_nis","_absen","_kelas","_role","_studentId","_errorMsg","_successMsg","_loading"]}}}}globalThis.customElements.define(dt.tag,dt);class ot extends O(j(F)){static get tag(){return"latihan-kuis"}static get properties(){return{...super.properties,appsScriptUrl:{type:String,attribute:"apps-script-url",reflect:!0},spreadsheetUrl:{type:String,attribute:"spreadsheet-url",reflect:!0},duration:{type:Number,attribute:"duration",reflect:!0},judulMateri:{type:String,attribute:"judul-materi",reflect:!0},teksMateri:{type:String,attribute:"teks-materi",reflect:!0},materiUrl:{type:String,attribute:"materi-url",reflect:!0},materiFile:{type:String,attribute:"materi-file",reflect:!0},coverImage:{type:String,attribute:"cover-image",reflect:!0},judulKuis:{type:String,attribute:"judul-kuis",reflect:!0},questions:{type:Array,attribute:"questions",reflect:!0},studentId:{type:String,attribute:"student-id",reflect:!0},studentName:{type:String,attribute:"student-name",reflect:!0},studentNis:{type:String,attribute:"student-nis",reflect:!0},studentAbsen:{type:String,attribute:"student-absen",reflect:!0},studentKelas:{type:String,attribute:"student-kelas",reflect:!0},kdMateri:{type:String,attribute:"kd-materi",reflect:!0},pesanWaktuHabis:{type:String,attribute:"pesan-waktu-habis",reflect:!0},pesanNilaiTerkirim:{type:String,attribute:"pesan-nilai-terkirim",reflect:!0},labelMulai:{type:String,attribute:"label-mulai",reflect:!0},showSheetLink:{type:Boolean,attribute:"show-sheet-link",reflect:!0},soalFileUrl:{type:String,attribute:"soal-file-url",reflect:!0},allowRetake:{type:Boolean,attribute:"allow-retake",reflect:!0},maxRetake:{type:Number,attribute:"max-retake",reflect:!0},mode:{type:String,attribute:"mode",reflect:!0},hidePauseRestart:{type:Boolean,attribute:"hide-pause-restart",reflect:!0},shuffleQuestions:{type:Boolean,attribute:"shuffle-questions",reflect:!0},shuffleChoices:{type:Boolean,attribute:"shuffle-choices",reflect:!0},kategori:{type:String,attribute:"kategori",reflect:!0},hideConfetti:{type:Boolean,attribute:"hide-confetti",reflect:!0},hideAnswers:{type:Boolean,attribute:"hide-answers",reflect:!0},hideScore:{type:Boolean,attribute:"hide-score",reflect:!0},showQuestionNav:{type:Boolean,attribute:"show-question-nav",reflect:!0},allowBackwardNav:{type:Boolean,attribute:"allow-backward-nav",reflect:!0},practiceMode:{type:Boolean,attribute:"practice-mode",reflect:!0},ulanganMode:{type:Boolean,attribute:"ulangan-mode",reflect:!0},questionDelay:{type:Number,attribute:"question-delay",reflect:!0},reviewAnswers:{type:Boolean,attribute:"review-answers",reflect:!0},timerAutostart:{type:Boolean,attribute:"timer-autostart",reflect:!0},_mulai:{state:!0},_selesai:{state:!0},_skor:{state:!0},_habisWaktu:{state:!0},_pesan:{state:!0},_bestSkor:{state:!0},_pernahIkut:{state:!0},_attemptKe:{state:!0},_terkunci:{state:!0},_resumeRemaining:{state:!0},_soalFileUrlCache:{state:!0},_tabSwitchWarning:{state:!0},_userStarted:{state:!0},kkm:{type:Number,attribute:"kkm",reflect:!0},remidiMode:{type:Boolean,attribute:"remidi-mode",reflect:!0},remidiSoalUrl:{type:String,attribute:"remidi-soal-url",reflect:!0},nilaiAkhir:{state:!0},sudahRemidi:{state:!0},_needsRemidi:{state:!0},_skorAwal:{state:!0},_remidiSoal:{state:!0},_tabSwitchCount:{state:!0},_visibilityChangeCount:{state:!0},_windowBlurCount:{state:!0},_windowFocusCount:{state:!0},_fullscreenWarning:{state:!0},_waktuMulai:{state:!0},tabSwitchThreshold:{type:Number,attribute:"tab-switch-threshold",reflect:!0},_curangLogged:{state:!0},_warningCount:{state:!0},_forceChoiceDialog:{state:!0},_sessionLogged:{state:!0},_showReview:{state:!0},_reviewSnapshot:{state:!0}}}constructor(){super(),this.appsScriptUrl="",this.spreadsheetUrl="",this.duration=300,this.judulMateri="Materi Pembelajaran",this.teksMateri="Baca materi di bawah ini dengan saksama sebelum mengerjakan kuis. Waktu pengerjaan kuis dibatasi oleh timer; saat waktu habis, kuis akan dikunci dan nilai otomatis terkirim.",this.materiUrl="",this.materiFile="",this.coverImage="",this.judulKuis="Evaluasi Kuis Interaktif",this.questions=void 0,this.studentId="",this.studentName="",this.studentNis="",this.studentAbsen="",this.studentKelas="",this.kdMateri="",this.pesanWaktuHabis="\u23F0 Waktu habis! Kuis dikunci & dinilai otomatis.",this.pesanNilaiTerkirim="\u{1F389} Selamat! Nilai Anda sudah terkirim ke spreadsheet.",this.labelMulai="\u25B6\uFE0F Mulai",this.showSheetLink=!1,this.soalFileUrl="",this.allowRetake=!0,this.maxRetake=0,this.mode="siswa",this.hidePauseRestart=!0,this.shuffleQuestions=!1,this.shuffleChoices=!1,this.kategori="sumatif_lm",this.hideConfetti=!1,this.hideAnswers=!1,this.hideScore=!1,this.showQuestionNav=!0,this.allowBackwardNav=!1,this.practiceMode=!1,this.ulanganMode=!1,this.questionDelay=1800,this.reviewAnswers=!0,this.timerAutostart=!0,this._mulai=!1,this._selesai=!1,this._skor=null,this._habisWaktu=!1,this._pesan="",this._bestSkor=null,this._pernahIkut=!1,this._attemptKe=0,this._terkunci=!1,this._resumeRemaining=null,this._soalFileUrlCache="",this._tabSwitchWarning=!1,this._userStarted=!1,this.kkm=75,this.remidiMode=!1,this.remidiSoalUrl="",this.nilaiAkhir=null,this.sudahRemidi=!1,this._needsRemidi=!1,this._skorAwal=null,this._remidiSoal=[],this._tabSwitchCount=0,this._visibilityChangeCount=0,this._windowBlurCount=0,this._windowFocusCount=0,this._waktuMulai=null,this.tabSwitchThreshold=3,this._curangLogged=!1,this._warningCount=0,this._forceChoiceDialog=!1,this._sessionLogged="",this._sessionToken="",this._showReview=!1,this._reviewSnapshot=null,this._onAuthLogin=this._onAuthLogin.bind(this),this._onAuthLogout=this._onAuthLogout.bind(this),this._antiCheat=new ea(this,{tabSwitchThreshold:this.tabSwitchThreshold}),this.addEventListener("anti-cheat-event",t=>this._onAntiCheatEvent(t.detail)),this.t={...this.t,bacaMateri:"\u{1F517} Buka URL Materi",unduhMateri:"\u{1F4CE} Unduh File Materi"}}_onAntiCheatEvent(t){switch(t.type){case"tab-switch":this._warningCount=(this._warningCount||0)+1,this._warningCount>=3&&!this._forceChoiceDialog&&(this._forceChoiceDialog=!0,this._logActivity("force_choice_dialog",{warningCount:this._warningCount,timestamp:new Date().toISOString(),studentId:this.studentId,kdMateri:this.kdMateri})),this.requestUpdate();break;case"force-choice":this._forceChoiceDialog=!0,this.requestUpdate();break;case"cheat":this._curangLogged=!0,this._logActivity("curang_tab_switch",t),this.requestUpdate();break;case"fullscreen-exit":this._fullscreenWarning=!0,this._logActivity("fullscreen_exit",t),this.requestUpdate();break;case"fullscreen-enter":this._fullscreenWarning=!1,this.requestUpdate();break;case"tab-warning":this._tabSwitchWarning=!0,this.requestUpdate();break;case"tab-warning-dismiss":this._tabSwitchWarning=!1,this.requestUpdate();break;case"fullscreen-dismiss":this._fullscreenWarning=!1,this.requestUpdate();break;case"copy-paste-attempt":this._logActivity("copy_paste_attempt",t);break}}connectedCallback(){if(super.connectedCallback(),globalThis.HaxStore&&typeof globalThis.HaxStore.requestAvailability=="function"){const t=globalThis.HaxStore.requestAvailability();t&&!t.elementList[ot.tag]&&(t.elementList[ot.tag]=ot.haxProperties)}globalThis.addEventListener("quiz-user-login",this._onAuthLogin),globalThis.addEventListener("quiz-user-logout",this._onAuthLogout),this._antiCheat.attach(),this._loadSession(),this._muatStatusKuis()}disconnectedCallback(){globalThis.removeEventListener("quiz-user-login",this._onAuthLogin),globalThis.removeEventListener("quiz-user-logout",this._onAuthLogout),this._antiCheat.detach(),super.disconnectedCallback()}_onVisibilityChange(){this._antiCheat._onVisibilityChange()}_cekThresholdCurang(){this._tabSwitchCount>0&&(this._antiCheat.tabSwitchCount=this._tabSwitchCount),this._antiCheat.cheatLogged=this._curangLogged,this._antiCheat._cekThresholdCurang()}_logSelesaiKuis(){if(!(!this.studentId||!this.kdMateri))try{globalThis.localStorage.setItem(`latihan_kuis_selesai_${this.studentId}_${this.kdMateri}`,String(Date.now()))}catch{}}_onAuthLogin(t){const e=t&&t.detail||{};this.studentId=e.studentId||"",this.studentName=e.nama||"",this.studentNis=e.nis||"",this.studentAbsen=e.absen||"",this.studentKelas=e.kelas||"",this.appsScriptUrl&&this.studentId&&this.kdMateri&&(this._bestSkor=null,this._pernahIkut=!1,this._selesai=!1,this._habisWaktu=!1,this._skor=null,this._mulai=!1,this._terkunci=!1,this._resumeRemaining=null,this._loadAttemptCounter(),this._muatStatusKuis())}_onAuthLogout(){this._bestSkor=null,this._pernahIkut=!1,this._selesai=!1,this._habisWaktu=!1,this._skor=null,this._mulai=!1,this._terkunci=!1,this._resumeRemaining=null,this._attemptKe=0;try{localStorage.removeItem(`kuis-ledakan:attempt:${this.studentId}:${this.kdMateri}`),localStorage.removeItem(`kuis-ledakan:session:${this.studentId}:${this.kdMateri}`)}catch{}this.studentId="",this.studentName="",this.studentNis="",this.studentAbsen="",this.studentKelas="",this._antiCheat.clearState(),this._warningCount=0,this._forceChoiceDialog=!1,this._curangLogged=!1,this._sessionLogged="",this._sessionToken="";try{localStorage.removeItem("latihan_kuis_attempt_u1_bab1")}catch{}}_lanjutkanKuis(){this._forceChoiceDialog=!1,this._warningCount=0,this.requestUpdate()}_kumpulkanSekarang(){this._forceChoiceDialog=!1,this.requestUpdate();const t=this.shadowRoot&&this.shadowRoot.querySelector("kuis-ledakan");t&&typeof t._selesaiKuis=="function"&&t._selesaiKuis()}_laporKeGuru(){this._forceChoiceDialog=!1,this._warningCount=0,this._logActivity("lapor_ke_guru",{warningCount:this._warningCount,timestamp:new Date().toISOString(),studentId:this.studentId,kdMateri:this.kdMateri,tabSwitchCount:this._antiCheat.tabSwitchCount||0}),this.requestUpdate()}_logActivity(t,e={}){if(["timer_mulai","tab_switch","curang_tab_switch","force_choice_dialog","fullscreen_exit","copy_paste_attempt","lapor_ke_guru","suspicious_timing"].includes(t)){this._antiCheat.enqueueAudit(t,e);return}const a={tipe:t,payload:{...e,studentId:this.studentId,kdMateri:this.kdMateri,audit_singkat:this._antiCheat.bacaAuditSingkat()}};try{this.dispatchEvent(new CustomEvent("dasbor-kuis-log",{detail:a,bubbles:!0,composed:!0}))}catch{}this.closest("dasbor-kuis")||this._sendLogDirect(t,a.payload),this._antiCheat.selesaiAudit()}async _sendLogDirect(t,e){if(!(!this.appsScriptUrl||!this.studentId))try{const a={action:"logActivity",studentId:this.studentId,type:t,description:JSON.stringify(e),timestamp:new Date().toISOString(),kdMateri:this.kdMateri||"",kategori:this.kategori||"sumatif_lm",id_log:e.id_log||`LOG-${Date.now()}-${Math.random().toString(36).slice(2,10).toUpperCase()}`};await fetch(`${this.appsScriptUrl}?${new URLSearchParams(a).toString()}`,{method:"GET",mode:"cors"})}catch{}}_loadSession(){try{const t=JSON.parse(globalThis.localStorage.getItem("quiz_user_session"));if(!t||!t.studentId)return;if(t.expiresAt&&Date.now()>t.expiresAt){globalThis.localStorage.removeItem("quiz_user_session");return}this.studentId=t.studentId||"",this.studentName=t.nama||"",this.studentNis=t.nis||"",this.studentAbsen=t.absen||"",this.studentKelas=t.kelas||""}catch{}this._loadAttemptCounter(),this._restoreRemidiState()}_attemptKey(){return`latihan_kuis_attempt_${this.studentId}_${this.kdMateri}`}_loadAttemptCounter(){if(!(!this.maxRetake||!this.studentId||!this.kdMateri))try{const t=globalThis.localStorage.getItem(this._attemptKey());this._attemptKe=parseInt(t,10)||0}catch{this._attemptKe=0}}_saveAttemptCounter(){if(!(!this.maxRetake||!this.studentId||!this.kdMateri))try{globalThis.localStorage.setItem(this._attemptKey(),String(this._attemptKe))}catch{}}_timerKey(){return`latihan_kuis_time_${this.studentId}_${this.kdMateri}`}_simpanWaktuMulai(){if(!(!this.studentId||!this.kdMateri))try{globalThis.localStorage.setItem(this._timerKey(),JSON.stringify({start:Date.now(),duration:this.duration}))}catch{}}_bacaSisaWaktu(){if(!this.studentId||!this.kdMateri)return 0;try{const t=JSON.parse(globalThis.localStorage.getItem(this._timerKey())||"null");if(!t)return 0;const e=t.duration-Math.floor((Date.now()-t.start)/1e3);return e>0?e:0}catch{return 0}}_hapusWaktuMulai(){try{globalThis.localStorage.removeItem(this._timerKey())}catch{}}_cobaResumeTimer(){const t=this._bacaSisaWaktu();(this.maxRetake===0||this._attemptKe<this.maxRetake+1)&&t!=null&&t>0&&(this._mulai=!0,this._resumeRemaining=t,this._antiCheat.restoreState())}_muatStatusKuis(){if(!this.appsScriptUrl||!this.studentId||!this.kdMateri){this._cobaResumeTimer();return}const t=`${this.appsScriptUrl}${this.appsScriptUrl.includes("?")?"&":"?"}action=getQuizLock&studentId=${encodeURIComponent(this.studentId)}&kdMateri=${encodeURIComponent(this.kdMateri)}`;return fetch(t,{method:"GET",mode:"cors"}).then(e=>e.json()).then(e=>{if(e&&(this._terkunci=!!e.locked,this._pernahIkut=typeof e.best=="number"&&e.best!=null,this._bestSkor=typeof e.best=="number"?e.best:null,this._terkunci)){this._terkunci=!0,this._selesai=!1,this._skor=this._bestSkor,this._hapusWaktuMulai(),this._mulai=!1,this._resumeRemaining=null;try{const a=this.shadowRoot&&this.shadowRoot.querySelector("timer-kuis");a&&typeof a.pause=="function"&&a.pause(),a&&typeof a.reset=="function"&&a.reset()}catch{}this.remidiMode&&typeof this._bestSkor=="number"&&this._bestSkor<this.kkm&&!this.sudahRemidi&&(this._needsRemidi=!0,this._skorAwal=this._bestSkor)}}).catch(()=>{}).finally(()=>{!this._userStarted&&!this._terkunci&&!this._selesai&&this._cobaResumeTimer(),this.requestUpdate()})}_reviewSnapshotFromChild(t){return t?{questions:Array.isArray(t._shuffledQuestions)&&t._shuffledQuestions.length?t._shuffledQuestions:Array.isArray(t.questions)?t.questions:[],userAnswers:t._userAnswers instanceof Map?Array.from(t._userAnswers.entries()):[],answeredSet:t._answeredSet instanceof Set?Array.from(t._answeredSet.values()):[],score:t._score,maxPoints:t._maxPoints}:null}async _restoreReview(){const t=this.shadowRoot&&this.shadowRoot.querySelector("kuis-ledakan");if(!t||!this._showReview||t._reviewMode)return;const e=this._reviewSnapshot;!e||!e.questions.length||(t._shuffledQuestions=e.questions,t._userAnswers=new Map(e.userAnswers),t._answeredSet=new Set(e.answeredSet),t._score=e.score,t._maxPoints=e.maxPoints,t._screen="result",t._reviewMode=!1,t.requestUpdate(),await t.updateComplete,t._startReviewMode())}_fireConfetti(){const t=this.shadowRoot&&this.shadowRoot.querySelector("kuis-ledakan");if(t&&typeof t._fireConfetti=="function"&&!t.hideConfetti){t._fireConfetti();return}const e=typeof ft=="function"?ft:ft&&ft.default;this.ulanganMode||this.hideConfetti||typeof e!="function"||(e({particleCount:70,spread:85,scalar:1.05,origin:{x:.5,y:.62}}),e({particleCount:45,spread:65,scalar:1.1,origin:{x:.1,y:.7}}),e({particleCount:45,spread:65,scalar:1.1,origin:{x:.9,y:.7}}))}_startReviewMode(){this._showReview=!0,this.requestUpdate()}_closeReviewMode(){this._showReview=!1,this.requestUpdate()}_ulangiKuisDenganKonfeti(){this._ulangiKuis(),this._fireConfetti()}_ulangiKuis(){this._antiCheat.enqueueAudit("restart",{timestamp:new Date().toISOString()}),this._selesai=!1,this._terkunci=!1,this._kunci=!1,this._resumeRemaining=null,this._hapusWaktuMulai(),this._habisWaktu=!1,this._skor=null,this._showReview=!1,this._muatStatusKuis(),this._mulaiLatihan()}updated(t){super.updated(t),t.has("soalFileUrl")&&this.soalFileUrl&&this.soalFileUrl!==this._soalFileUrlCache&&this._muatSoalDariFile(this.soalFileUrl),t.has("_showReview")&&this._showReview&&this._restoreReview()}async _muatSoalDariFile(t){this._soalFileUrlCache=t;try{const e=await fetch(t);if(!e.ok)throw new Error("HTTP "+e.status);const a=await e.json();if(!Array.isArray(a)||a.length===0)throw new Error("Bukan array JSON / kosong");this.questions=a,this._pesan=""}catch(e){this._soalFileUrlCache="",(!this.questions||this.questions.length===0)&&(this.questions=[]),this._pesan="Gagal memuat file soal: "+e.message}}_onWaktuHabis(){this._bacaSisaWaktu()>60&&this._antiCheat.cekWaktuSerakah(),this._antiCheat.selesaiAudit();const t=this.shadowRoot&&this.shadowRoot.querySelector("kuis-ledakan");t&&t._screen!=="result"&&typeof t._selesaiKuis=="function"&&t._selesaiKuis(),this._logSelesaiKuis(),this._selesai=!0,this._habisWaktu=!0,this._resumeRemaining=null,this._hapusWaktuMulai(),this._antiCheat.clearState(),this._kirimLogSession("waktu_habis")}_onKuisLog(t){if(t.detail&&t.detail.payload&&typeof t.detail.payload.score=="number"){const e=t.detail.payload.sessionToken,a=e||this._sessionToken;if(a&&this._sessionLogged===a)return;a&&(this._sessionLogged=a,e&&(this._sessionToken=e)),this._logSelesaiKuis(),this._skor=t.detail.payload.score,this._selesai=!0,this._showReview=!1;const i=this.shadowRoot&&this.shadowRoot.querySelector("kuis-ledakan");this._reviewSnapshot=this._reviewSnapshotFromChild(i),this._resumeRemaining=null,this._hapusWaktuMulai();try{globalThis.localStorage.removeItem(this._attemptKey()),globalThis.localStorage.removeItem(this._timerKey()),globalThis.localStorage.removeItem(`kuis-ledakan:attempt:${this.studentId}:${this.kdMateri}`),globalThis.localStorage.removeItem(`kuis-ledakan:session:${this.studentId}:${this.kdMateri}`)}catch{}this.maxRetake&&!this._effectiveRemidiMode&&(this._attemptKe++,this._saveAttemptCounter()),!this.remidiMode&&this.remidiSoalUrl&&this._skor<this.kkm&&(this.remidiMode=!0),this._effectiveRemidiMode&&this._skor<this.kkm?(this._needsRemidi=!0,this._skorAwal=this._skor):(this._needsRemidi=!1,this.lockAfterComplete&&!this._effectiveRemidiMode&&(this._terkunci=!0)),this._saveRemidiState(),this._muatStatusKuis(),this._kirimLogSession("selesai"),this._antiCheat.finalisasiAudit();const r=t.detail&&t.detail.id_log?t.detail.id_log:"";this._logActivity("selesai",{id_log:r,score:this._skor,timestamp:new Date().toISOString(),kdMateri:this.kdMateri,studentId:this.studentId,tabSwitchCount:this._antiCheat.tabSwitchCount||0,windowBlurCount:this._antiCheat.windowBlurCount||0,windowFocusCount:this._antiCheat.windowFocusCount||0,durasiPengerjaan:this._waktuMulai?Math.floor((Date.now()-this._waktuMulai)/1e3):0,curang:this._curangLogged||!1,remidi:this.sudahRemidi||!1,percobaanKe:this._attemptKe||1,sessionToken:this._sessionToken||"",waktuSelesai:String(Date.now()),catatan:"selesai"+(this._curangLogged?" (curang)":"")+(this.sudahRemidi?" (sudah-remidi)":"")+(this._effectiveRemidiMode?" (remidi)":""),warningCount:this._warningCount||0,forceChoiceDialogTriggered:this._forceChoiceDialog||!1,curangTabSwitchTriggered:this._curangLogged||!1,tabSwitchThreshold:this.tabSwitchThreshold||3})}}async _mulaiLatihan(){if(!this.studentId){this.requestUpdate();return}await this._muatStatusKuis();const t=this._needsRemidi&&this._effectiveRemidiMode&&!this.sudahRemidi;if(this._terkunci&&!t&&this.mode!=="guru"){this._pesan="Kuis terkunci. Hubungi guru atau gunakan Remidi jika nilai < KKM.",this._mulai=!1,this._hapusWaktuMulai();const i=this.shadowRoot&&this.shadowRoot.querySelector("timer-kuis");if(i&&typeof i.pause=="function")try{i.pause()}catch{}this.requestUpdate();return}if(this._userStarted=!0,t||this.mode==="guru")this._terkunci=!1;else if(this._terkunci)return;this._mulai=!0,this._waktuMulai=Date.now(),this._antiCheat.waktuMulai=this._waktuMulai,this._simpanWaktuMulai(),this._sessionToken=this._antiCheat.generateSessionToken(),this._antiCheat.sessionToken=this._sessionToken,this._sessionLogged="",this._antiCheat.resetCounters(),this._antiCheat.waktuMulai=this._waktuMulai,this._curangLogged=!1,this._warningCount=0,this._forceChoiceDialog=!1,this._latihanOnlyMode||this._logActivity("timer_mulai",{timestamp:new Date().toISOString(),durasiUlangan:this.duration||300,waktuMulai:this._waktuMulai,kategori:this.kategori||"sumatif_lm",kdMateri:this.kdMateri,percobaanKe:this._attemptKe?this._attemptKe+1:1}),this._antiCheat.requestFullscreen(),await this.updateComplete;const e=this.shadowRoot&&this.shadowRoot.querySelector("kuis-ledakan"),a=this.shadowRoot&&this.shadowRoot.querySelector("timer-kuis");e&&typeof e._onStartClick=="function"&&e._onStartClick(),a&&typeof a.start=="function"&&a.start()}async _kirimLogSession(t){if(!this.appsScriptUrl||!this.studentId)return;const e=String(Date.now()),a=this._waktuMulai?Math.floor((Date.now()-this._waktuMulai)/1e3):0,i=this._bacaSisaWaktu();let r=t;this._effectiveRemidiMode&&this._needsRemidi&&(r+=" (remidi)"),this.sudahRemidi&&(r+=" (sudah-remidi)"),this._curangLogged&&(r+=" (curang)"),this._warningCount>=3&&(r+=` (${this._warningCount}x tab switch)`),t==="waktu_habis"&&(r="waktu_habis (auto-submit)");const s={action:"updateQuizSession",studentId:this.studentId,nama:this.studentName||"",nis:this.studentNis||"",absen:this.studentAbsen||"",kelas:this.studentKelas||"",kdMateri:this.kdMateri||"",waktuMulai:this._waktuMulai?String(this._waktuMulai):"",waktuSelesai:e,durasiPengerjaan:a,durasiUlangan:this.duration||300,sisaWaktu:i,tabSwitchCount:this._antiCheat.tabSwitchCount||0,windowBlurCount:this._antiCheat.windowBlurCount||0,windowFocusCount:this._antiCheat.windowFocusCount||0,skor:this._skor!=null?this._skor:-1,catatan:r,sessionToken:this._sessionToken||"",percobaanKe:this._attemptKe||1,warningCount:this._warningCount||0,forceChoiceDialogTriggered:this._forceChoiceDialog||!1,curangTabSwitchTriggered:this._curangLogged||!1,tabSwitchThreshold:this.tabSwitchThreshold||3,id_log:`LOG-${Date.now()}-${Math.random().toString(36).slice(2,10).toUpperCase()}`,audit_singkat:JSON.stringify(this._antiCheat.bacaAuditSingkat())};try{const d=new URLSearchParams(s);await fetch(`${this.appsScriptUrl}?${d.toString()}`,{method:"GET",mode:"cors"}),this._antiCheat.clearState()}catch{const d=`latihan_kuis_session_${this.studentId}_${this.kdMateri}`;try{localStorage.setItem(d,JSON.stringify(s))}catch{}}}async _mulaiRemidi(){if(!this.remidiSoalUrl){this._pesan="Soal remidi belum disiapkan oleh guru.",this.requestUpdate();return}if(this._terkunci&&this.appsScriptUrl&&this.studentId&&this.kdMateri){try{const t=new URLSearchParams({action:"resetQuizLock",studentId:this.studentId,kdMateri:this.kdMateri});await fetch(`${this.appsScriptUrl}?${t.toString()}`,{method:"GET",mode:"cors"})}catch{}try{localStorage.removeItem(`kuis-ledakan:attempt:${this.studentId}:${this.kdMateri}`),localStorage.removeItem(`latihan_kuis_attempt_${this.studentId}_${this.kdMateri}`),localStorage.removeItem(`latihan_kuis_time_${this.studentId}_${this.kdMateri}`)}catch{}}try{const t=await fetch(this.remidiSoalUrl);if(!t.ok)throw new Error("HTTP "+t.status);if(this._remidiSoal=await t.json(),!Array.isArray(this._remidiSoal)||this._remidiSoal.length===0)throw new Error("Format soal remidi tidak valid");this._terkunci=!1,this._selesai=!1,this._skor=null,this._habisWaktu=!1,this._resumeRemaining=null,this._needsRemidi=!1,this.sudahRemidi=!0,this._pesan="",this.questions=this._remidiSoal,this._saveRemidiState();try{const e=this.shadowRoot&&this.shadowRoot.querySelector("kuis-ledakan");e&&(e._locked=!1,e._lockChecked=!1)}catch{}this.requestUpdate(),this._mulaiLatihan()}catch(t){this._pesan="Gagal memulai remidi: "+t.message,this.requestUpdate()}}async _resetKunciGuru(){if(!this.appsScriptUrl||!this.studentId||!this.kdMateri){this._pesan="Gagal buka kunci: appsScriptUrl/student/kdMateri belum lengkap.",this.requestUpdate();return}try{const t=new URLSearchParams({action:"resetQuizLock",studentId:this.studentId,kdMateri:this.kdMateri}),e=await(await fetch(`${this.appsScriptUrl}?${t.toString()}`,{method:"GET",mode:"cors"})).json();if(e&&e.status==="ok"){this._terkunci=!1,this._selesai=!1,this._skor=null,this._bestSkor=null,this._pernahIkut=!1;try{localStorage.removeItem(`latihan_kuis_attempt_${this.studentId}_${this.kdMateri}`),localStorage.removeItem(`latihan_kuis_time_${this.studentId}_${this.kdMateri}`)}catch{}this._pesan=`\u{1F513} Kunci LM1 dibuka \u2014 ${e.deleted||0} sesi dihapus. Siswa bisa ulang.`,this._muatStatusKuis()}else this._pesan="Gagal buka kunci: "+(e.message||"unknown")}catch(t){this._pesan="Gagal buka kunci: "+t.message}this.requestUpdate()}_hitungNilaiAkhir(){return this.nilaiAkhir=Math.round((this._skorAwal+this._skor)/2),this.nilaiAkhir}_remidiKey(){return`latihan_kuis_remidi_${this.studentId}_${this.kdMateri}`}_saveRemidiState(){if(!(!this.studentId||!this.kdMateri))try{const t={sudahRemidi:this.sudahRemidi,_needsRemidi:this._needsRemidi,_skorAwal:this._skorAwal,_remidiSoal:this._remidiSoal||[],timestamp:Date.now()};localStorage.setItem(this._remidiKey(),JSON.stringify(t))}catch{}}_restoreRemidiState(){if(!(!this.studentId||!this.kdMateri))try{const t=JSON.parse(localStorage.getItem(this._remidiKey()));t&&t.sudahRemidi&&(this.sudahRemidi=t.sudahRemidi,this._needsRemidi=t._needsRemidi,this._skorAwal=t._skorAwal,Array.isArray(t._remidiSoal)&&t._remidiSoal.length>0&&(this._remidiSoal=t._remidiSoal,this.sudahRemidi&&this._effectiveRemidiMode&&(this.questions=this._remidiSoal)))}catch{}}_clearRemidiState(){if(!(!this.studentId||!this.kdMateri))try{localStorage.removeItem(this._remidiKey())}catch{}}static get styles(){return[super.styles,z`
          ...
          .materi-card h2 { color: var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c)); margin: 0 0 var(--ddd-spacing-2) 0; }
          .materi-card p { color: var(--ddd-theme-secondary, rgba(0, 0, 0, 0.75)); line-height: 1.6; }
      ...
      .materi-links a {
        ...
        border: 1px solid var(--ddd-theme-polaris-border, var(--ddd-theme-default-limestoneLight, #e4e5e7));
        color: var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c)); text-decoration: none; font-size: var(--ddd-font-size-m);
      }
      ...
      .btn-mulai {
        ...
        background: var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c)); color: var(--ddd-theme-on-primary, var(--ddd-theme-bgContrast, var(--lowContrast-override, #ffffff))); cursor: pointer;
        font-family: var(--ddd-font-primary);
      }
      .btn-mulai:hover { background: var(--ddd-theme-accent, var(--ddd-accent-0, #96bee6)); }
      .btn-logout {
        display: inline-block; margin-top: var(--ddd-spacing-5);
        padding: var(--ddd-spacing-3) var(--ddd-spacing-6);
        background: var(--ddd-theme-error, var(--ddd-primary-22, var(--ddd-theme-default-error, #5f2120))); color: var(--ddd-theme-on-primary, var(--ddd-theme-bgContrast, var(--lowContrast-override, #ffffff)));
      ...
      .auth-hint { text-align: center; color: var(--ddd-theme-secondary, rgba(0, 0, 0, 0.75)); font-size: var(--ddd-font-size-m); margin: var(--ddd-spacing-3) 0 0; }

      .selesai-card {
        text-align: center; border: 1px solid var(--ddd-theme-success, var(--ddd-primary-25, var(--ddd-theme-default-success, #1e4620)));
        border-radius: var(--ddd-radius-lg); padding: var(--ddd-spacing-8);
        background: var(--ddd-theme-default-surface, var(--ddd-theme-default-background, light-dark(#f8fafc, #111827)));
      }
      .selesai-card .waktu { font-size: var(--ddd-font-size-l); color: var(--ddd-theme-error, var(--ddd-primary-22, var(--ddd-theme-default-error, #5f2120))); margin-bottom: var(--ddd-spacing-2); }
      .selesai-card .kirim { font-size: var(--ddd-font-size-xl); font-weight: var(--ddd-font-weight-bold); color: var(--ddd-theme-default-text, var(--ddd-theme-font-color, light-dark(#1e293b, #e5e7eb))); }
      .selesai-card .kirim.warn { color: var(--ddd-theme-error, var(--ddd-primary-22, var(--ddd-theme-default-error, #5f2120))); }
      ...
      .selesai-card a {
        ...
        background: var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c)); color: var(--ddd-theme-on-primary, var(--ddd-theme-bgContrast, var(--lowContrast-override, #ffffff))); border-radius: var(--ddd-radius-md);
        text-decoration: none; font-weight: var(--ddd-font-weight-bold);
      }


      .selesai-card.suspicious { border-color: var(--ddd-theme-warning, var(--ddd-primary-23, var(--ddd-theme-default-warning, #663c00))); background: linear-gradient(180deg, rgba(245,158,11,0.08), transparent); }
      .suspicious-warning { background: var(--ddd-theme-warning-light, var(--ddd-theme-default-warningLight, light-dark(#fff4e5, #78350f))); border: 1px solid var(--ddd-theme-warning, var(--ddd-primary-23, var(--ddd-theme-default-warning, #663c00))); border-radius: var(--ddd-radius-lg); padding: var(--ddd-spacing-5); margin-bottom: var(--ddd-spacing-4); text-align: left; }
      .suspicious-icon { font-size: 2rem; margin-bottom: var(--ddd-spacing-2); }
      .suspicious-title { font-size: var(--ddd-font-size-m); font-weight: var(--ddd-font-weight-bold); color: var(--ddd-theme-warning-text, var(--ddd-theme-default-warning, light-dark(#663c00, #fde68a))); margin-bottom: var(--ddd-spacing-2); }
      .suspicious-text { font-size: var(--ddd-font-size-s); color: var(--ddd-theme-warning, var(--ddd-primary-23, var(--ddd-theme-default-warning, #663c00))); line-height: 1.5; margin-bottom: var(--ddd-spacing-2); }
      .suspicious-note { font-size: var(--ddd-font-size-4xs); color: var(--ddd-theme-warning, var(--ddd-primary-23, var(--ddd-theme-default-warning, #663c00))); font-style: italic; }
      .remidi-card { background: var(--ddd-theme-warning-light, var(--ddd-theme-default-warningLight, light-dark(#fff4e5, #78350f))); border: 1px solid var(--ddd-theme-warning, var(--ddd-primary-23, var(--ddd-theme-default-warning, #663c00))); border-radius: var(--ddd-radius-lg); padding: var(--ddd-spacing-5); margin-top: var(--ddd-spacing-4); }
      .remidi-card h3 { margin: 0 0 var(--ddd-spacing-2) 0; color: var(--ddd-theme-warning-text, var(--ddd-theme-default-warning, light-dark(#663c00, #fde68a))); }
      .remidi-card p { color: var(--ddd-theme-warning, var(--ddd-primary-23, var(--ddd-theme-default-warning, #663c00))); margin-bottom: var(--ddd-spacing-3); }
      .remidi-notif { font-size: var(--ddd-font-size-4xs); color: var(--ddd-theme-accent, var(--ddd-accent-0, #96bee6)); margin-top: var(--ddd-spacing-3); font-weight: 600; }
      .review-host { margin-top: var(--ddd-spacing-5); }
      .review-host-header { display: flex; flex-wrap: wrap; align-items: center; gap: var(--ddd-spacing-3); margin-bottom: var(--ddd-spacing-4); }
      .review-host-header h2 { margin: 0; flex: 1 1 auto; }
      .err-chip {
        background: var(--ddd-theme-warning-light, var(--ddd-theme-default-warningLight, light-dark(#fff4e5, #78350f))); border: 1px solid var(--ddd-theme-warning, var(--ddd-primary-23, var(--ddd-theme-default-warning, #663c00))); color: var(--ddd-theme-warning-text, var(--ddd-theme-default-warning, light-dark(#663c00, #fde68a)));
      ...
      .skor-best {
        ...
        color: var(--ddd-theme-success, var(--ddd-primary-25, var(--ddd-theme-default-success, #1e4620)));
        background: var(--ddd-theme-success-light, var(--ddd-theme-default-successLight, light-dark(#edf7ed, #064e3b)));
        display: inline-block;
      }
      .tab-warning-overlay {
      ...
      .tab-warning-card {
        background: var(--ddd-theme-default-white, light-dark(#ffffff, #111827));
        color: var(--ddd-theme-default-text, light-dark(#1e293b, #e5e7eb));
        border-radius: var(--ddd-radius-lg);
        padding: var(--ddd-spacing-6);
        max-width: 400px;
        text-align: center;
      ...
      .tab-warning-title { font-size: var(--ddd-font-size-l); font-weight: 800; color: var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c)); margin-bottom: var(--ddd-spacing-2); }
      .tab-warning-text { font-size: var(--ddd-font-size-4xs); color: var(--ddd-theme-on-surface, var(--ddd-theme-default-text, light-dark(#1e293b, #e5e7eb))); margin-bottom: var(--ddd-spacing-4); }
      .tab-warning-close {
        padding: var(--ddd-spacing-3) var(--ddd-spacing-5);
        background: var(--ddd-theme-polaris-primary, var(--ddd-primary-1, #1e407c));
        color: var(--ddd-theme-on-primary, var(--ddd-theme-bgContrast, var(--lowContrast-override, #ffffff)));
      ...
      .force-choice-card {
        ...
        border: 3px solid var(--ddd-theme-warning, var(--ddd-primary-23, var(--ddd-theme-default-warning, #663c00)));
      ...
      #force-choice-title {
        ...
        color: var(--ddd-theme-error, var(--ddd-primary-22, var(--ddd-theme-default-error, light-dark(#5f2120, #fca5a5))));
        margin-bottom: var(--ddd-spacing-3);
      }

      #force-choice-text {
        font-size: var(--ddd-font-size-4xs);
        color: var(--ddd-theme-on-surface, var(--ddd-theme-default-text, light-dark(#1e293b, var(--ddd-theme-default-globalNeon, #ffffff))));
      ...
      .force-choice-btn.primary {
        background: var(--ddd-theme-primary, var(--ddd-primary-1, #1e407c)); color: var(--ddd-theme-on-primary, var(--ddd-theme-bgContrast, var(--lowContrast-override, #ffffff)));
      }
      .force-choice-btn.primary:hover { background: var(--ddd-theme-accent, var(--ddd-accent-0, #96bee6)); }
      .force-choice-btn.secondary {
        background: var(--ddd-theme-warning, var(--ddd-primary-23, var(--ddd-theme-default-warning, #663c00))); color: var(--ddd-theme-on-primary, var(--ddd-theme-bgContrast, var(--lowContrast-override, #ffffff)));
      }
      ...
      /* ========================================================= */
      /* 3. TEMA GELAP BERBASIS KELAS JAVASCRIPT INDUK (BODY)      */
      /* ========================================================= */
      :host-context(body.dark-mode) :host {
        --dk-bg: #0b1020;
        --dk-card: #111827;
        ...
        --ddd-theme-on-surface: var(--dk-text);
        --ddd-theme-on-primary: #f8fafc;
        --ddd-theme-card: #1f2937;
        --ddd-theme-card-deep: #111827;
        --ddd-theme-card-border: #2a3245;
        --ddd-theme-primary: #c4b5fd;
        --ddd-theme-accent: #818cf8;
        --ddd-theme-secondary: var(--dk-text-soft);
        --ddd-theme-polaris-surface: var(--dk-card);
        ...
        --ddd-theme-error: #fca5a5;
        --ddd-theme-error-dark: #7f1d1d;
        --ddd-theme-error-light: var(--ddd-theme-error, var(--ddd-primary-22, var(--ddd-theme-default-error, #5f2120)));
        --ddd-theme-error-text: var(--ddd-theme-error, var(--ddd-primary-22, var(--ddd-theme-default-error, #5f2120)));
        --ddd-theme-polaris-primary: #818cf8;
        --ddd-theme-default-text: var(--dk-text, #e5e7eb);
        --ddd-theme-default-surface: var(--dk-card, #111827);
        background: var(--dk-bg);
        color: var(--dk-text);
      }
      ...
      :host-context(body.dark-mode) .err-chip {
        background: var(--ddd-theme-error-light, var(--ddd-theme-default-errorLight, #fdeded));
        color: var(--ddd-theme-error-text, var(--ddd-theme-default-error, #5f2120));
        border-color: var(--ddd-theme-error-dark, var(--ddd-theme-default-error, #5f2120));
      }

      :host-context(body.dark-mode) .btn-mulai {
        background: var(--ddd-theme-polaris-primary, var(--ddd-primary-1, #1e407c));
        color: var(--ddd-theme-on-primary, var(--ddd-theme-bgContrast, var(--lowContrast-override, #ffffff)));
      }

      :host-context(body.dark-mode) .btn-mulai:hover { background: var(--ddd-theme-accent, var(--ddd-accent-0, #96bee6)); }
      ...
      :host-context(body.dark-mode) .tab-warning-close { background: var(--ddd-theme-polaris-primary, var(--ddd-primary-1, #1e407c)); color: var(--ddd-theme-on-primary, var(--ddd-theme-bgContrast, var(--lowContrast-override, #ffffff))); }
      ...
      :host-context(body.dark-mode) .force-choice-btn.secondary { background: var(--ddd-theme-warning, var(--ddd-primary-23, var(--ddd-theme-default-warning, #663c00))); color: var(--dk-text-strong); }
      :host-context(body.dark-mode) .selesai-card.suspicious { border-color: var(--ddd-theme-warning, var(--ddd-primary-23, var(--ddd-theme-default-warning, #663c00))); background: linear-gradient(180deg, rgba(180,83,9,0.1), transparent); }
      :host-context(body.dark-mode) .suspicious-warning { background: var(--ddd-theme-warning-light, var(--ddd-theme-default-warningLight, #fff4e5)); border-color: var(--ddd-theme-warning, var(--ddd-primary-23, var(--ddd-theme-default-warning, #663c00))); }
      :host-context(body.dark-mode) .suspicious-title { color: var(--ddd-theme-warning-text, var(--ddd-theme-default-warning, #663c00)); }
      :host-context(body.dark-mode) .suspicious-text { color: var(--ddd-theme-warning, var(--ddd-primary-23, var(--ddd-theme-default-warning, #663c00))); }
      :host-context(body.dark-mode) .suspicious-note { color: var(--ddd-theme-warning, var(--ddd-primary-23, var(--ddd-theme-default-warning, #663c00))); }
      :host-context(body.dark-mode) .remidi-card { background: var(--ddd-theme-warning-light, var(--ddd-theme-default-warningLight, #fff4e5)); border-color: var(--ddd-theme-warning, var(--ddd-primary-23, var(--ddd-theme-default-warning, #663c00))); }
      :host-context(body.dark-mode) .remidi-card h3 { color: var(--ddd-theme-warning-text, var(--ddd-theme-default-warning, #663c00)); }
      :host-context(body.dark-mode) .remidi-card p { color: var(--ddd-theme-warning, var(--ddd-primary-23, var(--ddd-theme-default-warning, #663c00))); }

      /*
        PROTEKSI FINISH (PRAW COMPLIANT):
        Mendaftarkan warna hex murni langsung ke dalam jaring pengaman light-dark().
        Browser dijamin 100% tidak akan memunculkan status 'not defined' lagi pada selektor ini.
      */
      :host-context(body.dark-mode) .choice-row.selected {
        border-color: var(--ddd-theme-selected-border, var(--ddd-theme-link, light-dark(#005fa9, #c4b5fd)));
        background: var(--ddd-theme-selected-bg, var(--ddd-theme-background, light-dark(#EFF2F5, #111827)));
        color: var(--ddd-theme-on-primary, var(--ddd-theme-textInverse, var(--lowContrast-override, light-dark(#262626, #ffffff))));
      }
      ...
      `]}get _effectiveRemidiMode(){return!!(this.remidiMode||this.remidiSoalUrl&&typeof this._bestSkor=="number"&&this._bestSkor<this.kkm&&!this.sudahRemidi)}get _latihanOnlyMode(){return!this.lockAfterComplete&&(this.duration===0||!this.duration)}render(){const t=this._effectiveRemidiMode&&!this.sudahRemidi&&typeof this._bestSkor=="number"&&this._bestSkor<this.kkm,e=(this._needsRemidi||t)&&this._effectiveRemidiMode&&!this.sudahRemidi;if(this._terkunci&&this.mode!=="guru")return e?o`
          <div class="wrap">
            <div class="selesai-card" role="alert">
              ...
              ${this._bestSkor!=null?o`<div class="skor">Nilai terbaik: <strong>${this._bestSkor}%</strong> (KKM ${this.kkm}%)</div>`:v}
        ...
        <div class="wrap">
          <div class="selesai-card" role="alert">
            ...
            ${this._bestSkor!=null?o`<div class="skor">Nilai terbaik Anda: <strong>${this._bestSkor}%</strong></div>`:v}
      ...
      `;if(this._selesai){const a=this._bacaSisaWaktu()>60;return o`
        <div class="wrap">
          <div class="selesai-card ${a?"suspicious":""}" role="status">
            ${this._habisWaktu?o`<div class="waktu">${this.pesanWaktuHabis}</div>`:v}
            ...
            ${this._skor!=null?o`<div class="skor">Skor Anda: <strong>${this._skor}%</strong></div>`:v}
            ${this.nilaiAkhir!=null?o`<div class="skor">Nilai Akhir: <strong>${this.nilaiAkhir}%</strong></div>`:v}
            ${this._needsRemidi&&!this.sudahRemidi&&this._effectiveRemidiMode?o`<div class="remidi-card">
                  ...
                  ${this._effectiveRemidiMode&&!this.sudahRemidi&&typeof this._bestSkor=="number"&&this._bestSkor<this.kkm?o`<p class="remidi-notif" role="status">🔔 Remidi otomatis aktif — nilai Anda di bawah KKM. Kerjakan soal remidi untuk tingkatkan nilai.</p>`:v}
                </div>`:v}
            ${this.allowRetake&&(this.maxRetake===0||this._attemptKe<this.maxRetake+1)?o`<button class="btn-mulai" @click=${this._ulangiKuisDenganKonfeti}>🔁 Ulangi Kuis + Konfeti</button>`:v}
            ${this.reviewAnswers&&this._reviewSnapshot&&this._reviewSnapshot.questions.length>0?o`<button class="btn-mulai" @click=${this._startReviewMode}>📋 Tinjau Jawaban</button>`:v}
            ${this.showSheetLink&&this.spreadsheetUrl?o`<a href="${this.spreadsheetUrl}" target="_blank" rel="noopener">📊 Buka Spreadsheet Nilai</a>`:v}
            ${this.studentId?o`<button class="btn-logout" @click=${this._onAuthLogout}>🚪 Keluar (Logout)</button>`:v}
          </div>
          ${this._showReview?o`
            <section class="review-host" aria-label="Tinjau jawaban">
              <div class="review-host-header">
                <h2>📋 Tinjau Jawaban</h2>
                <button class="btn-mulai" @click=${this._closeReviewMode}>← Kembali ke hasil</button>
              </div>
              <kuis-ledakan
                .questions="${this._reviewSnapshot&&this._reviewSnapshot.questions||this.questions}"
      ...
      <div class="wrap">
        <section class="materi-card">
          ${this.coverImage?o`<img class="cover" src="${this.coverImage}" alt="Cover materi" />`:v}
          <h2>📖 ${this.judulMateri}</h2>
          <p>${this.teksMateri}</p>
          <div class="materi-links">
            ${this.materiUrl?o`<a href="${this.materiUrl}" target="_blank" rel="noopener">${this.t.bacaMateri}</a>`:v}
            ${this.materiFile?o`<a href="${this.materiFile}" target="_blank" rel="noopener" download>${this.t.unduhMateri}</a>`:v}
          </div>
          ${this._pernahIkut&&this._bestSkor!=null?o`<p class="skor-best">⭐ Nilai terbaik Anda: <strong>${this._bestSkor}%</strong></p>`:v}
        </section>

        ${this._mulai?o`
              ${this._pesan?o`<p class="err-chip">${this._pesan}</p>`:v}
              <timer-kuis
              ...
              ${this._fullscreenWarning&&this._mulai&&!this._selesai?o`<div class="tab-warning-overlay" role="alert">
                    <div class="tab-warning-card">
                      ...
                      <button class="tab-warning-close" @click=${()=>{this._fullscreenWarning=!1,this._antiCheat.requestFullscreen(),this.requestUpdate()}}>Kembali Fullscreen</button>
                    </div>
                  </div>`:v}
    ...
    `}_muatBankSoal(){if(!this.appsScriptUrl){this._note="\u26A0\uFE0F URL Apps Script belum diatur (tab Atur).",this.requestUpdate();return}this._note="\u{1F4E5} Mengambil bank soal dari backend\u2026",this.requestUpdate(),this._apiGet({action:"getBankSoal"}).then(t=>{const e=t&&Array.isArray(t.questions)?t.questions:t&&Array.isArray(t.soal)?t.soal:t&&Array.isArray(t.data)?t.data:null;e&&e.length?(this._soalText=JSON.stringify(e,null,2),this._note=`\u2705 ${e.length} soal dari sheet Bank Soal dimuat ke editor.`):this._note="\u2139\uFE0F Bank soal kosong \u2014 belum ada data di sheet Bank Soal.",this.requestUpdate()}).catch(()=>{this._note="\u26A0\uFE0F Gagal memuat bank soal dari backend.",this.requestUpdate()})}_terapkanSoal(){const t=(this._soalText||"").trim();if(!t){this._note="\u26A0\uFE0F Form kosong. Tempel JSON soal terlebih dahulu.",this.requestUpdate();return}try{let e=JSON.parse(t);if(e&&typeof e=="object"&&!Array.isArray(e))if(Array.isArray(e.questions))e=e.questions;else throw new Error("bukan array");if(!Array.isArray(e))throw new Error("bukan array");this.questions=e,this._note=`\u2705 ${e.length} soal diterapkan ke properti questions & tab Evaluasi Kuis.`}catch{this._note="\u26A0\uFE0F JSON tidak valid. Format: array soal (lihat deskripsi properti questions di HAX editor)."}this.requestUpdate()}_renderPengaturan(){return o`
      ...
      <div class="card-panel" style="margin-top: var(--ddd-spacing-4);">
        ...
        <div class="set-row">
          ...
          ${this._raporStatus?o`<span style="margin-left:var(--ddd-spacing-3); color:#16a34a;">${this._raporStatus}</span>`:v}
        </div>
      </div>
      ...
      <div class="card-panel" style="margin-top: var(--ddd-spacing-4); border-left: 4px solid #f59e0b;">
        ...
        <div class="set-row" style="margin-top: var(--ddd-spacing-3);">
          ...
          ${this._unlockMsg?o`<span style="margin-left:12px; font-size:13px; color:${this._unlockMsg.startsWith("\u2705")?"#16a34a":"#dc2626"};">${this._unlockMsg}</span>`:v}
        </div>
    ...
    `}async _bukaKunciKuisGuru(){const t=(this._unlockSid||this.studentId||"").trim(),e=(this._unlockMateri||this.kdMateri||"LM1").trim();if(!t){this._unlockMsg="\u26A0\uFE0F Isi Student ID dulu.",this.requestUpdate();return}if(!this.appsScriptUrl){this._unlockMsg="\u26A0\uFE0F URL Apps Script belum diatur.",this.requestUpdate();return}this._unlockMsg="\u23F3 Membuka...",this.requestUpdate();try{const a=new URLSearchParams({action:"resetQuizLock",studentId:t,kdMateri:e}),i=await(await fetch(`${this.appsScriptUrl}?${a.toString()}`,{method:"GET",mode:"cors"})).json();if(i&&i.status==="ok"){this._unlockMsg=`\u2705 Kunci ${e} dibuka \u2014 ${i.deleted||0} sesi dihapus. Siswa bisa ulang/remidi.`;try{localStorage.removeItem(`latihan_kuis_attempt_${t}_${e}`),localStorage.removeItem(`latihan_kuis_time_${t}_${e}`)}catch{}}else this._unlockMsg="\u26A0\uFE0F Gagal: "+(i.message||"unknown")}catch(a){this._unlockMsg="\u26A0\uFE0F Error: "+a.message}this.requestUpdate()}async _generateRapor(){if(!this.appsScriptUrl){this._note="\u26A0\uFE0F URL Apps Script belum diatur (tab Atur).",this.requestUpdate();return}this._raporStatus="\u23F3 Membuat laporan...",this._note="",this.requestUpdate();try{const t=await this._apiGet({action:"generateReport"});t&&t.status==="ok"?(this._raporStatus=`\u2705 Rapor berhasil dibuat. ${t.students||0} siswa diproses.`,this._note="\u2705 Rapor berhasil di-generate. Lihat sheet Akumulasi_Nilai_Rapor."):(this._raporStatus="",this._note="\u26A0\uFE0F Gagal: "+(t&&t.message?t.message:"cek konsol."))}catch(t){this._raporStatus="",this._note="\u26A0\uFE0F Error: "+t.message}this.requestUpdate()}async _simpanBobot(){if(!this.appsScriptUrl){this._note="\u26A0\uFE0F URL Apps Script belum diatur (tab Atur).",this.requestUpdate();return}const t={tugas:this._bobotTugas??1,lm:this._bobotLM??3,sts:this._bobotSTS??2,sas:this._bobotSAS??2};this._note="\u23F3 Menyimpan bobot...",this.requestUpdate();try{const e=await this._apiGet({action:"saveBobot",...t});e&&e.status==="ok"?this._note="\u2705 Bobot tersimpan. Generate rapor untuk melihat hasil.":this._note="\u26A0\uFE0F Gagal: "+(e&&e.message?e.message:"cek konsol.")}catch(e){this._note="\u26A0\uFE0F Error: "+e.message}this.requestUpdate()}async _muatBobot(){if(!this.appsScriptUrl){this._note="\u26A0\uFE0F URL Apps Script belum diatur (tab Atur).",this.requestUpdate();return}this._note="\u23F3 Memuat bobot...",this.requestUpdate();try{const t=await this._apiGet({action:"getBobot"});t&&t.status==="ok"&&t.bobot?(this._bobotTugas=t.bobot.tugas??1,this._bobotLM=t.bobot.lm??3,this._bobotSTS=t.bobot.sts??2,this._bobotSAS=t.bobot.sas??2,this._note="\u2705 Bobot dimuat."):this._note="\u2139\uFE0F Belum ada bobot tersimpan, menggunakan default."}catch(t){this._note="\u26A0\uFE0F Error: "+t.message}this.requestUpdate()}_renderPantauanGuru(){const t=this._serverData.roster||[];if(t.length===0)return o`
      ...
      <div class="grid-heatmap">
        ${t.map(s=>{const d=this._num(s.nilaiAkhir),l=d>=75?"lvl-high":d>=60?"lvl-mid":"lvl-low",c=d>=75?{cls:"badge-good",txt:`${s.emoji||"\u2705"} LULUS`}:d>=60?{cls:"badge-warn",txt:`${s.emoji||"\u26A0\uFE0F"} PROSES`}:{cls:"badge-bad",txt:`${s.emoji||"\u{1F4ED}"} REMEDI`},u=(s.nama||"?").trim().charAt(0).toUpperCase(),m=["#4f46e5","#0891b2","#059669","#d97706","#db2777","#7c3aed"][(s.absen||"0").toString().length%6];return o`
    ...
    `}_materiCol(){const t=String(this.kdMateri||"").trim(),e=t.match(/^LM\s*0?(\d+)$/i);if(e)return`LM${e[1]}`;const a=t.match(/^Pertemuan\s*0?(\d+)$/i);return a?`LM${a[1]}`:/^STS$/i.test(t)?"STS":/^SAS$/i.test(t)?"SAS":""}_renderLeaderboard(){let t=this._serverData.leaderboard||[];if(t.length===0)return o`
      ...
      `;const e=this._canonKelas(this._peringkatKelas||this.kelas||"");e&&(t=t.filter(u=>this._canonKelas(this._rowValue(u,"Kelas"))===e));const a=this._materiCol(),i=new Map((this._serverData.roster||[]).map(u=>[String(u.studentId),u])),r=t.map((u,m)=>{const w=a?this._num(this._rowValue(u,a)):null,M=w!=null&&w>0?w:this._num(this._rowValue(u,"Nilai_Rapor")||this._rowValue(u,"Rata-rata Skor")),k=String(this._rowValue(u,"StudentID")||this._rowValue(u,"Student ID")||""),T=i.get(k)||(this._serverData.roster||[]).find(P=>String(P.nis)===String(this._rowValue(u,"NIS")))||null,x=String(this._rowValue(u,"Absen")||T?.absen||"").trim();return{...u,_rank:m+1,_nilai:M,_lmNilai:w,_nama:String(this._rowValue(u,"Nama")||T?.nama||"-"),_absen:x,_kelas:String(this._rowValue(u,"Kelas")||T?.kelas||""),_totalKuis:this._num(this._rowValue(u,"Total Kuis")||T?.totalKuis||0),_totalAktivitas:this._num(this._rowValue(u,"Total Aktivitas")||T?.totalActivities||0),_reading:this._num(this._rowValue(u,"Reading")),_quizAct:this._num(this._rowValue(u,"Quiz Activity")),_forum:this._num(this._rowValue(u,"Discussion")),_status:String(this._rowValue(u,"Status Kuis Terakhir")||T?.grade||"N/A"),_pertemuan:this._num(this._rowValue(u,"Jumlah Pertemuan"))}}).map((u,m)=>({...u,_rank:m+1})),s=this._leaderSortKey&&this._leaderSortKey!=="nilai"?this._getSortedLeaderboardRows(r):[...r].sort((u,m)=>(m._nilai||0)-(u._nilai||0)).map((u,m)=>({...u,_rank:m+1})),d=s[0]||{_nama:"-",_nilai:0},l=s[1]||{_nama:"-",_nilai:0},c=s[2]||{_nama:"-",_nilai:0};return o`
      ...
      <div class="podium-section">
        ...
        <div class="podium-box rank-3">
          <div class="podium-medal">🥉</div>
          <div class="podium-name">${c._nama}</div>
          <div class="podium-score">${c._nilai}%</div>
          <div style="font-size:11px;color:#94a3b8;">${this._num(c._totalKuis)} kuis • ${this._num(c._totalAktivitas)} aktivitas</div>
        </div>
      </div>
...
`)}_eksporNilai(t){const e=this._filterPeringkat(this._buildPeringkat());if(!e.length){this._note="Belum ada baris untuk diekspor.",this.requestUpdate();return}const a="peringkat-bimbingan-"+String(this._peringkatKelas||this.kelas||"semua").replace(/[^a-zA-Z0-9-_]/g,"");if(t==="copas"){this._copasTSV=this._csvKerangka(e,"	"),this._note="Kotak TSV siap disalin \u2014 paste langsung ke Google Sheets / Excel.",this.requestUpdate();return}if(t==="csv"){const i="\uFEFF"+this._csvKerangka(e,",");this._downloadBlob(`${a}.csv`,i,"text/csv;charset=utf-8;")}else{const{headers:i,grid:r}=this._rowPeringkatKeCSV(e),s=i.map(c=>`<th>${this._hs(c)}</th>`).join(""),d=r.map(c=>`<tr>${c.map(u=>`<td>${this._hs(u)}</td>`).join("")}</tr>`).join(""),l=`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel"><head><meta charset="utf-8"><!--[if gte mso 9]><xml><x:ExcelWorkbook><x:ExcelWorksheets><x:ExcelWorksheet><x:Name>Peringkat</x:Name><x:WorksheetOptions><x:DisplayGridlines/></x:WorksheetOptions></x:ExcelWorksheet></x:ExcelWorksheets></x:ExcelWorkbook></xml><![endif]--></head><body><table><thead><tr>${s}</tr></thead><tbody>${d}</tbody></table></body></html>`;this._downloadBlob(`${a}.xls`,l,"application/vnd.ms-excel;charset=utf-8;")}this._note=`\u2705 Ekspor ${t.toUpperCase()} selesai (${e.length} siswa).`,this.requestUpdate()}_downloadBlob(t,e,a){const i=new Blob([e],{type:a}),r=URL.createObjectURL(i),s=document.createElement("a");s.href=r,s.download=t,document.body.appendChild(s),s.click(),document.body.removeChild(s),setTimeout(()=>URL.revokeObjectURL(r),1500)}_hs(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}_renderHasilSiswa(){const t=this._serverData.siswa;if(!t)return o`
      ...
      `;const e=this._num(t.kehadiran),a=this._num(t.ulanganHarian&&(t.ulanganHarian.average||t.ulanganHarian.highest)||0),i=this._num(t.uts&&t.uts.highest||0),r=this._num(t.uas&&t.uas.highest||0),s=this._num(t.sikap),d=this._num(t.keterampilan),l=Math.round(parseFloat(t.nilaiAkhir)||0),c=String(t.grade||"-"),u=Math.max(0,Math.min(100,l))*3.6,m=Array.isArray(t.lm)?t.lm:Array.isArray(t.LM)?t.LM:[],w=m.length>0&&m.some(k=>this._num(k)>0),M=[{label:"Kehadiran",value:e,unit:"%"},{label:"Rata-rata UH",value:a,unit:""},{label:"Skor UTS",value:i,unit:""},{label:"Skor UAS",value:r,unit:""},{label:"Sikap",value:s,unit:""},{label:"Keterampilan",value:d,unit:""}];return o`
      <h2 style="margin-top: 0; color: #1e293b;">🎯 Hasil & Nilai Evaluasi Anda</h2>
          ...
          ${w?o`
            <div class="card-siswa" style="padding: var(--ddd-spacing-4); margin-top: var(--ddd-spacing-4);">
              ...
              <div style="display:grid; grid-template-columns: repeat(auto-fill, minmax(86px,1fr)); gap: var(--ddd-spacing-2);">
                ${m.map((k,T)=>{const x=this._num(k),P=String(this.kdMateri||"").trim().toLowerCase()===`lm${T+1}`.toLowerCase()||String(this.kdMateri||"").trim()===`Pertemuan ${T+1}`;return o`
                    <button @click=${()=>{this.kdMateri=`LM${T+1}`,this.requestUpdate()}}
                      style="border:1px solid ${P?"#4F46E5":"#E2E8F0"}; background:${x>=75?"#ECFDF5":x>=60?"#FFFBEB":x>0?"#FEF2F2":"#F8FAFC"}; border-radius:12px; padding:10px 6px; text-align:center; cursor:pointer;">
                      <div style="font-size:11px; font-weight:700; color:#475569;">LM${T+1}</div>
