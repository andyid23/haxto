 ...
 */const kt=globalThis,St=kt.ShadowRoot&&(kt.ShadyCSS===void 0||kt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,$t=Symbol(),Rt=new WeakMap;let Bt=class{constructor(t,e,a){if(this._$cssResult$=!0,a!==$t)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(St&&t===void 0){const a=e!==void 0&&e.length===1;a&&(t=Rt.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),a&&Rt.set(e,t))}return t}toString(){return this.cssText}};const Te=c=>new Bt(typeof c=="string"?c:c+"",void 0,$t),z=(c,...t)=>{const e=c.length===1?c[0]:t.reduce((a,i,s)=>a+(r=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+c[s+1],c[0]);return new Bt(e,c,$t)},Ee=(c,t)=>{if(St)c.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const e of t){const a=document.createElement("style"),i=kt.litNonce;i!==void 0&&a.setAttribute("nonce",i),a.textContent=e.cssText,c.appendChild(a)}},jt=St?c=>c:c=>c instanceof CSSStyleSheet?(t=>{let e="";for(const a of t.cssRules)e+=a.cssText;return Te(e)})(c):c;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:qe,defineProperty:ze,getOwnPropertyDescriptor:Ue,getOwnPropertyNames:Ke,getOwnPropertySymbols:Le,getPrototypeOf:Fe}=Object,Q=globalThis,Ot=Q.trustedTypes,Ne=Ot?Ot.emptyScript:"",De=Q.reactiveElementPolyfillSupport,ut=(c,t)=>c,At={toAttribute(c,t){switch(t){case Boolean:c=c?Ne:null;break;case Object:case Array:c=c==null?c:JSON.stringify(c)}return c},fromAttribute(c,t){let e=c;switch(t){case Boolean:e=c!==null;break;case Number:e=c===null?null:Number(c);break;case Object:case Array:try{e=JSON.parse(c)}catch{e=null}}return e}},Qt=(c,t)=>!qe(c,t),Gt={attribute:!0,type:String,converter:At,reflect:!1,useDefault:!1,hasChanged:Qt};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),Q.litPropertyMetadata??(Q.litPropertyMetadata=new WeakMap);let et=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=Gt){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){const a=Symbol(),i=this.getPropertyDescriptor(t,a,e);i!==void 0&&ze(this.prototype,t,i)}}static getPropertyDescriptor(t,e,a){const{get:i,set:s}=Ue(this.prototype,t)??{get(){return this[e]},set(r){this[e]=r}};return{get:i,set(r){const d=i?.call(this);s?.call(this,r),this.requestUpdate(t,d,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Gt}static _$Ei(){if(this.hasOwnProperty(ut("elementProperties")))return;const t=Fe(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(ut("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(ut("properties"))){const e=this.properties,a=[...Ke(e),...Le(e)];for(const i of a)this.createProperty(i,e[i])}const t=this[Symbol.metadata];if(t!==null){const e=litPropertyMetadata.get(t);if(e!==void 0)for(const[a,i]of e)this.elementProperties.set(a,i)}this._$Eh=new Map;for(const[e,a]of this.elementProperties){const i=this._$Eu(e,a);i!==void 0&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const a=new Set(t.flat(1/0).reverse());for(const i of a)e.unshift(jt(i))}else t!==void 0&&e.push(jt(t));return e}static _$Eu(t,e){const a=e.attribute;return a===!1?void 0:typeof a=="string"?a:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const a of e.keys())this.hasOwnProperty(a)&&(t.set(a,this[a]),delete this[a]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ee(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,a){this._$AK(t,a)}_$ET(t,e){const a=this.constructor.elementProperties.get(t),i=this.constructor._$Eu(t,a);if(i!==void 0&&a.reflect===!0){const s=(a.converter?.toAttribute!==void 0?a.converter:At).toAttribute(e,a.type);this._$Em=t,s==null?this.removeAttribute(i):this.setAttribute(i,s),this._$Em=null}}_$AK(t,e){const a=this.constructor,i=a._$Eh.get(t);if(i!==void 0&&this._$Em!==i){const s=a.getPropertyOptions(i),r=typeof s.converter=="function"?{fromAttribute:s.converter}:s.converter?.fromAttribute!==void 0?s.converter:At;this._$Em=i;const d=r.fromAttribute(e,s.type);this[i]=d??this._$Ej?.get(i)??d,this._$Em=null}}requestUpdate(t,e,a,i=!1,s){if(t!==void 0){const r=this.constructor;if(i===!1&&(s=this[t]),a??(a=r.getPropertyOptions(t)),!((a.hasChanged??Qt)(s,e)||a.useDefault&&a.reflect&&s===this._$Ej?.get(t)&&!this.hasAttribute(r._$Eu(t,a))))return;this.C(t,e,a)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:a,reflect:i,wrapped:s},r){a&&!(this._$Ej??(this._$Ej=new Map)).has(t)&&(this._$Ej.set(t,r??e??this[t]),s!==!0||r!==void 0)||(this._$AL.has(t)||(this.hasUpdated||a||(e=void 0),this._$AL.set(t,e)),i===!0&&this._$Em!==t&&(this._$Eq??(this._$Eq=new Set)).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[i,s]of this._$Ep)this[i]=s;this._$Ep=void 0}const a=this.constructor.elementProperties;if(a.size>0)for(const[i,s]of a){const{wrapped:r}=s,d=this[i];r!==!0||this._$AL.has(i)||d===void 0||this.C(i,void 0,s,d)}}let t=!1;const e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(a=>a.hostUpdate?.()),this.update(e)):this._$EM()}catch(a){throw t=!1,this._$EM(),a}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&(this._$Eq=this._$Eq.forEach(e=>this._$ET(e,this[e]))),this._$EM()}updated(t){}firstUpdated(t){}};et.elementStyles=[],et.shadowRootOptions={mode:"open"},et[ut("elementProperties")]=new Map,et[ut("finalized")]=new Map,De?.({ReactiveElement:et}),(Q.reactiveElementVersions??(Q.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ct=globalThis,Jt=c=>c,_t=ct.trustedTypes,Wt=_t?_t.createPolicy("lit-html",{createHTML:c=>c}):void 0,Ht="$lit$",G=`lit$${Math.random().toFixed(9).slice(2)}$`,Vt="?"+G,Pe=`<${Vt}>`,H=document,pt=()=>H.createComment(""),mt=c=>c===null||typeof c!="object"&&typeof c!="function",Mt=Array.isArray,Re=c=>Mt(c)||typeof c?.[Symbol.iterator]=="function",It=`[ 	
\f\r]`,gt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Yt=/-->/g,Xt=/>/g,V=RegExp(`>|${It}(?:([^\\s"'>=/]+)(${It}*=${It}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Zt=/'/g,te=/"/g,ee=/^(?:script|style|textarea|title)$/i,Be=c=>(t,...e)=>({_$litType$:c,strings:t,values:e}),o=Be(1),at=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),ae=new WeakMap,Y=H.createTreeWalker(H,129);function ie(c,t){if(!Mt(c)||!c.hasOwnProperty("raw"))throw Error("invalid template strings array");return Wt!==void 0?Wt.createHTML(t):t}const je=(c,t)=>{const e=c.length-1,a=[];let i,s=t===2?"<svg>":t===3?"<math>":"",r=gt;for(let d=0;d<e;d++){const l=c[d];let p,u,m=-1,A=0;for(;A<l.length&&(r.lastIndex=A,u=r.exec(l),u!==null);)A=r.lastIndex,r===gt?u[1]==="!--"?r=Yt:u[1]!==void 0?r=Xt:u[2]!==void 0?(ee.test(u[2])&&(i=RegExp("</"+u[2],"g")),r=V):u[3]!==void 0&&(r=V):r===V?u[0]===">"?(r=i??gt,m=-1):u[1]===void 0?m=-2:(m=r.lastIndex-u[2].length,p=u[1],r=u[3]===void 0?V:u[3]==='"'?te:Zt):r===te||r===Zt?r=V:r===Yt||r===Xt?r=gt:(r=V,i=void 0);const C=r===V&&c[d+1].startsWith("/>")?" ":"";s+=r===gt?l+Pe:m>=0?(a.push(p),l.slice(0,m)+Ht+l.slice(m)+G+C):l+G+(m===-2?d:C)}return[ie(c,s+(c[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),a]};class vt{constructor({strings:t,_$litType$:e},a){let i;this.parts=[];let s=0,r=0;const d=t.length-1,l=this.parts,[p,u]=je(t,e);if(this.el=vt.createElement(p,a),Y.currentNode=this.el.content,e===2||e===3){const m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(i=Y.nextNode())!==null&&l.length<d;){if(i.nodeType===1){if(i.hasAttributes())for(const m of i.getAttributeNames())if(m.endsWith(Ht)){const A=u[r++],C=i.getAttribute(m).split(G),k=/([.?@])?(.*)/.exec(A);l.push({type:1,index:s,name:k[2],strings:C,ctor:k[1]==="."?Qe:k[1]==="?"?Ge:k[1]==="@"?Je:yt}),i.removeAttribute(m)}else m.startsWith(G)&&(l.push({type:6,index:s}),i.removeAttribute(m));if(ee.test(i.tagName)){const m=i.textContent.split(G),A=m.length-1;if(A>0){i.textContent=_t?_t.emptyScript:"";for(let C=0;C<A;C++)i.append(m[C],pt()),Y.nextNode(),l.push({type:2,index:++s});i.append(m[A],pt())}}}else if(i.nodeType===8)if(i.data===Vt)l.push({type:2,index:s});else{let m=-1;for(;(m=i.data.indexOf(G,m+1))!==-1;)l.push({type:7,index:s}),m+=G.length-1}s++}}static createElement(t,e){const a=H.createElement("template");return a.innerHTML=t,a}}function it(c,t,e=c,a){if(t===at)return t;let i=a!==void 0?e._$Co?.[a]:e._$Cl;const s=mt(t)?void 0:t._$litDirective$;return i?.constructor!==s&&(i?._$AO?.(!1),s===void 0?i=void 0:(i=new s(c),i._$AT(c,e,a)),a!==void 0?(e._$Co??(e._$Co=[]))[a]=i:e._$Cl=i),i!==void 0&&(t=it(c,i._$AS(c,t.values),i,a)),t}class Oe{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:a}=this._$AD,i=(t?.creationScope??H).importNode(e,!0);Y.currentNode=i;let s=Y.nextNode(),r=0,d=0,l=a[0];for(;l!==void 0;){if(r===l.index){let p;l.type===2?p=new Ct(s,s.nextSibling,this,t):l.type===1?p=new l.ctor(s,l.name,l.strings,this,t):l.type===6&&(p=new We(s,this,t)),this._$AV.push(p),l=a[++d]}r!==l?.index&&(s=Y.nextNode(),r++)}return Y.currentNode=H,i}p(t){let e=0;for(const a of this._$AV)a!==void 0&&(a.strings!==void 0?(a._$AI(t,a,e),e+=a.strings.length-2):a._$AI(t[e])),e++}}let Ct=class oe{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,a,i){this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=a,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=it(this,t,e),mt(t)?t===f||t==null||t===""?(this._$AH!==f&&this._$AR(),this._$AH=f):t!==this._$AH&&t!==at&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Re(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==f&&mt(this._$AH)?this._$AA.nextSibling.data=t:this.T(H.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:a}=t,i=typeof a=="number"?this._$AC(t):(a.el===void 0&&(a.el=vt.createElement(ie(a.h,a.h[0]),this.options)),a);if(this._$AH?._$AD===i)this._$AH.p(e);else{const s=new Oe(i,this),r=s.u(this.options);s.p(e),this.T(r),this._$AH=s}}_$AC(t){let e=ae.get(t.strings);return e===void 0&&ae.set(t.strings,e=new vt(t)),e}k(t){Mt(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let a,i=0;for(const s of t)i===e.length?e.push(a=new oe(this.O(pt()),this.O(pt()),this,this.options)):a=e[i],a._$AI(s),i++;i<e.length&&(this._$AR(a&&a._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const a=Jt(t).nextSibling;Jt(t).remove(),t=a}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}};class yt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,a,i,s){this.type=1,this._$AH=f,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=s,a.length>2||a[0]!==""||a[1]!==""?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=f}_$AI(t,e=this,a,i){const s=this.strings;let r=!1;if(s===void 0)t=it(this,t,e,0),r=!mt(t)||t!==this._$AH&&t!==at,r&&(this._$AH=t);else{const d=t;let l,p;for(t=s[0],l=0;l<s.length-1;l++)p=it(this,d[a+l],e,l),p===at&&(p=this._$AH[l]),r||(r=!mt(p)||p!==this._$AH[l]),p===f?t=f:t!==f&&(t+=(p??"")+s[l+1]),this._$AH[l]=p}r&&!i&&this.j(t)}j(t){t===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Qe extends yt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===f?void 0:t}}class Ge extends yt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==f)}}class Je extends yt{constructor(t,e,a,i,s){super(t,e,a,i,s),this.type=5}_$AI(t,e=this){if((t=it(this,t,e,0)??f)===at)return;const a=this._$AH,i=t===f&&a!==f||t.capture!==a.capture||t.once!==a.once||t.passive!==a.passive,s=t!==f&&(a===f||i);i&&this.element.removeEventListener(this.name,this,a),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class We{constructor(t,e,a){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(t){it(this,t)}}const He=ct.litHtmlPolyfillSupport;He?.(vt,Ct),(ct.litHtmlVersions??(ct.litHtmlVersions=[])).push("3.3.3");const Ve=(c,t,e)=>{const a=e?.renderBefore??t;let i=a._$litPart$;if(i===void 0){const s=e?.renderBefore??null;a._$litPart$=i=new Ct(t.insertBefore(pt(),s),s,void 0,e??{})}return i._$AI(c),i};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const bt=globalThis;class F extends et{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;const t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ve(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return at}}F._$litElement$=!0,F.finalized=!0,bt.litElementHydrateSupport?.({LitElement:F});const Ye=bt.litElementPolyfillSupport;Ye?.({LitElement:F}),(bt.litElementVersions??(bt.litElementVersions=[])).push("4.2.2");var Tt={};(function c(t,e,a,i){var s=!!(t.Worker&&t.Blob&&t.Promise&&t.OffscreenCanvas&&t.OffscreenCanvasRenderingContext2D&&t.HTMLCanvasElement&&t.HTMLCanvasElement.prototype.transferControlToOffscreen&&t.URL&&t.URL.createObjectURL),r=typeof Path2D=="function"&&typeof DOMMatrix=="function",d=(function(){if(!t.OffscreenCanvas)return!1;try{var h=new OffscreenCanvas(1,1),n=h.getContext("2d");n.fillRect(0,0,1,1);var g=h.transferToImageBitmap();n.createPattern(g,"no-repeat")}catch{return!1}return!0})();function l(){}function p(h){var n=e.exports.Promise,g=n!==void 0?n:t.Promise;return typeof g=="function"?new g(h):(h(l,l),null)}var u=(function(h,n){return{transform:function(g){if(h)return g;if(n.has(g))return n.get(g);var v=new OffscreenCanvas(g.width,g.height),_=v.getContext("2d");return _.drawImage(g,0,0),n.set(g,v),v},clear:function(){n.clear()}}})(d,new Map),m=(function(){var h=Math.floor(16.666666666666668),n,g,v={},_=0;return typeof requestAnimationFrame=="function"&&typeof cancelAnimationFrame=="function"?(n=function(y){var w=Math.random();return v[w]=requestAnimationFrame(function b(S){_===S||_+h-1<S?(_=S,delete v[w],y()):v[w]=requestAnimationFrame(b)}),w},g=function(y){v[y]&&cancelAnimationFrame(v[y])}):(n=function(y){return setTimeout(y,h)},g=function(y){return clearTimeout(y)}),{frame:n,cancel:g}})(),A=(function(){var h,n,g={};function v(_){function y(w,b){_.postMessage({options:w||{},callback:b})}_.init=function(b){var S=b.transferControlToOffscreen();_.postMessage({canvas:S},[S])},_.fire=function(b,S,M){if(n)return y(b,null),n;var E=Math.random().toString(36).slice(2);return n=p(function(I){function q(U){U.data.callback===E&&(delete g[E],_.removeEventListener("message",q),n=null,u.clear(),M(),I())}_.addEventListener("message",q),y(b,E),g[E]=q.bind(null,{data:{callback:E}})}),n},_.reset=function(){_.postMessage({reset:!0});for(var b in g)g[b](),delete g[b]}}return function(){if(h)return h;if(!a&&s){var _=["var CONFETTI, SIZE = {}, module = {};","("+c.toString()+")(this, module, true, SIZE);","onmessage = function(msg) {","  if (msg.data.options) {","    CONFETTI(msg.data.options).then(function () {","      if (msg.data.callback) {","        postMessage({ callback: msg.data.callback });","      }","    });","  } else if (msg.data.reset) {","    CONFETTI && CONFETTI.reset();","  } else if (msg.data.resize) {","    SIZE.width = msg.data.resize.width;","    SIZE.height = msg.data.resize.height;","  } else if (msg.data.canvas) {","    SIZE.width = msg.data.canvas.width;","    SIZE.height = msg.data.canvas.height;","    CONFETTI = module.exports.create(msg.data.canvas);","  }","}"].join(`
`);try{h=new Worker(URL.createObjectURL(new Blob([_])))}catch(y){return typeof console<"u"&&typeof console.warn=="function"&&console.warn("\u{1F38A} Could not load worker",y),null}v(h)}return h}})(),C={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function k(h,n){return n?n(h):h}function T(h){return h!=null}function x(h,n,g){return k(h&&T(h[n])?h[n]:C[n],g)}function R(h){return h<0?0:Math.floor(h)}function ft(h,n){return Math.floor(Math.random()*(n-h))+h}function tt(h){return parseInt(h,16)}function lt(h){return h.map(ne)}function ne(h){var n=String(h).replace(/[^0-9a-f]/gi,"");return n.length<6&&(n=n[0]+n[0]+n[1]+n[1]+n[2]+n[2]),{r:tt(n.substring(0,2)),g:tt(n.substring(2,4)),b:tt(n.substring(4,6))}}function le(h){var n=x(h,"origin",Object);return n.x=x(n,"x",Number),n.y=x(n,"y",Number),n}function he(h){h.width=document.documentElement.clientWidth,h.height=document.documentElement.clientHeight}function ue(h){var n=h.getBoundingClientRect();h.width=n.width,h.height=n.height}function ce(h){var n=document.createElement("canvas");return n.style.position="fixed",n.style.top="0px",n.style.left="0px",n.style.pointerEvents="none",n.style.zIndex=h,n}function pe(h,n,g,v,_,y,w,b,S){h.save(),h.translate(n,g),h.rotate(y),h.scale(v,_),h.arc(0,0,1,w,b,S),h.restore()}function me(h){var n=h.angle*(Math.PI/180),g=h.spread*(Math.PI/180);return{x:h.x,y:h.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:h.startVelocity*.5+Math.random()*h.startVelocity,angle2D:-n+(.5*g-Math.random()*g),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:h.color,shape:h.shape,tick:0,totalTicks:h.ticks,decay:h.decay,drift:h.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:h.gravity*3,ovalScalar:.6,scalar:h.scalar,flat:h.flat}}function ge(h,n){n.x+=Math.cos(n.angle2D)*n.velocity+n.drift,n.y+=Math.sin(n.angle2D)*n.velocity+n.gravity,n.velocity*=n.decay,n.flat?(n.wobble=0,n.wobbleX=n.x+10*n.scalar,n.wobbleY=n.y+10*n.scalar,n.tiltSin=0,n.tiltCos=0,n.random=1):(n.wobble+=n.wobbleSpeed,n.wobbleX=n.x+10*n.scalar*Math.cos(n.wobble),n.wobbleY=n.y+10*n.scalar*Math.sin(n.wobble),n.tiltAngle+=.1,n.tiltSin=Math.sin(n.tiltAngle),n.tiltCos=Math.cos(n.tiltAngle),n.random=Math.random()+2);var g=n.tick++/n.totalTicks,v=n.x+n.random*n.tiltCos,_=n.y+n.random*n.tiltSin,y=n.wobbleX+n.random*n.tiltCos,w=n.wobbleY+n.random*n.tiltSin;if(h.fillStyle="rgba("+n.color.r+", "+n.color.g+", "+n.color.b+", "+(1-g)+")",h.beginPath(),r&&n.shape.type==="path"&&typeof n.shape.path=="string"&&Array.isArray(n.shape.matrix))h.fill(ve(n.shape.path,n.shape.matrix,n.x,n.y,Math.abs(y-v)*.1,Math.abs(w-_)*.1,Math.PI/10*n.wobble));else if(n.shape.type==="bitmap"){var b=Math.PI/10*n.wobble,S=Math.abs(y-v)*.1,M=Math.abs(w-_)*.1,E=n.shape.bitmap.width*n.scalar,I=n.shape.bitmap.height*n.scalar,q=new DOMMatrix([Math.cos(b)*S,Math.sin(b)*S,-Math.sin(b)*M,Math.cos(b)*M,n.x,n.y]);q.multiplySelf(new DOMMatrix(n.shape.matrix));var U=h.createPattern(u.transform(n.shape.bitmap),"no-repeat");U.setTransform(q),h.globalAlpha=1-g,h.fillStyle=U,h.fillRect(n.x-E/2,n.y-I/2,E,I),h.globalAlpha=1}else if(n.shape==="circle")h.ellipse?h.ellipse(n.x,n.y,Math.abs(y-v)*n.ovalScalar,Math.abs(w-_)*n.ovalScalar,Math.PI/10*n.wobble,0,2*Math.PI):pe(h,n.x,n.y,Math.abs(y-v)*n.ovalScalar,Math.abs(w-_)*n.ovalScalar,Math.PI/10*n.wobble,0,2*Math.PI);else if(n.shape==="star")for(var $=Math.PI/2*3,L=4*n.scalar,N=8*n.scalar,D=n.x,B=n.y,W=5,P=Math.PI/W;W--;)D=n.x+Math.cos($)*N,B=n.y+Math.sin($)*N,h.lineTo(D,B),$+=P,D=n.x+Math.cos($)*L,B=n.y+Math.sin($)*L,h.lineTo(D,B),$+=P;else h.moveTo(Math.floor(n.x),Math.floor(n.y)),h.lineTo(Math.floor(n.wobbleX),Math.floor(_)),h.lineTo(Math.floor(y),Math.floor(w)),h.lineTo(Math.floor(v),Math.floor(n.wobbleY));return h.closePath(),h.fill(),n.tick<n.totalTicks}function be(h,n,g,v,_){var y=n.slice(),w=h.getContext("2d"),b,S,M=p(function(E){function I(){b=S=null,w.clearRect(0,0,v.width,v.height),u.clear(),_(),E()}function q(){a&&!(v.width===i.width&&v.height===i.height)&&(v.width=h.width=i.width,v.height=h.height=i.height),!v.width&&!v.height&&(g(h),v.width=h.width,v.height=h.height),w.clearRect(0,0,v.width,v.height),y=y.filter(function(U){return ge(w,U)}),y.length?b=m.frame(q):I()}b=m.frame(q),S=I});return{addFettis:function(E){return y=y.concat(E),M},canvas:h,promise:M,reset:function(){b&&m.cancel(b),S&&S()}}}function Ut(h,n){var g=!h,v=!!x(n||{},"resize"),_=!1,y=x(n,"disableForReducedMotion",Boolean),w=s&&!!x(n||{},"useWorker"),b=w?A():null,S=g?he:ue,M=h&&b?!!h.__confetti_initialized:!1,E=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,I;function q($,L,N){for(var D=x($,"particleCount",R),B=x($,"angle",Number),W=x($,"spread",Number),P=x($,"startVelocity",Number),_e=x($,"decay",Number),ye=x($,"gravity",Number),xe=x($,"drift",Number),Lt=x($,"colors",lt),we=x($,"ticks",Number),Ft=x($,"shapes"),Se=x($,"scalar"),$e=!!x($,"flat"),Nt=le($),Dt=D,wt=[],Ae=h.width*Nt.x,Me=h.height*Nt.y;Dt--;)wt.push(me({x:Ae,y:Me,angle:B,spread:W,startVelocity:P,color:Lt[Dt%Lt.length],shape:Ft[ft(0,Ft.length)],ticks:we,decay:_e,gravity:ye,drift:xe,scalar:Se,flat:$e}));return I?I.addFettis(wt):(I=be(h,wt,S,L,N),I.promise)}function U($){var L=y||x($,"disableForReducedMotion",Boolean),N=x($,"zIndex",Number);if(L&&E)return p(function(P){P()});g&&I?h=I.canvas:g&&!h&&(h=ce(N),document.body.appendChild(h)),v&&!M&&S(h);var D={width:h.width,height:h.height};b&&!M&&b.init(h),M=!0,b&&(h.__confetti_initialized=!0);function B(){if(b){var P={getBoundingClientRect:function(){if(!g)return h.getBoundingClientRect()}};S(P),b.postMessage({resize:{width:P.width,height:P.height}});return}D.width=D.height=null}function W(){I=null,v&&(_=!1,t.removeEventListener("resize",B)),g&&h&&(document.body.contains(h)&&document.body.removeChild(h),h=null,M=!1)}return v&&!_&&(_=!0,t.addEventListener("resize",B,!1)),b?b.fire($,D,W):q($,D,W)}return U.reset=function(){b&&b.reset(),I&&I.reset()},U}var xt;function Kt(){return xt||(xt=Ut(null,{useWorker:!0,resize:!0})),xt}function ve(h,n,g,v,_,y,w){var b=new Path2D(h),S=new Path2D;S.addPath(b,new DOMMatrix(n));var M=new Path2D;return M.addPath(S,new DOMMatrix([Math.cos(w)*_,Math.sin(w)*_,-Math.sin(w)*y,Math.cos(w)*y,g,v])),M}function fe(h){if(!r)throw new Error("path confetti are not supported in this browser");var n,g;typeof h=="string"?n=h:(n=h.path,g=h.matrix);var v=new Path2D(n),_=document.createElement("canvas"),y=_.getContext("2d");if(!g){for(var w=1e3,b=w,S=w,M=0,E=0,I,q,U=0;U<w;U+=2)for(var $=0;$<w;$+=2)y.isPointInPath(v,U,$,"nonzero")&&(b=Math.min(b,U),S=Math.min(S,$),M=Math.max(M,U),E=Math.max(E,$));I=M-b,q=E-S;var L=10,N=Math.min(L/I,L/q);g=[N,0,0,N,-Math.round(I/2+b)*N,-Math.round(q/2+S)*N]}return{type:"path",path:n,matrix:g}}function ke(h){var n,g=1,v="#000000",_='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof h=="string"?n=h:(n=h.text,g="scalar"in h?h.scalar:g,_="fontFamily"in h?h.fontFamily:_,v="color"in h?h.color:v);var y=10*g,w=""+y+"px "+_,b=new OffscreenCanvas(y,y),S=b.getContext("2d");S.font=w;var M=S.measureText(n),E=Math.ceil(M.actualBoundingBoxRight+M.actualBoundingBoxLeft),I=Math.ceil(M.actualBoundingBoxAscent+M.actualBoundingBoxDescent),q=2,U=M.actualBoundingBoxLeft+q,$=M.actualBoundingBoxAscent+q;E+=q+q,I+=q+q,b=new OffscreenCanvas(E,I),S=b.getContext("2d"),S.font=w,S.fillStyle=v,S.fillText(n,U,$);var L=1/g;return{type:"bitmap",bitmap:b.transferToImageBitmap(),matrix:[L,0,0,L,-E*L/2,-I*L/2]}}e.exports=function(){return Kt().apply(this,arguments)},e.exports.reset=function(){Kt().reset()},e.exports.create=Ut,e.exports.shapeFromPath=fe,e.exports.shapeFromText=ke})((function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}})(),Tt,!1);var Xe=Tt.exports;Tt.exports.create;class Et extends O(j(F)){static get tag(){return"timer-kuis"}static get properties(){return{...super.properties,duration:{type:Number,attribute:"duration",reflect:!0},remaining:{type:Number,attribute:"remaining",reflect:!0},autostart:{type:Boolean,attribute:"autostart",reflect:!0},kdMateri:{type:String,attribute:"kd-materi"},studentId:{type:String,attribute:"student-id"},_remaining:{state:!0},_running:{state:!0},hideControls:{type:Boolean,attribute:"hide-controls",reflect:!0}}}constructor(){super(),this.duration=300,this.autostart=!1,this.hideControls=!1,this._remaining=this.duration,this._running=!1,this._intervalId=null,this.t={...this.t,title:"Waktu Kuis",start:"Mulai",pause:"Jeda",reset:"Ulang",done:"Waktu habis"}}connectedCallback(){super.connectedCallback(),this.remaining!=null&&!isNaN(this.remaining)&&this.remaining>0?this._remaining=this.remaining:this._remaining=this.duration,this._onVisChange=this._onVisChange.bind(this),globalThis.addEventListener("visibilitychange",this._onVisChange),this.autostart&&this._remaining>0&&this.start()}disconnectedCallback(){globalThis.removeEventListener("visibilitychange",this._onVisChange),this._clearInterval(),super.disconnectedCallback()}_onVisChange(){document.hidden?this._running&&this.pause():(this._remaining>0&&!this._running&&this.autostart&&this.start(),this._remaining<=0&&!this._running&&(this._remaining=0,this._running=!1,this._clearInterval(),this._clearStartTime(),this._onExpire()))}_startKey(){return`timer_kuis_start_${this.kdMateri||"default"}_${this.studentId||"default"}`}_saveStartTime(t){try{globalThis.localStorage.setItem(this._startKey(),String(t))}catch{}}_loadStartTime(){try{const t=parseInt(globalThis.localStorage.getItem(this._startKey())||"0",10);return isNaN(t)?0:t}catch{return 0}}_clearStartTime(){try{globalThis.localStorage.removeItem(this._startKey())}catch{}}updated(t){t.has("remaining")&&this.remaining!=null&&!isNaN(this.remaining)&&(this._remaining=this.remaining,this._running&&(this._clearInterval(),this._running=!1,this.start())),t.has("duration")&&!this._running&&this.remaining==null&&(this._remaining=this.duration)}start(){this._running||(this._remaining<=0&&(this._remaining=this.duration),this._running=!0,this._clearInterval(),this._saveStartTime(Date.now()-(this.duration-this._remaining)*1e3),this._intervalId=setInterval(()=>this._tick(),1e3))}pause(){this._running=!1,this._clearInterval();const t=this._loadStartTime();if(t>0){const e=Math.floor((Date.now()-t)/1e3);this._remaining=Math.max(0,this.duration-e),this._saveStartTime(Date.now()-(this.duration-this._remaining)*1e3)}}reset(){this._clearInterval(),this._running=!1,this._remaining=this.duration,this._clearStartTime()}_clearInterval(){this._intervalId&&(clearInterval(this._intervalId),this._intervalId=null)}_tick(){const t=this._loadStartTime();if(t>0){const e=Math.floor((Date.now()-t)/1e3);this._remaining=Math.max(0,this.duration-e)}else this._remaining>0&&(this._remaining-=1);this._remaining<=0&&(this._remaining=0,this._running=!1,this._clearInterval(),this._clearStartTime(),this._onExpire())}_onExpire(){this.dispatchEvent(new CustomEvent("timer-kuis-expired",{detail:{duration:this.duration},bubbles:!0,composed:!0}))}_format(t){const e=Math.floor(t/60),a=t%60;return`${String(e).padStart(2,"0")}:${String(a).padStart(2,"0")}`}static get styles(){return[super.styles,z`
        :host { display: block; }
        .timer-card {
    ...
    `}static get haxProperties(){return{api:"1",canScale:!0,canPosition:!0,canEditSource:!1,type:"element",designSystem:{accent:!0,primary:!0,card:!0,text:!0,designTreatment:!1},gizmo:{title:"Timer Kuis",description:"Timer hitung mundur untuk kuis dengan auto-submit via event timer-kuis-expired",icon:"icons:timer",color:"purple",tags:["Education","Timer","Quiz"]},settings:{configure:[{property:"duration",title:"Durasi (detik)",inputMethod:"number",description:"Lama waktu pengerjaan kuis dalam detik",default:300},{property:"autostart",title:"Mulai Otomatis",inputMethod:"boolean",default:!1}]},saveOptions:{unsetAttributes:[]},demoSchema:[{tag:"timer-kuis",properties:{duration:300,autostart:!1},content:""},{tag:"timer-kuis",properties:{duration:60,autostart:!0},content:""}]}}}customElements.get(Et.tag)||globalThis.customElements.define(Et.tag,Et);class Ze{constructor(t){this._host=t}calculateScore(t,e=1){return t?e:0}}class se{static renderMC(t,e){const{selected:a,selectedAnswers:i,answered:s,editable:r,feedbackText:d,feedbackPositive:l,hideAnswers:p}=e,u=e.isMulti,m=t.choices||[],A=t._correctMap?(e.correctAnswers||[]).map(C=>t._correctMap.indexOf(C)):e.correctAnswers||[];return o`
      ...
      ${u&&(!s||r)?o`<button class="btn-submit" @click=${e.onSubmit}>Kirim Jawaban (${i.size} dipilih)</button>`:""}
    `}static renderPGKompleks(t,e){const{selectedAnswers:a,answered:i,editable:s,feedbackText:r,feedbackPositive:d,hideAnswers:l}=e,p=a||new Set,u=i&&!s;return o`
      <div class="choices-container">
        ${t.choices.map((m,A)=>{const C=p.has(A),k=(t.correctAnswers||[]).includes(A);let T="choice-row multi-correct";return i&&!l?(k&&(T+=" correct"),C&&!k&&(T+=" wrong")):C&&(T+=" selected"),o`
            <button
              class="${T} ${u?"disabled":""}"
              ?disabled=${u}
              @click=${()=>e.onToggle(A)}
    ...
    `}static renderPGK(t,e){const{pgkAnswers:a,answered:i,editable:s,feedbackText:r,feedbackPositive:d,hideAnswers:l}=e;return o`
      <div class="pgk-container">
        ${(t.statements||[]).map((p,u)=>{const m=a?a[u]:null;return o`
            <div class="pgk-statement">
              <div class="statement-text">${u+1}. ${p.text}</div>
    ...
    `}static renderMatching(t,e){const{matchAnswers:a,answered:i,editable:s,feedbackText:r,feedbackPositive:d,hideAnswers:l}=e;return o`
      <div class="matching-container">
        <div class="matching-left">
          ${(t.leftItems||[]).map((p,u)=>o`
            <div class="match-item left">${p}</div>
          `)}
        </div>
        <div class="matching-right">
          ${(t.rightItems||[]).map((p,u)=>{const m=a?a[u]:null;return o`
...
${!i||s?o`<button class="btn-submit" @click=${e.onSubmit}>Kirim Jawaban</button>`:""}
    ...
    `}_renderReviewQuestion(t,e){const a=this._normalisasiSoal(e),i=this._siapkanSoal(a);if(!i)return o``;const s=this._userAnswers.get(t)||{},r=i.type||"mc",d=["A","B","C","D","E","F"],l=a._correctMap?i.correctAnswers.map(p=>a._correctMap.indexOf(p)):i.correctAnswers;return o`
      <div class="review-question">
        ...
        ${r==="mc"?o`<ul class="review-mc">${i.pilihan.map((p,u)=>{let m="";return this.hideAnswers||(l.includes(u)?m="review-correct":(!i.isMulti&&s.selected===u||i.isMulti&&s.selectedAnswers&&s.selectedAnswers.has(u))&&(m="review-selected-wrong")),o`<li class="${m}">${d[u]||u+1}. ${p}</li>`})}</ul>`:""}
    ...
    `}_renderQuestionScreen(){const t=this._getActiveQuestions(),e=this._normalisasiSoal(t[this._currentIdx]),a=this._siapkanSoal(e);if(!a)return o`<div class="quiz-card result-box">Soal tidak valid.</div>`;const i=a.type||"mc";return o`
      <div class="quiz-card">
        ...
        ${this.showQuestionNav&&t.length>1?o`<nav class="question-nav" aria-label="Navigasi nomor soal">
              ...
              <div class="nav-grid">
              ${t.map((s,r)=>{const d=r===this._currentIdx,l=this._answeredSet.has(r),p=!l&&!d,u=!this.allowBackwardNav&&l&&r<this._currentIdx;return o`<button
                  type="button"
        ...
        <div class="user-bar">
          <div class="user-info">
            ...
            <div class="user-details">
              ...
              <div class="user-meta">NIS: ${this._nis} | Absen: ${this._absen} | Kelas: ${this._kelas}${this._role?o` | <strong>${this._role==="guru"?"\u{1F468}\u200D\u{1F3EB} Guru":"\u{1F393} Siswa"}</strong>`:f}</div>
    ...
    `}async _bukaKunciKuisGuru(){const t=(this._unlockSid||this.studentId||"").trim(),e=(this._unlockMateri||this.kdMateri||"LM1").trim();if(!t){this._unlockMsg="\u26A0\uFE0F Isi Student ID dulu.",this.requestUpdate();return}if(!this.appsScriptUrl){this._unlockMsg="\u26A0\uFE0F URL Apps Script belum diatur.",this.requestUpdate();return}this._unlockMsg="\u23F3 Membuka...",this.requestUpdate();try{const a=new URLSearchParams({action:"resetQuizLock",studentId:t,kdMateri:e}),i=await(await fetch(`${this.appsScriptUrl}?${a.toString()}`,{method:"GET",mode:"cors"})).json();if(i&&i.status==="ok"){this._unlockMsg=`\u2705 Kunci ${e} dibuka \u2014 ${i.deleted||0} sesi dihapus. Siswa bisa ulang/remidi.`;try{localStorage.removeItem(`latihan_kuis_attempt_${t}_${e}`),localStorage.removeItem(`latihan_kuis_time_${t}_${e}`)}catch{}}else this._unlockMsg="\u26A0\uFE0F Gagal: "+(i.message||"unknown")}catch(a){this._unlockMsg="\u26A0\uFE0F Error: "+a.message}this.requestUpdate()}async _generateRapor(){if(!this.appsScriptUrl){this._note="\u26A0\uFE0F URL Apps Script belum diatur (tab Atur).",this.requestUpdate();return}this._raporStatus="\u23F3 Membuat laporan...",this._note="",this.requestUpdate();try{const t=await this._apiGet({action:"generateReport"});t&&t.status==="ok"?(this._raporStatus=`\u2705 Rapor berhasil dibuat. ${t.students||0} siswa diproses.`,this._note="\u2705 Rapor berhasil di-generate. Lihat sheet Akumulasi_Nilai_Rapor."):(this._raporStatus="",this._note="\u26A0\uFE0F Gagal: "+(t&&t.message?t.message:"cek konsol."))}catch(t){this._raporStatus="",this._note="\u26A0\uFE0F Error: "+t.message}this.requestUpdate()}async _simpanBobot(){if(!this.appsScriptUrl){this._note="\u26A0\uFE0F URL Apps Script belum diatur (tab Atur).",this.requestUpdate();return}const t={tugas:this._bobotTugas??1,lm:this._bobotLM??3,sts:this._bobotSTS??2,sas:this._bobotSAS??2};this._note="\u23F3 Menyimpan bobot...",this.requestUpdate();try{const e=await this._apiGet({action:"saveBobot",...t});e&&e.status==="ok"?this._note="\u2705 Bobot tersimpan. Generate rapor untuk melihat hasil.":this._note="\u26A0\uFE0F Gagal: "+(e&&e.message?e.message:"cek konsol.")}catch(e){this._note="\u26A0\uFE0F Error: "+e.message}this.requestUpdate()}async _muatBobot(){if(!this.appsScriptUrl){this._note="\u26A0\uFE0F URL Apps Script belum diatur (tab Atur).",this.requestUpdate();return}this._note="\u23F3 Memuat bobot...",this.requestUpdate();try{const t=await this._apiGet({action:"getBobot"});t&&t.status==="ok"&&t.bobot?(this._bobotTugas=t.bobot.tugas??1,this._bobotLM=t.bobot.lm??3,this._bobotSTS=t.bobot.sts??2,this._bobotSAS=t.bobot.sas??2,this._note="\u2705 Bobot dimuat."):this._note="\u2139\uFE0F Belum ada bobot tersimpan, menggunakan default."}catch(t){this._note="\u26A0\uFE0F Error: "+t.message}this.requestUpdate()}_renderPantauanGuru(){const t=this._serverData.roster||[];if(t.length===0)return o`
      ...
      <div class="grid-heatmap">
        ${t.map(r=>{const d=this._num(r.nilaiAkhir),l=d>=75?"lvl-high":d>=60?"lvl-mid":"lvl-low",p=d>=75?{cls:"badge-good",txt:`${r.emoji||"\u2705"} LULUS`}:d>=60?{cls:"badge-warn",txt:`${r.emoji||"\u26A0\uFE0F"} PROSES`}:{cls:"badge-bad",txt:`${r.emoji||"\u{1F4ED}"} REMEDI`},u=(r.nama||"?").trim().charAt(0).toUpperCase(),m=["#4f46e5","#0891b2","#059669","#d97706","#db2777","#7c3aed"][(r.absen||"0").toString().length%6];return o`
    ...
    `}_materiCol(){const t=String(this.kdMateri||"").trim(),e=t.match(/^LM\s*0?(\d+)$/i);if(e)return`LM${e[1]}`;const a=t.match(/^Pertemuan\s*0?(\d+)$/i);return a?`LM${a[1]}`:/^STS$/i.test(t)?"STS":/^SAS$/i.test(t)?"SAS":""}_renderLeaderboard(){let t=this._serverData.leaderboard||[];if(t.length===0)return o`
      ...
      `;const e=this._canonKelas(this._peringkatKelas||this.kelas||"");e&&(t=t.filter(u=>this._canonKelas(this._rowValue(u,"Kelas"))===e));const a=this._materiCol(),i=new Map((this._serverData.roster||[]).map(u=>[String(u.studentId),u])),s=t.map((u,m)=>{const A=a?this._num(this._rowValue(u,a)):null,C=A!=null&&A>0?A:this._num(this._rowValue(u,"Nilai_Rapor")||this._rowValue(u,"Rata-rata Skor")),k=String(this._rowValue(u,"StudentID")||this._rowValue(u,"Student ID")||""),T=i.get(k)||(this._serverData.roster||[]).find(R=>String(R.nis)===String(this._rowValue(u,"NIS")))||null,x=String(this._rowValue(u,"Absen")||T?.absen||"").trim();return{...u,_rank:m+1,_nilai:C,_lmNilai:A,_nama:String(this._rowValue(u,"Nama")||T?.nama||"-"),_absen:x,_kelas:String(this._rowValue(u,"Kelas")||T?.kelas||""),_totalKuis:this._num(this._rowValue(u,"Total Kuis")||T?.totalKuis||0),_totalAktivitas:this._num(this._rowValue(u,"Total Aktivitas")||T?.totalActivities||0),_reading:this._num(this._rowValue(u,"Reading")),_quizAct:this._num(this._rowValue(u,"Quiz Activity")),_forum:this._num(this._rowValue(u,"Discussion")),_status:String(this._rowValue(u,"Status Kuis Terakhir")||T?.grade||"N/A"),_pertemuan:this._num(this._rowValue(u,"Jumlah Pertemuan"))}}).map((u,m)=>({...u,_rank:m+1})),r=this._leaderSortKey&&this._leaderSortKey!=="nilai"?this._getSortedLeaderboardRows(s):[...s].sort((u,m)=>(m._nilai||0)-(u._nilai||0)).map((u,m)=>({...u,_rank:m+1})),d=r[0]||{_nama:"-",_nilai:0},l=r[1]||{_nama:"-",_nilai:0},p=r[2]||{_nama:"-",_nilai:0};return o`
...
`)}_eksporNilai(t){const e=this._filterPeringkat(this._buildPeringkat());if(!e.length){this._note="Belum ada baris untuk diekspor.",this.requestUpdate();return}const a="peringkat-bimbingan-"+String(this._peringkatKelas||this.kelas||"semua").replace(/[^a-zA-Z0-9-_]/g,"");if(t==="copas"){this._copasTSV=this._csvKerangka(e,"	"),this._note="Kotak TSV siap disalin \u2014 paste langsung ke Google Sheets / Excel.",this.requestUpdate();return}if(t==="csv"){const i="\uFEFF"+this._csvKerangka(e,",");this._downloadBlob(`${a}.csv`,i,"text/csv;charset=utf-8;")}else{const{headers:i,grid:s}=this._rowPeringkatKeCSV(e),r=i.map(p=>`<th>${this._hs(p)}</th>`).join(""),d=s.map(p=>`<tr>${p.map(u=>`<td>${this._hs(u)}</td>`).join("")}</tr>`).join(""),l=`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel"><head><meta charset="utf-8"><!--[if gte mso 9]><xml><x:ExcelWorkbook><x:ExcelWorksheets><x:ExcelWorksheet><x:Name>Peringkat</x:Name><x:WorksheetOptions><x:DisplayGridlines/></x:WorksheetOptions></x:ExcelWorksheet></x:ExcelWorksheets></x:ExcelWorkbook></xml><![endif]--></head><body><table><thead><tr>${r}</tr></thead><tbody>${d}</tbody></table></body></html>`;this._downloadBlob(`${a}.xls`,l,"application/vnd.ms-excel;charset=utf-8;")}this._note=`\u2705 Ekspor ${t.toUpperCase()} selesai (${e.length} siswa).`,this.requestUpdate()}_downloadBlob(t,e,a){const i=new Blob([e],{type:a}),s=URL.createObjectURL(i),r=document.createElement("a");r.href=s,r.download=t,document.body.appendChild(r),r.click(),document.body.removeChild(r),setTimeout(()=>URL.revokeObjectURL(s),1500)}_hs(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}_renderHasilSiswa(){const t=this._serverData.siswa;if(!t)return o`
      ...
      `;const e=this._num(t.kehadiran),a=this._num(t.ulanganHarian&&(t.ulanganHarian.average||t.ulanganHarian.highest)||0),i=this._num(t.uts&&t.uts.highest||0),s=this._num(t.uas&&t.uas.highest||0),r=this._num(t.sikap),d=this._num(t.keterampilan),l=Math.round(parseFloat(t.nilaiAkhir)||0),p=String(t.grade||"-"),u=Math.max(0,Math.min(100,l))*3.6,m=Array.isArray(t.lm)?t.lm:Array.isArray(t.LM)?t.LM:[],A=m.length>0&&m.some(k=>this._num(k)>0),C=[{label:"Kehadiran",value:e,unit:"%"},{label:"Rata-rata UH",value:a,unit:""},{label:"Skor UTS",value:i,unit:""},{label:"Skor UAS",value:s,unit:""},{label:"Sikap",value:r,unit:""},{label:"Keterampilan",value:d,unit:""}];return o`
      <h2 style="margin-top: 0; color: #1e293b;">🎯 Hasil & Nilai Evaluasi Anda</h2>
          ...
          ${A?o`
            <div class="card-siswa" style="padding: var(--ddd-spacing-4); margin-top: var(--ddd-spacing-4);">
              ...
              <div style="display:grid; grid-template-columns: repeat(auto-fill, minmax(86px,1fr)); gap: var(--ddd-spacing-2);">
                ${m.map((k,T)=>{const x=this._num(k),R=String(this.kdMateri||"").trim().toLowerCase()===`lm${T+1}`.toLowerCase()||String(this.kdMateri||"").trim()===`Pertemuan ${T+1}`;return o`
