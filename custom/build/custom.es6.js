...
`);try{u=new Worker(URL.createObjectURL(new Blob([_])))}catch(y){return typeof console<"u"&&typeof console.warn=="function"&&console.warn("\u{1F38A} Could not load worker",y),null}f(u)}return u}})(),C={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function k(u,n){return n?n(u):u}function T(u){return u!=null}function w(u,n,g){return k(u&&T(u[n])?u[n]:C[n],g)}function P(u){return u<0?0:Math.floor(u)}function _t(u,n){return Math.floor(Math.random()*(n-u))+u}function tt(u){return parseInt(u,16)}function lt(u){return u.map(ne)}function ne(u){var n=String(u).replace(/[^0-9a-f]/gi,"");return n.length<6&&(n=n[0]+n[0]+n[1]+n[1]+n[2]+n[2]),{r:tt(n.substring(0,2)),g:tt(n.substring(2,4)),b:tt(n.substring(4,6))}}function le(u){var n=w(u,"origin",Object);return n.x=w(n,"x",Number),n.y=w(n,"y",Number),n}function he(u){u.width=document.documentElement.clientWidth,u.height=document.documentElement.clientHeight}function ue(u){var n=u.getBoundingClientRect();u.width=n.width,u.height=n.height}function ce(u){var n=document.createElement("canvas");return n.style.position="fixed",n.style.top="0px",n.style.left="0px",n.style.pointerEvents="none",n.style.zIndex=u,n}function pe(u,n,g,f,_,y,x,b,S){u.save(),u.translate(n,g),u.rotate(y),u.scale(f,_),u.arc(0,0,1,x,b,S),u.restore()}function me(u){var n=u.angle*(Math.PI/180),g=u.spread*(Math.PI/180);return{x:u.x,y:u.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:u.startVelocity*.5+Math.random()*u.startVelocity,angle2D:-n+(.5*g-Math.random()*g),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:u.color,shape:u.shape,tick:0,totalTicks:u.ticks,decay:u.decay,drift:u.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:u.gravity*3,ovalScalar:.6,scalar:u.scalar,flat:u.flat}}function ge(u,n){n.x+=Math.cos(n.angle2D)*n.velocity+n.drift,n.y+=Math.sin(n.angle2D)*n.velocity+n.gravity,n.velocity*=n.decay,n.flat?(n.wobble=0,n.wobbleX=n.x+10*n.scalar,n.wobbleY=n.y+10*n.scalar,n.tiltSin=0,n.tiltCos=0,n.random=1):(n.wobble+=n.wobbleSpeed,n.wobbleX=n.x+10*n.scalar*Math.cos(n.wobble),n.wobbleY=n.y+10*n.scalar*Math.sin(n.wobble),n.tiltAngle+=.1,n.tiltSin=Math.sin(n.tiltAngle),n.tiltCos=Math.cos(n.tiltAngle),n.random=Math.random()+2);var g=n.tick++/n.totalTicks,f=n.x+n.random*n.tiltCos,_=n.y+n.random*n.tiltSin,y=n.wobbleX+n.random*n.tiltCos,x=n.wobbleY+n.random*n.tiltSin;if(u.fillStyle="rgba("+n.color.r+", "+n.color.g+", "+n.color.b+", "+(1-g)+")",u.beginPath(),s&&n.shape.type==="path"&&typeof n.shape.path=="string"&&Array.isArray(n.shape.matrix))u.fill(fe(n.shape.path,n.shape.matrix,n.x,n.y,Math.abs(y-f)*.1,Math.abs(x-_)*.1,Math.PI/10*n.wobble));else if(n.shape.type==="bitmap"){var b=Math.PI/10*n.wobble,S=Math.abs(y-f)*.1,M=Math.abs(x-_)*.1,E=n.shape.bitmap.width*n.scalar,I=n.shape.bitmap.height*n.scalar,q=new DOMMatrix([Math.cos(b)*S,Math.sin(b)*S,-Math.sin(b)*M,Math.cos(b)*M,n.x,n.y]);q.multiplySelf(new DOMMatrix(n.shape.matrix));var L=u.createPattern(h.transform(n.shape.bitmap),"no-repeat");L.setTransform(q),u.globalAlpha=1-g,u.fillStyle=L,u.fillRect(n.x-E/2,n.y-I/2,E,I),u.globalAlpha=1}else if(n.shape==="circle")u.ellipse?u.ellipse(n.x,n.y,Math.abs(y-f)*n.ovalScalar,Math.abs(x-_)*n.ovalScalar,Math.PI/10*n.wobble,0,2*Math.PI):pe(u,n.x,n.y,Math.abs(y-f)*n.ovalScalar,Math.abs(x-_)*n.ovalScalar,Math.PI/10*n.wobble,0,2*Math.PI);else if(n.shape==="star")for(var $=Math.PI/2*3,U=4*n.scalar,N=8*n.scalar,D=n.x,B=n.y,H=5,R=Math.PI/H;H--;)D=n.x+Math.cos($)*N,B=n.y+Math.sin($)*N,u.lineTo(D,B),$+=R,D=n.x+Math.cos($)*U,B=n.y+Math.sin($)*U,u.lineTo(D,B),$+=R;else u.moveTo(Math.floor(n.x),Math.floor(n.y)),u.lineTo(Math.floor(n.wobbleX),Math.floor(_)),u.lineTo(Math.floor(y),Math.floor(x)),u.lineTo(Math.floor(f),Math.floor(n.wobbleY));return u.closePath(),u.fill(),n.tick<n.totalTicks}function be(u,n,g,f,_){var y=n.slice(),x=u.getContext("2d"),b,S,M=c(function(E){function I(){b=S=null,x.clearRect(0,0,f.width,f.height),h.clear(),_(),E()}function q(){a&&!(f.width===i.width&&f.height===i.height)&&(f.width=u.width=i.width,f.height=u.height=i.height),!f.width&&!f.height&&(g(u),f.width=u.width,f.height=u.height),x.clearRect(0,0,f.width,f.height),y=y.filter(function(L){return ge(x,L)}),y.length?b=m.frame(q):I()}b=m.frame(q),S=I});return{addFettis:function(E){return y=y.concat(E),M},canvas:u,promise:M,reset:function(){b&&m.cancel(b),S&&S()}}}function Kt(u,n){var g=!u,f=!!w(n||{},"resize"),_=!1,y=w(n,"disableForReducedMotion",Boolean),x=r&&!!w(n||{},"useWorker"),b=x?A():null,S=g?he:ue,M=u&&b?!!u.__confetti_initialized:!1,E=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,I;function q($,U,N){for(var D=w($,"particleCount",P),B=w($,"angle",Number),H=w($,"spread",Number),R=w($,"startVelocity",Number),_e=w($,"decay",Number),ye=w($,"gravity",Number),we=w($,"drift",Number),Ft=w($,"colors",lt),xe=w($,"ticks",Number),Nt=w($,"shapes"),Se=w($,"scalar"),$e=!!w($,"flat"),Dt=le($),Rt=D,At=[],Ae=u.width*Dt.x,Me=u.height*Dt.y;Rt--;)At.push(me({x:Ae,y:Me,angle:B,spread:H,startVelocity:R,color:Ft[Rt%Ft.length],shape:Nt[_t(0,Nt.length)],ticks:xe,decay:_e,gravity:ye,drift:we,scalar:Se,flat:$e}));return I?I.addFettis(At):(I=be(u,At,S,U,N),I.promise)}function L($){var U=y||w($,"disableForReducedMotion",Boolean),N=w($,"zIndex",Number);if(U&&E)return c(function(R){R()});g&&I?u=I.canvas:g&&!u&&(u=ce(N),document.body.appendChild(u)),f&&!M&&S(u);var D={width:u.width,height:u.height};b&&!M&&b.init(u),M=!0,b&&(u.__confetti_initialized=!0);function B(){if(b){var R={getBoundingClientRect:function(){if(!g)return u.getBoundingClientRect()}};S(R),b.postMessage({resize:{width:R.width,height:R.height}});return}D.width=D.height=null}function H(){I=null,f&&(_=!1,t.removeEventListener("resize",B)),g&&u&&(document.body.contains(u)&&document.body.removeChild(u),u=null,M=!1)}return f&&!_&&(_=!0,t.addEventListener("resize",B,!1)),b?b.fire($,D,H):q($,D,H)}return L.reset=function(){b&&b.reset(),I&&I.reset()},L}var $t;function Ut(){return $t||($t=Kt(null,{useWorker:!0,resize:!0})),$t}function fe(u,n,g,f,_,y,x){var b=new Path2D(u),S=new Path2D;S.addPath(b,new DOMMatrix(n));var M=new Path2D;return M.addPath(S,new DOMMatrix([Math.cos(x)*_,Math.sin(x)*_,-Math.sin(x)*y,Math.cos(x)*y,g,f])),M}function ve(u){if(!s)throw new Error("path confetti are not supported in this browser");var n,g;typeof u=="string"?n=u:(n=u.path,g=u.matrix);var f=new Path2D(n),_=document.createElement("canvas"),y=_.getContext("2d");if(!g){for(var x=1e3,b=x,S=x,M=0,E=0,I,q,L=0;L<x;L+=2)for(var $=0;$<x;$+=2)y.isPointInPath(f,L,$,"nonzero")&&(b=Math.min(b,L),S=Math.min(S,$),M=Math.max(M,L),E=Math.max(E,$));I=M-b,q=E-S;var U=10,N=Math.min(U/I,U/q);g=[N,0,0,N,-Math.round(I/2+b)*N,-Math.round(q/2+S)*N]}return{type:"path",path:n,matrix:g}}function ke(u){var n,g=1,f="#000000",_='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof u=="string"?n=u:(n=u.text,g="scalar"in u?u.scalar:g,_="fontFamily"in u?u.fontFamily:_,f="color"in u?u.color:f);var y=10*g,x=""+y+"px "+_,b=new OffscreenCanvas(y,y),S=b.getContext("2d");S.font=x;var M=S.measureText(n),E=Math.ceil(M.actualBoundingBoxRight+M.actualBoundingBoxLeft),I=Math.ceil(M.actualBoundingBoxAscent+M.actualBoundingBoxDescent),q=2,L=M.actualBoundingBoxLeft+q,$=M.actualBoundingBoxAscent+q;E+=q+q,I+=q+q,b=new OffscreenCanvas(E,I),S=b.getContext("2d"),S.font=x,S.fillStyle=f,S.fillText(n,L,$);var U=1/g;return{type:"bitmap",bitmap:b.transferToImageBitmap(),matrix:[U,0,0,U,-E*U/2,-I*U/2]}}e.exports=function(){return Ut().apply(this,arguments)},e.exports.reset=function(){Ut().reset()},e.exports.create=Kt,e.exports.shapeFromPath=ve,e.exports.shapeFromText=ke})((function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}})(),qt,!1);var ft=qt.exports;qt.exports.create;class zt extends O(j(F)){static get tag(){return"timer-kuis"}static get properties(){return{...super.properties,duration:{type:Number,attribute:"duration",reflect:!0},remaining:{type:Number,attribute:"remaining",reflect:!0},autostart:{type:Boolean,attribute:"autostart",reflect:!0},kdMateri:{type:String,attribute:"kd-materi"},studentId:{type:String,attribute:"student-id"},_remaining:{state:!0},_running:{state:!0},hideControls:{type:Boolean,attribute:"hide-controls",reflect:!0}}}constructor(){super(),this.duration=300,this.autostart=!1,this.hideControls=!1,this._remaining=this.duration,this._running=!1,this._intervalId=null,this.t={...this.t,title:"Waktu Kuis",start:"Mulai",pause:"Jeda",reset:"Ulang",done:"Waktu habis"}}connectedCallback(){super.connectedCallback(),this.remaining!=null&&!isNaN(this.remaining)&&this.remaining>0?this._remaining=this.remaining:this._remaining=this.duration,this._onVisChange=this._onVisChange.bind(this),globalThis.addEventListener("visibilitychange",this._onVisChange),this.autostart&&this._remaining>0&&this.start()}disconnectedCallback(){globalThis.removeEventListener("visibilitychange",this._onVisChange),this._clearInterval(),super.disconnectedCallback()}_onVisChange(){document.hidden?this._running&&this.pause():(this._remaining>0&&!this._running&&this.autostart&&this.start(),this._remaining<=0&&!this._running&&(this._remaining=0,this._running=!1,this._clearInterval(),this._clearStartTime(),this._onExpire()))}_startKey(){return`timer_kuis_start_${this.kdMateri||"default"}_${this.studentId||"default"}`}_saveStartTime(t){try{globalThis.localStorage.setItem(this._startKey(),String(t))}catch{}}_loadStartTime(){try{const t=parseInt(globalThis.localStorage.getItem(this._startKey())||"0",10);return isNaN(t)?0:t}catch{return 0}}_clearStartTime(){try{globalThis.localStorage.removeItem(this._startKey())}catch{}}updated(t){t.has("remaining")&&this.remaining!=null&&!isNaN(this.remaining)&&(this._remaining=this.remaining,this._running&&(this._clearInterval(),this._running=!1,this.start())),t.has("duration")&&!this._running&&this.remaining==null&&(this._remaining=this.duration)}start(){this._running||(this._remaining<=0&&(this._remaining=this.duration),this._running=!0,this._clearInterval(),this._saveStartTime(Date.now()-(this.duration-this._remaining)*1e3),this._intervalId=setInterval(()=>this._tick(),1e3))}pause(){this._running=!1,this._clearInterval();const t=this._loadStartTime();if(t>0){const e=Math.floor((Date.now()-t)/1e3);this._remaining=Math.max(0,this.duration-e),this._saveStartTime(Date.now()-(this.duration-this._remaining)*1e3)}}reset(){this._clearInterval(),this._running=!1,this._remaining=this.duration,this._clearStartTime()}_clearInterval(){this._intervalId&&(clearInterval(this._intervalId),this._intervalId=null)}_tick(){const t=this._loadStartTime();if(t>0){const e=Math.floor((Date.now()-t)/1e3);this._remaining=Math.max(0,this.duration-e)}else this._remaining>0&&(this._remaining-=1);this._remaining<=0&&(this._remaining=0,this._running=!1,this._clearInterval(),this._clearStartTime(),this._onExpire())}_onExpire(){this.dispatchEvent(new CustomEvent("timer-kuis-expired",{detail:{duration:this.duration},bubbles:!0,composed:!0}))}_format(t){const e=Math.floor(t/60),a=t%60;return`${String(e).padStart(2,"0")}:${String(a).padStart(2,"0")}`}static get styles(){return[super.styles,z`
    ...
    `}static get haxProperties(){return{api:"1",canScale:!0,canPosition:!0,canEditSource:!1,type:"element",designSystem:{accent:!0,primary:!0,card:!0,text:!0,designTreatment:!1},gizmo:{title:"Timer Kuis",description:"Timer hitung mundur untuk kuis dengan auto-submit via event timer-kuis-expired",icon:"icons:timer",color:"purple",tags:["Education","Timer","Quiz"]},settings:{configure:[{property:"duration",title:"Durasi (detik)",inputMethod:"number",description:"Lama waktu pengerjaan kuis dalam detik",default:300},{property:"autostart",title:"Mulai Otomatis",inputMethod:"boolean",default:!1}]},saveOptions:{unsetAttributes:[]},demoSchema:[{tag:"timer-kuis",properties:{duration:300,autostart:!1},content:""},{tag:"timer-kuis",properties:{duration:60,autostart:!0},content:""}]}}}customElements.get(zt.tag)||globalThis.customElements.define(zt.tag,zt);class Xe{constructor(t){this._host=t,this._questionStartTime=null}getAnswerTime(){return this._host._questionStartTime?Date.now()-this._host._questionStartTime:0}resetQuestionTimer(){this._questionStartTime=Date.now()}isSuspiciousTiming(t,e=3e3){return t>0&&t<e}getTimingData(){return{questionStartTime:this._questionStartTime,currentTime:Date.now()}}calculateScore(t,e=1){return t?e:0}}class se{static renderMC(t,e){const{selected:a,selectedAnswers:i,answered:r,editable:s,feedbackText:d,feedbackPositive:l,hideAnswers:c}=e,h=e.isMulti,m=t.choices||[],A=t._correctMap?(e.correctAnswers||[]).map(C=>t._correctMap.indexOf(C)):e.correctAnswers||[];return o`
      ...
      ${h&&(!r||s)?o`<button class="btn-submit" @click=${e.onSubmit}>Kirim Jawaban (${i.size} dipilih)</button>`:""}
    `}static renderPGKompleks(t,e){const{selectedAnswers:a,answered:i,editable:r,feedbackText:s,feedbackPositive:d,hideAnswers:l}=e,c=a||new Set,h=i&&!r;return o`
      <div class="choices-container">
        ${t.choices.map((m,A)=>{const C=c.has(A),k=(t.correctAnswers||[]).includes(A);let T="choice-row multi-correct";return i&&!l?(k&&(T+=" correct"),C&&!k&&(T+=" wrong")):C&&(T+=" selected"),o`
            <button
              class="${T} ${h?"disabled":""}"
              ?disabled=${h}
              @click=${()=>e.onToggle(A)}
              aria-label="Pilihan ${huruf[A]||A+1}: ${m} ${C?"(dipilih)":""}"
            >${!l&&C&&i&&k?"\u2713 ":""}${huruf[A]||A+1}. ${m}
            </button>
          `})}
      </div>
    ...
    `}static renderPGK(t,e){const{pgkAnswers:a,answered:i,editable:r,feedbackText:s,feedbackPositive:d,hideAnswers:l}=e;return o`
      <div class="pgk-container">
        ${(t.statements||[]).map((c,h)=>{const m=a?a[h]:null;return o`
            <div class="pgk-statement">
              <div class="statement-text">${h+1}. ${c.text}</div>
    ...
    `}static renderMatching(t,e){const{matchAnswers:a,answered:i,editable:r,feedbackText:s,feedbackPositive:d,hideAnswers:l}=e;return o`
      <div class="matching-container">
        <div class="matching-left">
          ${(t.leftItems||[]).map((c,h)=>o`
            <div class="match-item left">${c}</div>
          `)}
        </div>
        <div class="matching-right">
          ${(t.rightItems||[]).map((c,h)=>{const m=a?a[h]:null;return o`
              <div class="match-item right ${m!==null?"matched":""}" 
                @click=${()=>e.onMatchRight(h)}>
...
${!i||r?o`<button class="btn-submit" @click=${e.onSubmit}>Kirim Jawaban</button>`:""}
    ...
    `}_renderReviewQuestion(t,e){const a=this._normalisasiSoal(e),i=this._siapkanSoal(a);if(!i)return o``;const r=this._userAnswers.get(t)||{},s=i.type||"mc",d=["A","B","C","D","E","F"],l=a._correctMap?i.correctAnswers.map(c=>a._correctMap.indexOf(c)):i.correctAnswers;return o`
      <div class="review-question">
        ...
        ${s==="mc"?o`<ul class="review-mc">${i.pilihan.map((c,h)=>{let m="";return this.hideAnswers||(l.includes(h)?m="review-correct":(!i.isMulti&&r.selected===h||i.isMulti&&r.selectedAnswers&&r.selectedAnswers.has(h))&&(m="review-selected-wrong")),o`<li class="${m}">${d[h]||h+1}. ${c}</li>`})}</ul>`:""}
    ...
    `}_renderQuestionScreen(){const t=this._getActiveQuestions(),e=this._normalisasiSoal(t[this._currentIdx]),a=this._siapkanSoal(e);if(!a)return o`<div class="quiz-card result-box">Soal tidak valid.</div>`;const i=a.type||"mc";return o`
      <div class="quiz-card">
        ...
        ${this.showQuestionNav&&t.length>1?o`<nav class="question-nav" aria-label="Navigasi nomor soal">
              ...
              <div class="nav-grid">
              ${t.map((r,s)=>{const d=s===this._currentIdx,l=this._answeredSet.has(s),c=!l&&!d,h=!this.allowBackwardNav&&l&&s<this._currentIdx;return o`<button
                  type="button"
                  class="${`q-dot ${d?"current":""} ${l?"answered":""} ${c?"unanswered":""} ${h?"disabled":""}`}"
                  ?disabled=${h}
    ...
    `}_renderKehadiran(){const t=this._weekly(),e=this._streak(),a=this._heatmap(),i=this._logs||[],r=this.thresholds,s=64,d=2*Math.PI*s,l=d-t.pct/100*d,c=["Sen","Sel","Rab","Kam","Jum","Sab","Min"];return o`
      ...
      <div class="g2">
        ...
        <div class="c">
          ...
          <div class="hmh">
            ${c.map(h=>o`<span>${h}</span>`)}
          </div>
          <div class="hmg">
            ${a.map(h=>{let m="";return h.count>0&&h.count<=2?m="l1":h.count>2&&h.count<=4?m="l2":h.count>4&&h.count<=7?m="l3":h.count>7&&(m="l4"),o`
                  <div class="hc ${m}" title="${h.date.toLocaleDateString("id-ID")}: ${h.count}">${h.count||""}</div>
                `})}
          </div>
          <div class="hml">
            <span>Sedikit</span>
          ...
          <div style="margin-top:var(--ddd-spacing-4); max-height:var(--ddd-layout-size-xl); overflow-y:auto;">
            ...
            ${i.length===0?o`<div class="ti" style="margin:0;">Belum ada aktivitas tercatat. Gunakan tombol simulasi di atas atau kerjakan kuis/materi.</div>`:i.slice(0,5).map(h=>o`
                    <div class="li ${h.type}">
                      <span class="lt">${new Date(h.timestamp).toLocaleString("id-ID")}</span>
                      <span class="ld">${h.description}</span>
                    </div>
                  `)}
          </div>
        </div>
  ...
  a      @media (prefers-color-scheme: dark) {
    ...
    `}async _bukaKunciKuisGuru(){const t=(this._unlockSid||this.studentId||"").trim(),e=(this._unlockMateri||this.kdMateri||"LM1").trim();if(!t){this._unlockMsg="\u26A0\uFE0F Isi Student ID dulu.",this.requestUpdate();return}if(!this.appsScriptUrl){this._unlockMsg="\u26A0\uFE0F URL Apps Script belum diatur.",this.requestUpdate();return}this._unlockMsg="\u23F3 Membuka...",this.requestUpdate();try{const a=new URLSearchParams({action:"resetQuizLock",studentId:t,kdMateri:e}),i=await(await fetch(`${this.appsScriptUrl}?${a.toString()}`,{method:"GET",mode:"cors"})).json();if(i&&i.status==="ok"){this._unlockMsg=`\u2705 Kunci ${e} dibuka \u2014 ${i.deleted||0} sesi dihapus. Siswa bisa ulang/remidi.`;try{localStorage.removeItem(`latihan_kuis_attempt_${t}_${e}`),localStorage.removeItem(`latihan_kuis_time_${t}_${e}`)}catch{}}else this._unlockMsg="\u26A0\uFE0F Gagal: "+(i.message||"unknown")}catch(a){this._unlockMsg="\u26A0\uFE0F Error: "+a.message}this.requestUpdate()}async _generateRapor(){if(!this.appsScriptUrl){this._note="\u26A0\uFE0F URL Apps Script belum diatur (tab Atur).",this.requestUpdate();return}this._raporStatus="\u23F3 Membuat laporan...",this._note="",this.requestUpdate();try{const t=await this._apiGet({action:"generateReport"});t&&t.status==="ok"?(this._raporStatus=`\u2705 Rapor berhasil dibuat. ${t.students||0} siswa diproses.`,this._note="\u2705 Rapor berhasil di-generate. Lihat sheet Akumulasi_Nilai_Rapor."):(this._raporStatus="",this._note="\u26A0\uFE0F Gagal: "+(t&&t.message?t.message:"cek konsol."))}catch(t){this._raporStatus="",this._note="\u26A0\uFE0F Error: "+t.message}this.requestUpdate()}async _simpanBobot(){if(!this.appsScriptUrl){this._note="\u26A0\uFE0F URL Apps Script belum diatur (tab Atur).",this.requestUpdate();return}const t={tugas:this._bobotTugas??1,lm:this._bobotLM??3,sts:this._bobotSTS??2,sas:this._bobotSAS??2};this._note="\u23F3 Menyimpan bobot...",this.requestUpdate();try{const e=await this._apiGet({action:"saveBobot",...t});e&&e.status==="ok"?this._note="\u2705 Bobot tersimpan. Generate rapor untuk melihat hasil.":this._note="\u26A0\uFE0F Gagal: "+(e&&e.message?e.message:"cek konsol.")}catch(e){this._note="\u26A0\uFE0F Error: "+e.message}this.requestUpdate()}async _muatBobot(){if(!this.appsScriptUrl){this._note="\u26A0\uFE0F URL Apps Script belum diatur (tab Atur).",this.requestUpdate();return}this._note="\u23F3 Memuat bobot...",this.requestUpdate();try{const t=await this._apiGet({action:"getBobot"});t&&t.status==="ok"&&t.bobot?(this._bobotTugas=t.bobot.tugas??1,this._bobotLM=t.bobot.lm??3,this._bobotSTS=t.bobot.sts??2,this._bobotSAS=t.bobot.sas??2,this._note="\u2705 Bobot dimuat."):this._note="\u2139\uFE0F Belum ada bobot tersimpan, menggunakan default."}catch(t){this._note="\u26A0\uFE0F Error: "+t.message}this.requestUpdate()}_renderPantauanGuru(){const t=this._serverData.roster||[];if(t.length===0)return o`
      ...
      <div class="grid-heatmap">
        ${t.map(s=>{const d=this._num(s.nilaiAkhir),l=d>=75?"lvl-high":d>=60?"lvl-mid":"lvl-low",c=d>=75?{cls:"badge-good",txt:`${s.emoji||"\u2705"} LULUS`}:d>=60?{cls:"badge-warn",txt:`${s.emoji||"\u26A0\uFE0F"} PROSES`}:{cls:"badge-bad",txt:`${s.emoji||"\u{1F4ED}"} REMEDI`},h=(s.nama||"?").trim().charAt(0).toUpperCase(),m=["#4f46e5","#0891b2","#059669","#d97706","#db2777","#7c3aed"][(s.absen||"0").toString().length%6];return o`
            <div class="card-siswa ${l}">
              <div class="student-head">
                <div class="avatar-circle" style="background:${m};">${h}</div>
                <div>
    ...
    `}_materiCol(){const t=String(this.kdMateri||"").trim(),e=t.match(/^LM\s*0?(\d+)$/i);if(e)return`LM${e[1]}`;const a=t.match(/^Pertemuan\s*0?(\d+)$/i);return a?`LM${a[1]}`:/^STS$/i.test(t)?"STS":/^SAS$/i.test(t)?"SAS":""}_renderLeaderboard(){let t=this._serverData.leaderboard||[];if(t.length===0)return o`
      ...
      `;const e=this._canonKelas(this._peringkatKelas||this.kelas||"");e&&(t=t.filter(h=>this._canonKelas(this._rowValue(h,"Kelas"))===e));const a=this._materiCol(),i=new Map((this._serverData.roster||[]).map(h=>[String(h.studentId),h])),r=t.map((h,m)=>{const A=a?this._num(this._rowValue(h,a)):null,C=A!=null&&A>0?A:this._num(this._rowValue(h,"Nilai_Rapor")||this._rowValue(h,"Rata-rata Skor")),k=String(this._rowValue(h,"StudentID")||this._rowValue(h,"Student ID")||""),T=i.get(k)||(this._serverData.roster||[]).find(P=>String(P.nis)===String(this._rowValue(h,"NIS")))||null,w=String(this._rowValue(h,"Absen")||T?.absen||"").trim();return{...h,_rank:m+1,_nilai:C,_lmNilai:A,_nama:String(this._rowValue(h,"Nama")||T?.nama||"-"),_absen:w,_kelas:String(this._rowValue(h,"Kelas")||T?.kelas||""),_totalKuis:this._num(this._rowValue(h,"Total Kuis")||T?.totalKuis||0),_totalAktivitas:this._num(this._rowValue(h,"Total Aktivitas")||T?.totalActivities||0),_reading:this._num(this._rowValue(h,"Reading")),_quizAct:this._num(this._rowValue(h,"Quiz Activity")),_forum:this._num(this._rowValue(h,"Discussion")),_status:String(this._rowValue(h,"Status Kuis Terakhir")||T?.grade||"N/A"),_pertemuan:this._num(this._rowValue(h,"Jumlah Pertemuan"))}}).map((h,m)=>({...h,_rank:m+1})),s=this._leaderSortKey&&this._leaderSortKey!=="nilai"?this._getSortedLeaderboardRows(r):[...r].sort((h,m)=>(m._nilai||0)-(h._nilai||0)).map((h,m)=>({...h,_rank:m+1})),d=s[0]||{_nama:"-",_nilai:0},l=s[1]||{_nama:"-",_nilai:0},c=s[2]||{_nama:"-",_nilai:0};return o`
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${s.map(h=>o`
                <tr class="${h._rank<=3?"highlight-row":""}">
                  <td><span class="rank-chip ${h._rank===1?"top":""}">${h._rank}</span></td>
                  <td><strong>${h._nama}</strong></td>
                  <td>${h._kelas}</td>
                  <td style="text-align:center; font-weight:700;">${h._absen||"-"}</td>
                  <td>${h._totalKuis}</td>
                  <td><strong>${h._nilai}%</strong></td>
                  <td>${h._totalAktivitas}</td>
                  <td>${h._reading}</td>
                  <td>${h._quizAct}</td>
                  <td>${h._forum}</td>
                  <td>${h._pertemuan}</td>
                  <td>
                    <span class="badge-status ${h._status==="LULUS"?"badge-good":h._status==="TIDAK LULUS"?"badge-bad":"badge-warn"}">${h._status}</span>
                  </td>
                </tr>
              `)}
          </tbody>
...
`)}_eksporNilai(t){const e=this._filterPeringkat(this._buildPeringkat());if(!e.length){this._note="Belum ada baris untuk diekspor.",this.requestUpdate();return}const a="peringkat-bimbingan-"+String(this._peringkatKelas||this.kelas||"semua").replace(/[^a-zA-Z0-9-_]/g,"");if(t==="copas"){this._copasTSV=this._csvKerangka(e,"	"),this._note="Kotak TSV siap disalin \u2014 paste langsung ke Google Sheets / Excel.",this.requestUpdate();return}if(t==="csv"){const i="\uFEFF"+this._csvKerangka(e,",");this._downloadBlob(`${a}.csv`,i,"text/csv;charset=utf-8;")}else{const{headers:i,grid:r}=this._rowPeringkatKeCSV(e),s=i.map(c=>`<th>${this._hs(c)}</th>`).join(""),d=r.map(c=>`<tr>${c.map(h=>`<td>${this._hs(h)}</td>`).join("")}</tr>`).join(""),l=`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel"><head><meta charset="utf-8"><!--[if gte mso 9]><xml><x:ExcelWorkbook><x:ExcelWorksheets><x:ExcelWorksheet><x:Name>Peringkat</x:Name><x:WorksheetOptions><x:DisplayGridlines/></x:WorksheetOptions></x:ExcelWorksheet></x:ExcelWorksheets></x:ExcelWorkbook></xml><![endif]--></head><body><table><thead><tr>${s}</tr></thead><tbody>${d}</tbody></table></body></html>`;this._downloadBlob(`${a}.xls`,l,"application/vnd.ms-excel;charset=utf-8;")}this._note=`\u2705 Ekspor ${t.toUpperCase()} selesai (${e.length} siswa).`,this.requestUpdate()}_downloadBlob(t,e,a){const i=new Blob([e],{type:a}),r=URL.createObjectURL(i),s=document.createElement("a");s.href=r,s.download=t,document.body.appendChild(s),s.click(),document.body.removeChild(s),setTimeout(()=>URL.revokeObjectURL(r),1500)}_hs(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}_renderHasilSiswa(){const t=this._serverData.siswa;if(!t)return o`
      ...
      `;const e=this._num(t.kehadiran),a=this._num(t.ulanganHarian&&(t.ulanganHarian.average||t.ulanganHarian.highest)||0),i=this._num(t.uts&&t.uts.highest||0),r=this._num(t.uas&&t.uas.highest||0),s=this._num(t.sikap),d=this._num(t.keterampilan),l=Math.round(parseFloat(t.nilaiAkhir)||0),c=String(t.grade||"-"),h=Math.max(0,Math.min(100,l))*3.6,m=Array.isArray(t.lm)?t.lm:Array.isArray(t.LM)?t.LM:[],A=m.length>0&&m.some(k=>this._num(k)>0),C=[{label:"Kehadiran",value:e,unit:"%"},{label:"Rata-rata UH",value:a,unit:""},{label:"Skor UTS",value:i,unit:""},{label:"Skor UAS",value:r,unit:""},{label:"Sikap",value:s,unit:""},{label:"Keterampilan",value:d,unit:""}];return o`
      <h2 style="margin-top: 0; color: #1e293b;">🎯 Hasil & Nilai Evaluasi Anda</h2>

      <div class="hasil-hero">
        <div class="grade-ring-card">
          <div class="grade-ring" style="background: conic-gradient(#fbbf24 ${h}deg, rgb(255 255 255 / 0.15) ${h}deg);">
          ...
          ${A?o`
            <div class="card-siswa" style="padding: var(--ddd-spacing-4); margin-top: var(--ddd-spacing-4);">
              ...
              <div style="display:grid; grid-template-columns: repeat(auto-fill, minmax(86px,1fr)); gap: var(--ddd-spacing-2);">
                ${m.map((k,T)=>{const w=this._num(k),P=String(this.kdMateri||"").trim().toLowerCase()===`lm${T+1}`.toLowerCase()||String(this.kdMateri||"").trim()===`Pertemuan ${T+1}`;return o`
                    <button @click=${()=>{this.kdMateri=`LM${T+1}`,this.requestUpdate()}}
                      style="border:1px solid ${P?"#4F46E5":"#E2E8F0"}; background:${w>=75?"#ECFDF5":w>=60?"#FFFBEB":w>0?"#FEF2F2":"#F8FAFC"}; border-radius:12px; padding:10px 6px; text-align:center; cursor:pointer;">
                      <div style="font-size:11px; font-weight:700; color:#475569;">LM${T+1}</div>
                      <div style="font-size:18px; font-weight:800; color:${w>=75?"#065F46":w>=60?"#92400E":w>0?"#991B1B":"#94A3B8"};">${w||"-"}</div>
                      <div style="font-size:10px; color:#94a3b8;">${w>=75?"Mencapai TP":w>=60?"Pengayaan":w>0?"Remedial":"Belum ada"}</div>
                    </button>
                  `})}
              </div>
