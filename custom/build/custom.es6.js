    ...
    `}static get haxProperties(){return{canScale:!1,canPosition:!0,canEditSource:!1,gizmo:{title:"Quiz User Auth",description:"Sistem login/registrasi siswa untuk dasbor-kuis",icon:"icons:account-circle",color:"purple",tags:["Education","Auth"]},settings:{configure:[{property:"appsScriptUrl",title:"Apps Script URL",inputMethod:"textfield",required:!0}],advanced:[],developer:[]},saveOptions:{unsetAttributes:["_screen","_nama","_email","_nis","_absen","_kelas","_studentId","_errorMsg","_successMsg","_loading"]}}}}globalThis.customElements.define(tt.tag,tt);class et extends D(F(q)){static get tag(){return"latihan-kuis"}static get properties(){return{...super.properties,appsScriptUrl:{type:String,attribute:"apps-script-url",reflect:!0},spreadsheetUrl:{type:String,attribute:"spreadsheet-url",reflect:!0},duration:{type:Number,attribute:"duration",reflect:!0},judulMateri:{type:String,attribute:"judul-materi",reflect:!0},teksMateri:{type:String,attribute:"teks-materi",reflect:!0},materiUrl:{type:String,attribute:"materi-url",reflect:!0},materiFile:{type:String,attribute:"materi-file",reflect:!0},coverImage:{type:String,attribute:"cover-image",reflect:!0},judulKuis:{type:String,attribute:"judul-kuis",reflect:!0},questions:{type:Array,attribute:"questions",reflect:!0},studentId:{type:String,attribute:"student-id",reflect:!0},studentName:{type:String,attribute:"student-name",reflect:!0},studentNis:{type:String,attribute:"student-nis",reflect:!0},studentAbsen:{type:String,attribute:"student-absen",reflect:!0},studentKelas:{type:String,attribute:"student-kelas",reflect:!0},kdMateri:{type:String,attribute:"kd-materi",reflect:!0},pesanWaktuHabis:{type:String,attribute:"pesan-waktu-habis",reflect:!0},pesanNilaiTerkirim:{type:String,attribute:"pesan-nilai-terkirim",reflect:!0},labelMulai:{type:String,attribute:"label-mulai",reflect:!0},showSheetLink:{type:Boolean,attribute:"show-sheet-link",reflect:!0},soalFileUrl:{type:String,attribute:"soal-file-url",reflect:!0},_mulai:{state:!0},_selesai:{state:!0},_skor:{state:!0},_habisWaktu:{state:!0},_pesan:{state:!0}}}constructor(){super(),this.appsScriptUrl="",this.spreadsheetUrl="",this.duration=300,this.judulMateri="Materi Pembelajaran",this.teksMateri="Baca materi di bawah ini dengan saksama sebelum mengerjakan kuis. Waktu pengerjaan kuis dibatasi oleh timer; saat waktu habis, kuis akan dikunci dan nilai otomatis terkirim.",this.materiUrl="",this.materiFile="",this.coverImage="",this.judulKuis="Evaluasi Kuis Interaktif",this.questions=void 0,this.studentId="",this.studentName="",this.studentNis="",this.studentAbsen="",this.studentKelas="",this.kdMateri="",this.pesanWaktuHabis="\u23F0 Waktu habis! Kuis dikunci & dinilai otomatis.",this.pesanNilaiTerkirim="\u{1F389} Selamat! Nilai Anda sudah terkirim ke spreadsheet.",this.labelMulai="\u25B6\uFE0F Mulai Latihan",this.showSheetLink=!1,this.soalFileUrl="",this._mulai=!1,this._selesai=!1,this._skor=null,this._habisWaktu=!1,this._pesan="",this._onAuthLogin=this._onAuthLogin.bind(this),this._onAuthLogout=this._onAuthLogout.bind(this),this.t={...this.t,bacaMateri:"\u{1F517} Buka URL Materi",unduhMateri:"\u{1F4CE} Unduh File Materi"}}connectedCallback(){if(super.connectedCallback(),globalThis.HaxStore&&typeof globalThis.HaxStore.requestAvailability=="function"){const t=globalThis.HaxStore.requestAvailability();t&&!t.elementList[et.tag]&&(t.elementList[et.tag]=et.haxProperties)}globalThis.addEventListener("quiz-user-login",this._onAuthLogin),globalThis.addEventListener("quiz-user-logout",this._onAuthLogout)}disconnectedCallback(){globalThis.removeEventListener("quiz-user-login",this._onAuthLogin),globalThis.removeEventListener("quiz-user-logout",this._onAuthLogout),super.disconnectedCallback()}_onAuthLogin(t){const e=t&&t.detail||{};this.studentId=e.studentId||"",this.studentName=e.nama||"",this.studentNis=e.nis||"",this.studentAbsen=e.absen||"",this.studentKelas=e.kelas||""}_onAuthLogout(){this.studentId="",this.studentName="",this.studentNis="",this.studentAbsen="",this.studentKelas=""}updated(t){super.updated(t),t.has("soalFileUrl")&&this.soalFileUrl&&this._muatSoalDariFile(this.soalFileUrl)}async _muatSoalDariFile(t){try{const e=await fetch(t);if(!e.ok)throw new Error("HTTP "+e.status);const i=await e.json();if(!Array.isArray(i))throw new Error("Bukan array JSON");this.questions=i,this._pesan=""}catch(e){this._pesan="Gagal memuat file soal: "+e.message}}_onWaktuHabis(){const t=this.shadowRoot&&this.shadowRoot.querySelector("kuis-ledakan");t&&t._screen!=="result"&&typeof t._selesaiKuis=="function"&&t._selesaiKuis(),this._selesai=!0,this._habisWaktu=!0}_onKuisLog(t){t.detail&&t.detail.payload&&typeof t.detail.payload.score=="number"&&(this._skor=t.detail.payload.score,this._selesai=!0)}async _mulaiLatihan(){if(!this.studentId){this.requestUpdate();return}this._mulai=!0,await this.updateComplete;const t=this.shadowRoot&&this.shadowRoot.querySelector("kuis-ledakan"),e=this.shadowRoot&&this.shadowRoot.querySelector("timer-kuis");t&&typeof t._onStartClick=="function"&&t._onStartClick(),e&&typeof e.start=="function"&&e.start()}static get styles(){return[super.styles,O`
      ...
      <div class="wrap">
        ...
        ${this._mulai?d`
            ...
            `:this.studentId?d`<button class="btn-mulai" @click="${this._mulaiLatihan}">${this.labelMulai}</button>`:d`
