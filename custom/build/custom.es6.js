var $e=(h,t)=>()=>{try{return t||h((t={exports:{}}).exports,t),t.exports}catch(e){throw t=0,e}};import{css as Ae,html as nt}from"@haxtheweb/haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{PolarisFlexTheme as Ie}from"@haxtheweb/polaris-theme/lib/polaris-flex-theme.js";import"@haxtheweb/haxcms-elements/lib/ui-components/blocks/site-children-block.js";import{DDDSuper as F}from"@haxtheweb/d-d-d/d-d-d.js";import{I18NMixin as D}from"@haxtheweb/i18n-manager/lib/I18NMixin.js";var Ze=$e((li,gt)=>{let Pt=class extends Ie{static get styles(){return[super.styles,Ae`
        :host {
          display: block;
        }
        aside {
      ...
      `]}renderHeaderSlot(){return nt``}renderSideBar(){return nt`
    <aside
          role="complementary"
    ...
    `}renderFooterContactInformation(){return nt``}renderFooterSecondarySlot(){return nt``}renderFooterPrimarySlot(){return nt``}static get tag(){return"custom-haxkuis-theme"}constructor(){super()}};customElements.define(Pt.tag,Pt);/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const bt=globalThis,wt=bt.ShadowRoot&&(bt.ShadyCSS===void 0||bt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,St=Symbol(),Kt=new WeakMap;let Lt=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==St)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(wt&&t===void 0){const i=e!==void 0&&e.length===1;i&&(t=Kt.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&Kt.set(e,t))}return t}toString(){return this.cssText}};const Me=h=>new Lt(typeof h=="string"?h:h+"",void 0,St),R=(h,...t)=>{const e=h.length===1?h[0]:t.reduce((i,a,s)=>i+(r=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+h[s+1],h[0]);return new Lt(e,h,St)},Te=(h,t)=>{if(wt)h.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const e of t){const i=document.createElement("style"),a=bt.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=e.cssText,h.appendChild(i)}},Ft=wt?h=>h:h=>h instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return Me(e)})(h):h;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:ze,defineProperty:Ce,getOwnPropertyDescriptor:Ee,getOwnPropertyNames:qe,getOwnPropertySymbols:Ue,getPrototypeOf:Ne}=Object,O=globalThis,Dt=O.trustedTypes,Pe=Dt?Dt.emptyScript:"",Ke=O.reactiveElementPolyfillSupport,dt=(h,t)=>h,$t={toAttribute(h,t){switch(t){case Boolean:h=h?Pe:null;break;case Object:case Array:h=h==null?h:JSON.stringify(h)}return h},fromAttribute(h,t){let e=h;switch(t){case Boolean:e=h!==null;break;case Number:e=h===null?null:Number(h);break;case Object:case Array:try{e=JSON.parse(h)}catch{e=null}}return e}},Rt=(h,t)=>!ze(h,t),Ot={attribute:!0,type:String,converter:$t,reflect:!1,useDefault:!1,hasChanged:Rt};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),O.litPropertyMetadata??(O.litPropertyMetadata=new WeakMap);let X=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=Ot){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){const i=Symbol(),a=this.getPropertyDescriptor(t,i,e);a!==void 0&&Ce(this.prototype,t,a)}}static getPropertyDescriptor(t,e,i){const{get:a,set:s}=Ee(this.prototype,t)??{get(){return this[e]},set(r){this[e]=r}};return{get:a,set(r){const o=a?.call(this);s?.call(this,r),this.requestUpdate(t,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Ot}static _$Ei(){if(this.hasOwnProperty(dt("elementProperties")))return;const t=Ne(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(dt("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(dt("properties"))){const e=this.properties,i=[...qe(e),...Ue(e)];for(const a of i)this.createProperty(a,e[a])}const t=this[Symbol.metadata];if(t!==null){const e=litPropertyMetadata.get(t);if(e!==void 0)for(const[i,a]of e)this.elementProperties.set(i,a)}this._$Eh=new Map;for(const[e,i]of this.elementProperties){const a=this._$Eu(e,i);a!==void 0&&this._$Eh.set(a,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const a of i)e.unshift(Ft(a))}else t!==void 0&&e.push(Ft(t));return e}static _$Eu(t,e){const i=e.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Te(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$ET(t,e){const i=this.constructor.elementProperties.get(t),a=this.constructor._$Eu(t,i);if(a!==void 0&&i.reflect===!0){const s=(i.converter?.toAttribute!==void 0?i.converter:$t).toAttribute(e,i.type);this._$Em=t,s==null?this.removeAttribute(a):this.setAttribute(a,s),this._$Em=null}}_$AK(t,e){const i=this.constructor,a=i._$Eh.get(t);if(a!==void 0&&this._$Em!==a){const s=i.getPropertyOptions(a),r=typeof s.converter=="function"?{fromAttribute:s.converter}:s.converter?.fromAttribute!==void 0?s.converter:$t;this._$Em=a;const o=r.fromAttribute(e,s.type);this[a]=o??this._$Ej?.get(a)??o,this._$Em=null}}requestUpdate(t,e,i,a=!1,s){if(t!==void 0){const r=this.constructor;if(a===!1&&(s=this[t]),i??(i=r.getPropertyOptions(t)),!((i.hasChanged??Rt)(s,e)||i.useDefault&&i.reflect&&s===this._$Ej?.get(t)&&!this.hasAttribute(r._$Eu(t,i))))return;this.C(t,e,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:i,reflect:a,wrapped:s},r){i&&!(this._$Ej??(this._$Ej=new Map)).has(t)&&(this._$Ej.set(t,r??e??this[t]),s!==!0||r!==void 0)||(this._$AL.has(t)||(this.hasUpdated||i||(e=void 0),this._$AL.set(t,e)),a===!0&&this._$Em!==t&&(this._$Eq??(this._$Eq=new Set)).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[a,s]of this._$Ep)this[a]=s;this._$Ep=void 0}const i=this.constructor.elementProperties;if(i.size>0)for(const[a,s]of i){const{wrapped:r}=s,o=this[a];r!==!0||this._$AL.has(a)||o===void 0||this.C(a,void 0,s,o)}}let t=!1;const e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(e)):this._$EM()}catch(i){throw t=!1,this._$EM(),i}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&(this._$Eq=this._$Eq.forEach(e=>this._$ET(e,this[e]))),this._$EM()}updated(t){}firstUpdated(t){}};X.elementStyles=[],X.shadowRootOptions={mode:"open"},X[dt("elementProperties")]=new Map,X[dt("finalized")]=new Map,Ke?.({ReactiveElement:X}),(O.reactiveElementVersions??(O.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ot=globalThis,jt=h=>h,ft=ot.trustedTypes,Bt=ft?ft.createPolicy("lit-html",{createHTML:h=>h}):void 0,Ht="$lit$",j=`lit$${Math.random().toFixed(9).slice(2)}$`,Qt="?"+j,Le=`<${Qt}>`,Q=document,lt=()=>Q.createComment(""),ut=h=>h===null||typeof h!="object"&&typeof h!="function",At=Array.isArray,Fe=h=>At(h)||typeof h?.[Symbol.iterator]=="function",It=`[ 	
\f\r]`,ht=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Gt=/-->/g,Jt=/>/g,G=RegExp(`>|${It}(?:([^\\s"'>=/]+)(${It}*=${It}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Wt=/'/g,Vt=/"/g,Yt=/^(?:script|style|textarea|title)$/i,De=h=>(t,...e)=>({_$litType$:h,strings:t,values:e}),d=De(1),Z=Symbol.for("lit-noChange"),w=Symbol.for("lit-nothing"),Xt=new WeakMap,J=Q.createTreeWalker(Q,129);function Zt(h,t){if(!At(h)||!h.hasOwnProperty("raw"))throw Error("invalid template strings array");return Bt!==void 0?Bt.createHTML(t):t}const Re=(h,t)=>{const e=h.length-1,i=[];let a,s=t===2?"<svg>":t===3?"<math>":"",r=ht;for(let o=0;o<e;o++){const u=h[o];let c,g,_=-1,A=0;for(;A<u.length&&(r.lastIndex=A,g=r.exec(u),g!==null);)A=r.lastIndex,r===ht?g[1]==="!--"?r=Gt:g[1]!==void 0?r=Jt:g[2]!==void 0?(Yt.test(g[2])&&(a=RegExp("</"+g[2],"g")),r=G):g[3]!==void 0&&(r=G):r===G?g[0]===">"?(r=a??ht,_=-1):g[1]===void 0?_=-2:(_=r.lastIndex-g[2].length,c=g[1],r=g[3]===void 0?G:g[3]==='"'?Vt:Wt):r===Vt||r===Wt?r=G:r===Gt||r===Jt?r=ht:(r=G,a=void 0);const P=r===G&&h[o+1].startsWith("/>")?" ":"";s+=r===ht?u+Le:_>=0?(i.push(c),u.slice(0,_)+Ht+u.slice(_)+j+P):u+j+(_===-2?o:P)}return[Zt(h,s+(h[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]};class pt{constructor({strings:t,_$litType$:e},i){let a;this.parts=[];let s=0,r=0;const o=t.length-1,u=this.parts,[c,g]=Re(t,e);if(this.el=pt.createElement(c,i),J.currentNode=this.el.content,e===2||e===3){const _=this.el.content.firstChild;_.replaceWith(..._.childNodes)}for(;(a=J.nextNode())!==null&&u.length<o;){if(a.nodeType===1){if(a.hasAttributes())for(const _ of a.getAttributeNames())if(_.endsWith(Ht)){const A=g[r++],P=a.getAttribute(_).split(j),Y=/([.?@])?(.*)/.exec(A);u.push({type:1,index:s,name:Y[2],strings:P,ctor:Y[1]==="."?je:Y[1]==="?"?Be:Y[1]==="@"?He:vt}),a.removeAttribute(_)}else _.startsWith(j)&&(u.push({type:6,index:s}),a.removeAttribute(_));if(Yt.test(a.tagName)){const _=a.textContent.split(j),A=_.length-1;if(A>0){a.textContent=ft?ft.emptyScript:"";for(let P=0;P<A;P++)a.append(_[P],lt()),J.nextNode(),u.push({type:2,index:++s});a.append(_[A],lt())}}}else if(a.nodeType===8)if(a.data===Qt)u.push({type:2,index:s});else{let _=-1;for(;(_=a.data.indexOf(j,_+1))!==-1;)u.push({type:7,index:s}),_+=j.length-1}s++}}static createElement(t,e){const i=Q.createElement("template");return i.innerHTML=t,i}}function tt(h,t,e=h,i){if(t===Z)return t;let a=i!==void 0?e._$Co?.[i]:e._$Cl;const s=ut(t)?void 0:t._$litDirective$;return a?.constructor!==s&&(a?._$AO?.(!1),s===void 0?a=void 0:(a=new s(h),a._$AT(h,e,i)),i!==void 0?(e._$Co??(e._$Co=[]))[i]=a:e._$Cl=a),a!==void 0&&(t=tt(h,a._$AS(h,t.values),a,i)),t}class Oe{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,a=(t?.creationScope??Q).importNode(e,!0);J.currentNode=a;let s=J.nextNode(),r=0,o=0,u=i[0];for(;u!==void 0;){if(r===u.index){let c;u.type===2?c=new mt(s,s.nextSibling,this,t):u.type===1?c=new u.ctor(s,u.name,u.strings,this,t):u.type===6&&(c=new Qe(s,this,t)),this._$AV.push(c),u=i[++o]}r!==u?.index&&(s=J.nextNode(),r++)}return J.currentNode=Q,a}p(t){let e=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class mt{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,a){this.type=2,this._$AH=w,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=tt(this,t,e),ut(t)?t===w||t==null||t===""?(this._$AH!==w&&this._$AR(),this._$AH=w):t!==this._$AH&&t!==Z&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Fe(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==w&&ut(this._$AH)?this._$AA.nextSibling.data=t:this.T(Q.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,a=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=pt.createElement(Zt(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===a)this._$AH.p(e);else{const s=new Oe(a,this),r=s.u(this.options);s.p(e),this.T(r),this._$AH=s}}_$AC(t){let e=Xt.get(t.strings);return e===void 0&&Xt.set(t.strings,e=new pt(t)),e}k(t){At(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,a=0;for(const s of t)a===e.length?e.push(i=new mt(this.O(lt()),this.O(lt()),this,this.options)):i=e[a],i._$AI(s),a++;a<e.length&&(this._$AR(i&&i._$AB.nextSibling,a),e.length=a)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const i=jt(t).nextSibling;jt(t).remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class vt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,a,s){this.type=1,this._$AH=w,this._$AN=void 0,this.element=t,this.name=e,this._$AM=a,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=w}_$AI(t,e=this,i,a){const s=this.strings;let r=!1;if(s===void 0)t=tt(this,t,e,0),r=!ut(t)||t!==this._$AH&&t!==Z,r&&(this._$AH=t);else{const o=t;let u,c;for(t=s[0],u=0;u<s.length-1;u++)c=tt(this,o[i+u],e,u),c===Z&&(c=this._$AH[u]),r||(r=!ut(c)||c!==this._$AH[u]),c===w?t=w:t!==w&&(t+=(c??"")+s[u+1]),this._$AH[u]=c}r&&!a&&this.j(t)}j(t){t===w?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class je extends vt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===w?void 0:t}}class Be extends vt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==w)}}class He extends vt{constructor(t,e,i,a,s){super(t,e,i,a,s),this.type=5}_$AI(t,e=this){if((t=tt(this,t,e,0)??w)===Z)return;const i=this._$AH,a=t===w&&i!==w||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,s=t!==w&&(i===w||a);a&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class Qe{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){tt(this,t)}}const Ge=ot.litHtmlPolyfillSupport;Ge?.(pt,mt),(ot.litHtmlVersions??(ot.litHtmlVersions=[])).push("3.3.3");const Je=(h,t,e)=>{const i=e?.renderBefore??t;let a=i._$litPart$;if(a===void 0){const s=e?.renderBefore??null;i._$litPart$=a=new mt(t.insertBefore(lt(),s),s,void 0,e??{})}return a._$AI(h),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ct=globalThis;class q extends X{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;const t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Je(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Z}}q._$litElement$=!0,q.finalized=!0,ct.litElementHydrateSupport?.({LitElement:q});const We=ct.litElementPolyfillSupport;We?.({LitElement:q}),(ct.litElementVersions??(ct.litElementVersions=[])).push("4.2.2");var gt={};(function h(t,e,i,a){var s=!!(t.Worker&&t.Blob&&t.Promise&&t.OffscreenCanvas&&t.OffscreenCanvasRenderingContext2D&&t.HTMLCanvasElement&&t.HTMLCanvasElement.prototype.transferControlToOffscreen&&t.URL&&t.URL.createObjectURL),r=typeof Path2D=="function"&&typeof DOMMatrix=="function",o=(function(){if(!t.OffscreenCanvas)return!1;try{var l=new OffscreenCanvas(1,1),n=l.getContext("2d");n.fillRect(0,0,1,1);var p=l.transferToImageBitmap();n.createPattern(p,"no-repeat")}catch{return!1}return!0})();function u(){}function c(l){var n=e.exports.Promise,p=n!==void 0?n:t.Promise;return typeof p=="function"?new p(l):(l(u,u),null)}var g=(function(l,n){return{transform:function(p){if(l)return p;if(n.has(p))return n.get(p);var b=new OffscreenCanvas(p.width,p.height),f=b.getContext("2d");return f.drawImage(p,0,0),n.set(p,b),b},clear:function(){n.clear()}}})(o,new Map),_=(function(){var l=Math.floor(16.666666666666668),n,p,b={},f=0;return typeof requestAnimationFrame=="function"&&typeof cancelAnimationFrame=="function"?(n=function(v){var k=Math.random();return b[k]=requestAnimationFrame(function m(y){f===y||f+l-1<y?(f=y,delete b[k],v()):b[k]=requestAnimationFrame(m)}),k},p=function(v){b[v]&&cancelAnimationFrame(b[v])}):(n=function(v){return setTimeout(v,l)},p=function(v){return clearTimeout(v)}),{frame:n,cancel:p}})(),A=(function(){var l,n,p={};function b(f){function v(k,m){f.postMessage({options:k||{},callback:m})}f.init=function(m){var y=m.transferControlToOffscreen();f.postMessage({canvas:y},[y])},f.fire=function(m,y,S){if(n)return v(m,null),n;var I=Math.random().toString(36).slice(2);return n=c(function($){function M(z){z.data.callback===I&&(delete p[I],f.removeEventListener("message",M),n=null,g.clear(),S(),$())}f.addEventListener("message",M),v(m,I),p[I]=M.bind(null,{data:{callback:I}})}),n},f.reset=function(){f.postMessage({reset:!0});for(var m in p)p[m](),delete p[m]}}return function(){if(l)return l;if(!i&&s){var f=["var CONFETTI, SIZE = {}, module = {};","("+h.toString()+")(this, module, true, SIZE);","onmessage = function(msg) {","  if (msg.data.options) {","    CONFETTI(msg.data.options).then(function () {","      if (msg.data.callback) {","        postMessage({ callback: msg.data.callback });","      }","    });","  } else if (msg.data.reset) {","    CONFETTI && CONFETTI.reset();","  } else if (msg.data.resize) {","    SIZE.width = msg.data.resize.width;","    SIZE.height = msg.data.resize.height;","  } else if (msg.data.canvas) {","    SIZE.width = msg.data.canvas.width;","    SIZE.height = msg.data.canvas.height;","    CONFETTI = module.exports.create(msg.data.canvas);","  }","}"].join(`
`);try{l=new Worker(URL.createObjectURL(new Blob([f])))}catch(v){return typeof console<"u"&&typeof console.warn=="function"&&console.warn("\u{1F38A} Could not load worker",v),null}b(l)}return l}})(),P={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function Y(l,n){return n?n(l):l}function ee(l){return l!=null}function T(l,n,p){return Y(l&&ee(l[n])?l[n]:P[n],p)}function ie(l){return l<0?0:Math.floor(l)}function ae(l,n){return Math.floor(Math.random()*(n-l))+l}function kt(l){return parseInt(l,16)}function se(l){return l.map(re)}function re(l){var n=String(l).replace(/[^0-9a-f]/gi,"");return n.length<6&&(n=n[0]+n[0]+n[1]+n[1]+n[2]+n[2]),{r:kt(n.substring(0,2)),g:kt(n.substring(2,4)),b:kt(n.substring(4,6))}}function ne(l){var n=T(l,"origin",Object);return n.x=T(n,"x",Number),n.y=T(n,"y",Number),n}function de(l){l.width=document.documentElement.clientWidth,l.height=document.documentElement.clientHeight}function oe(l){var n=l.getBoundingClientRect();l.width=n.width,l.height=n.height}function le(l){var n=document.createElement("canvas");return n.style.position="fixed",n.style.top="0px",n.style.left="0px",n.style.pointerEvents="none",n.style.zIndex=l,n}function ue(l,n,p,b,f,v,k,m,y){l.save(),l.translate(n,p),l.rotate(v),l.scale(b,f),l.arc(0,0,1,k,m,y),l.restore()}function he(l){var n=l.angle*(Math.PI/180),p=l.spread*(Math.PI/180);return{x:l.x,y:l.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:l.startVelocity*.5+Math.random()*l.startVelocity,angle2D:-n+(.5*p-Math.random()*p),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:l.color,shape:l.shape,tick:0,totalTicks:l.ticks,decay:l.decay,drift:l.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:l.gravity*3,ovalScalar:.6,scalar:l.scalar,flat:l.flat}}function ce(l,n){n.x+=Math.cos(n.angle2D)*n.velocity+n.drift,n.y+=Math.sin(n.angle2D)*n.velocity+n.gravity,n.velocity*=n.decay,n.flat?(n.wobble=0,n.wobbleX=n.x+10*n.scalar,n.wobbleY=n.y+10*n.scalar,n.tiltSin=0,n.tiltCos=0,n.random=1):(n.wobble+=n.wobbleSpeed,n.wobbleX=n.x+10*n.scalar*Math.cos(n.wobble),n.wobbleY=n.y+10*n.scalar*Math.sin(n.wobble),n.tiltAngle+=.1,n.tiltSin=Math.sin(n.tiltAngle),n.tiltCos=Math.cos(n.tiltAngle),n.random=Math.random()+2);var p=n.tick++/n.totalTicks,b=n.x+n.random*n.tiltCos,f=n.y+n.random*n.tiltSin,v=n.wobbleX+n.random*n.tiltCos,k=n.wobbleY+n.random*n.tiltSin;if(l.fillStyle="rgba("+n.color.r+", "+n.color.g+", "+n.color.b+", "+(1-p)+")",l.beginPath(),r&&n.shape.type==="path"&&typeof n.shape.path=="string"&&Array.isArray(n.shape.matrix))l.fill(me(n.shape.path,n.shape.matrix,n.x,n.y,Math.abs(v-b)*.1,Math.abs(k-f)*.1,Math.PI/10*n.wobble));else if(n.shape.type==="bitmap"){var m=Math.PI/10*n.wobble,y=Math.abs(v-b)*.1,S=Math.abs(k-f)*.1,I=n.shape.bitmap.width*n.scalar,$=n.shape.bitmap.height*n.scalar,M=new DOMMatrix([Math.cos(m)*y,Math.sin(m)*y,-Math.sin(m)*S,Math.cos(m)*S,n.x,n.y]);M.multiplySelf(new DOMMatrix(n.shape.matrix));var z=l.createPattern(g.transform(n.shape.bitmap),"no-repeat");z.setTransform(M),l.globalAlpha=1-p,l.fillStyle=z,l.fillRect(n.x-I/2,n.y-$/2,I,$),l.globalAlpha=1}else if(n.shape==="circle")l.ellipse?l.ellipse(n.x,n.y,Math.abs(v-b)*n.ovalScalar,Math.abs(k-f)*n.ovalScalar,Math.PI/10*n.wobble,0,2*Math.PI):ue(l,n.x,n.y,Math.abs(v-b)*n.ovalScalar,Math.abs(k-f)*n.ovalScalar,Math.PI/10*n.wobble,0,2*Math.PI);else if(n.shape==="star")for(var x=Math.PI/2*3,E=4*n.scalar,U=8*n.scalar,N=n.x,L=n.y,H=5,K=Math.PI/H;H--;)N=n.x+Math.cos(x)*U,L=n.y+Math.sin(x)*U,l.lineTo(N,L),x+=K,N=n.x+Math.cos(x)*E,L=n.y+Math.sin(x)*E,l.lineTo(N,L),x+=K;else l.moveTo(Math.floor(n.x),Math.floor(n.y)),l.lineTo(Math.floor(n.wobbleX),Math.floor(f)),l.lineTo(Math.floor(v),Math.floor(k)),l.lineTo(Math.floor(b),Math.floor(n.wobbleY));return l.closePath(),l.fill(),n.tick<n.totalTicks}function pe(l,n,p,b,f){var v=n.slice(),k=l.getContext("2d"),m,y,S=c(function(I){function $(){m=y=null,k.clearRect(0,0,b.width,b.height),g.clear(),f(),I()}function M(){i&&!(b.width===a.width&&b.height===a.height)&&(b.width=l.width=a.width,b.height=l.height=a.height),!b.width&&!b.height&&(p(l),b.width=l.width,b.height=l.height),k.clearRect(0,0,b.width,b.height),v=v.filter(function(z){return ce(k,z)}),v.length?m=_.frame(M):$()}m=_.frame(M),y=$});return{addFettis:function(I){return v=v.concat(I),S},canvas:l,promise:S,reset:function(){m&&_.cancel(m),y&&y()}}}function zt(l,n){var p=!l,b=!!T(n||{},"resize"),f=!1,v=T(n,"disableForReducedMotion",Boolean),k=s&&!!T(n||{},"useWorker"),m=k?A():null,y=p?de:oe,S=l&&m?!!l.__confetti_initialized:!1,I=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,$;function M(x,E,U){for(var N=T(x,"particleCount",ie),L=T(x,"angle",Number),H=T(x,"spread",Number),K=T(x,"startVelocity",Number),fe=T(x,"decay",Number),ve=T(x,"gravity",Number),_e=T(x,"drift",Number),Et=T(x,"colors",se),ke=T(x,"ticks",Number),qt=T(x,"shapes"),ye=T(x,"scalar"),xe=!!T(x,"flat"),Ut=ne(x),Nt=N,xt=[],we=l.width*Ut.x,Se=l.height*Ut.y;Nt--;)xt.push(he({x:we,y:Se,angle:L,spread:H,startVelocity:K,color:Et[Nt%Et.length],shape:qt[ae(0,qt.length)],ticks:ke,decay:fe,gravity:ve,drift:_e,scalar:ye,flat:xe}));return $?$.addFettis(xt):($=pe(l,xt,y,E,U),$.promise)}function z(x){var E=v||T(x,"disableForReducedMotion",Boolean),U=T(x,"zIndex",Number);if(E&&I)return c(function(K){K()});p&&$?l=$.canvas:p&&!l&&(l=le(U),document.body.appendChild(l)),b&&!S&&y(l);var N={width:l.width,height:l.height};m&&!S&&m.init(l),S=!0,m&&(l.__confetti_initialized=!0);function L(){if(m){var K={getBoundingClientRect:function(){if(!p)return l.getBoundingClientRect()}};y(K),m.postMessage({resize:{width:K.width,height:K.height}});return}N.width=N.height=null}function H(){$=null,b&&(f=!1,t.removeEventListener("resize",L)),p&&l&&(document.body.contains(l)&&document.body.removeChild(l),l=null,S=!1)}return b&&!f&&(f=!0,t.addEventListener("resize",L,!1)),m?m.fire(x,N,H):M(x,N,H)}return z.reset=function(){m&&m.reset(),$&&$.reset()},z}var yt;function Ct(){return yt||(yt=zt(null,{useWorker:!0,resize:!0})),yt}function me(l,n,p,b,f,v,k){var m=new Path2D(l),y=new Path2D;y.addPath(m,new DOMMatrix(n));var S=new Path2D;return S.addPath(y,new DOMMatrix([Math.cos(k)*f,Math.sin(k)*f,-Math.sin(k)*v,Math.cos(k)*v,p,b])),S}function ge(l){if(!r)throw new Error("path confetti are not supported in this browser");var n,p;typeof l=="string"?n=l:(n=l.path,p=l.matrix);var b=new Path2D(n),f=document.createElement("canvas"),v=f.getContext("2d");if(!p){for(var k=1e3,m=k,y=k,S=0,I=0,$,M,z=0;z<k;z+=2)for(var x=0;x<k;x+=2)v.isPointInPath(b,z,x,"nonzero")&&(m=Math.min(m,z),y=Math.min(y,x),S=Math.max(S,z),I=Math.max(I,x));$=S-m,M=I-y;var E=10,U=Math.min(E/$,E/M);p=[U,0,0,U,-Math.round($/2+m)*U,-Math.round(M/2+y)*U]}return{type:"path",path:n,matrix:p}}function be(l){var n,p=1,b="#000000",f='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof l=="string"?n=l:(n=l.text,p="scalar"in l?l.scalar:p,f="fontFamily"in l?l.fontFamily:f,b="color"in l?l.color:b);var v=10*p,k=""+v+"px "+f,m=new OffscreenCanvas(v,v),y=m.getContext("2d");y.font=k;var S=y.measureText(n),I=Math.ceil(S.actualBoundingBoxRight+S.actualBoundingBoxLeft),$=Math.ceil(S.actualBoundingBoxAscent+S.actualBoundingBoxDescent),M=2,z=S.actualBoundingBoxLeft+M,x=S.actualBoundingBoxAscent+M;I+=M+M,$+=M+M,m=new OffscreenCanvas(I,$),y=m.getContext("2d"),y.font=k,y.fillStyle=b,y.fillText(n,z,x);var E=1/p;return{type:"bitmap",bitmap:m.transferToImageBitmap(),matrix:[E,0,0,E,-I*E/2,-$*E/2]}}e.exports=function(){return Ct().apply(this,arguments)},e.exports.reset=function(){Ct().reset()},e.exports.create=zt,e.exports.shapeFromPath=ge,e.exports.shapeFromText=be})((function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}})(),gt,!1);var Ve=gt.exports;gt.exports.create;class Mt extends D(F(q)){static get tag(){return"timer-kuis"}static get properties(){return{...super.properties,duration:{type:Number,attribute:"duration",reflect:!0},autostart:{type:Boolean,attribute:"autostart",reflect:!0},_remaining:{state:!0},_running:{state:!0},hideControls:{type:Boolean,attribute:"hide-controls",reflect:!0}}}constructor(){super(),this.duration=300,this.autostart=!1,this.hideControls=!1,this._remaining=this.duration,this._running=!1,this._intervalId=null,this.t={...this.t,title:"Waktu Kuis",start:"Mulai",pause:"Jeda",reset:"Ulang",done:"Waktu habis"}}connectedCallback(){super.connectedCallback(),this._remaining=this.duration,this.autostart&&this.start()}disconnectedCallback(){this._clearInterval(),super.disconnectedCallback()}updated(t){t.has("duration")&&!this._running&&(this._remaining=this.duration)}start(){this._running||(this._remaining<=0&&(this._remaining=this.duration),this._running=!0,this._clearInterval(),this._intervalId=setInterval(()=>this._tick(),1e3))}pause(){this._running=!1,this._clearInterval()}reset(){this._clearInterval(),this._running=!1,this._remaining=this.duration}_clearInterval(){this._intervalId&&(clearInterval(this._intervalId),this._intervalId=null)}_tick(){this._remaining>0&&(this._remaining-=1),this._remaining<=0&&(this._remaining=0,this._running=!1,this._clearInterval(),this._onExpire())}_onExpire(){this.dispatchEvent(new CustomEvent("timer-kuis-expired",{detail:{duration:this.duration},bubbles:!0,composed:!0}))}_format(t){const e=Math.floor(t/60),i=t%60;return`${String(e).padStart(2,"0")}:${String(i).padStart(2,"0")}`}static get styles(){return[super.styles,R`
        :host { display: block; }
        .timer-card {
    ...
    `}_renderMC(t,e){const i=["A","B","C","D","E","F"],a=e._correctMap?t.correctAnswers.map(s=>e._correctMap.indexOf(s)):t.correctAnswers;return d`
      <div class="choices-stack">
        ${t.pilihan.map((s,r)=>{let o="";this._answered&&!this.hideAnswers?a.includes(r)?o="correct":(t.isMulti?this._selectedAnswers.has(r):this._selected===r)&&(o="wrong"):(t.isMulti?this._selectedAnswers.has(r):this._selected===r)&&(o="selected");const u=this._answered,c=t.pilihanImages&&t.pilihanImages[r];return d`
            <button
            ...
            ${c?d`<br /><img class="choice-image" src="${c}" alt="Gambar pilihan ${i[r]||r+1}" loading="lazy" />`:""}</button>
          `})}
      </div>
                ...
                `:d`
                  <div style="display:flex;justify-content:space-between;align-items:center;gap:8px;flex-wrap:wrap;">
                    ...
                    <div style="display:flex;gap:6px;">
                      ...
                      <button class="btn-edit-soal" style="margin:0;padding:4px 10px;background-color:var(--ddd-theme-error);" @click=${()=>this._deleteQuestion(i)}>🗑️</button>
                    </div>
                  </div>
                `}
              </div>
    ...
    `}_renderKehadiran(){const t=this._weekly(),e=this._streak(),i=this._heatmap(),a=this._logs||[],s=this.thresholds,r=64,o=2*Math.PI*r,u=o-t.pct/100*o,c=["Sen","Sel","Rab","Kam","Jum","Sab","Min"];return d`
      <div class="c">
    ...
    `}static get haxProperties(){return{canScale:!1,canPosition:!0,canEditSource:!1,gizmo:{title:"Quiz User Auth",description:"Sistem login/registrasi siswa untuk dasbor-kuis",icon:"icons:account-circle",color:"purple",tags:["Education","Auth"]},settings:{configure:[{property:"appsScriptUrl",title:"Apps Script URL",inputMethod:"textfield",required:!0}],advanced:[],developer:[]},saveOptions:{unsetAttributes:["_screen","_nama","_email","_nis","_absen","_kelas","_studentId","_errorMsg","_successMsg","_loading"]}}}}globalThis.customElements.define(at.tag,at);class st extends D(F(q)){static get tag(){return"latihan-kuis"}static get properties(){return{...super.properties,appsScriptUrl:{type:String,attribute:"apps-script-url",reflect:!0},spreadsheetUrl:{type:String,attribute:"spreadsheet-url",reflect:!0},duration:{type:Number,attribute:"duration",reflect:!0},judulMateri:{type:String,attribute:"judul-materi",reflect:!0},teksMateri:{type:String,attribute:"teks-materi",reflect:!0},materiUrl:{type:String,attribute:"materi-url",reflect:!0},materiFile:{type:String,attribute:"materi-file",reflect:!0},coverImage:{type:String,attribute:"cover-image",reflect:!0},judulKuis:{type:String,attribute:"judul-kuis",reflect:!0},questions:{type:Array,attribute:"questions",reflect:!0},studentId:{type:String,attribute:"student-id",reflect:!0},studentName:{type:String,attribute:"student-name",reflect:!0},studentNis:{type:String,attribute:"student-nis",reflect:!0},studentAbsen:{type:String,attribute:"student-absen",reflect:!0},studentKelas:{type:String,attribute:"student-kelas",reflect:!0},kdMateri:{type:String,attribute:"kd-materi",reflect:!0},pesanWaktuHabis:{type:String,attribute:"pesan-waktu-habis",reflect:!0},pesanNilaiTerkirim:{type:String,attribute:"pesan-nilai-terkirim",reflect:!0},labelMulai:{type:String,attribute:"label-mulai",reflect:!0},showSheetLink:{type:Boolean,attribute:"show-sheet-link",reflect:!0},soalFileUrl:{type:String,attribute:"soal-file-url",reflect:!0},allowRetake:{type:Boolean,attribute:"allow-retake",reflect:!0},maxRetake:{type:Number,attribute:"max-retake",reflect:!0},mode:{type:String,attribute:"mode",reflect:!0},hidePauseRestart:{type:Boolean,attribute:"hide-pause-restart",reflect:!0},shuffleQuestions:{type:Boolean,attribute:"shuffle-questions",reflect:!0},shuffleChoices:{type:Boolean,attribute:"shuffle-choices",reflect:!0},kategori:{type:String,attribute:"kategori",reflect:!0},hideConfetti:{type:Boolean,attribute:"hide-confetti",reflect:!0},hideAnswers:{type:Boolean,attribute:"hide-answers",reflect:!0},hideScore:{type:Boolean,attribute:"hide-score",reflect:!0},_mulai:{state:!0},_selesai:{state:!0},_skor:{state:!0},_habisWaktu:{state:!0},_pesan:{state:!0},_bestSkor:{state:!0},_pernahIkut:{state:!0},_attemptKe:{state:!0},_terkunci:{state:!0}}}constructor(){super(),this.appsScriptUrl="",this.spreadsheetUrl="",this.duration=300,this.judulMateri="Materi Pembelajaran",this.teksMateri="Baca materi di bawah ini dengan saksama sebelum mengerjakan kuis. Waktu pengerjaan kuis dibatasi oleh timer; saat waktu habis, kuis akan dikunci dan nilai otomatis terkirim.",this.materiUrl="",this.materiFile="",this.coverImage="",this.judulKuis="Evaluasi Kuis Interaktif",this.questions=void 0,this.studentId="",this.studentName="",this.studentNis="",this.studentAbsen="",this.studentKelas="",this.kdMateri="",this.pesanWaktuHabis="\u23F0 Waktu habis! Kuis dikunci & dinilai otomatis.",this.pesanNilaiTerkirim="\u{1F389} Selamat! Nilai Anda sudah terkirim ke spreadsheet.",this.labelMulai="\u25B6\uFE0F Mulai Latihan",this.showSheetLink=!1,this.soalFileUrl="",this.allowRetake=!0,this.maxRetake=0,this.mode="siswa",this.hidePauseRestart=!0,this.shuffleQuestions=!1,this.shuffleChoices=!1,this.kategori="",this.hideConfetti=!1,this.hideAnswers=!1,this.hideScore=!1,this._mulai=!1,this._selesai=!1,this._skor=null,this._habisWaktu=!1,this._pesan="",this._bestSkor=null,this._pernahIkut=!1,this._attemptKe=0,this._terkunci=!1,this._onAuthLogout=this._onAuthLogout.bind(this),this.t={...this.t,bacaMateri:"\u{1F517} Buka URL Materi",unduhMateri:"\u{1F4CE} Unduh File Materi"}}connectedCallback(){if(super.connectedCallback(),globalThis.HaxStore&&typeof globalThis.HaxStore.requestAvailability=="function"){const t=globalThis.HaxStore.requestAvailability();t&&!t.elementList[st.tag]&&(t.elementList[st.tag]=st.haxProperties)}globalThis.addEventListener("quiz-user-login",this._onAuthLogin),globalThis.addEventListener("quiz-user-logout",this._onAuthLogout),this._loadSession(),this._muatStatusKuis()}disconnectedCallback(){globalThis.removeEventListener("quiz-user-login",this._onAuthLogin),globalThis.removeEventListener("quiz-user-logout",this._onAuthLogout),super.disconnectedCallback()}_onAuthLogin(t){const e=t&&t.detail||{};this._bestSkor=null,this._pernahIkut=!1,this._selesai=!1,this._habisWaktu=!1,this._skor=null,this._mulai=!1,this._terkunci=!1,this.studentId=e.studentId||"",this.studentName=e.nama||"",this.studentNis=e.nis||"",this.studentAbsen=e.absen||"",this.studentKelas=e.kelas||"",this._loadAttemptCounter(),this._muatStatusKuis()}_onAuthLogout(){this._bestSkor=null,this._pernahIkut=!1,this._selesai=!1,this._habisWaktu=!1,this._skor=null,this._mulai=!1,this._terkunci=!1,this._attemptKe=0,this.studentId="",this.studentName="",this.studentNis="",this.studentAbsen="",this.studentKelas=""}_loadSession(){try{const t=JSON.parse(globalThis.localStorage.getItem("quiz_user_session"));if(!t||!t.studentId)return;if(t.expiresAt&&Date.now()>t.expiresAt){globalThis.localStorage.removeItem("quiz_user_session");return}this.studentId=t.studentId||"",this.studentName=t.nama||"",this.studentNis=t.nis||"",this.studentAbsen=t.absen||"",this.studentKelas=t.kelas||""}catch{}this._loadAttemptCounter()}_attemptKey(){return`latihan_kuis_attempt_${this.studentId}_${this.kdMateri}`}_loadAttemptCounter(){if(!(!this.maxRetake||!this.studentId||!this.kdMateri))try{const t=globalThis.localStorage.getItem(this._attemptKey());this._attemptKe=parseInt(t,10)||0}catch{this._attemptKe=0}}_saveAttemptCounter(){if(!(!this.maxRetake||!this.studentId||!this.kdMateri))try{globalThis.localStorage.setItem(this._attemptKey(),String(this._attemptKe))}catch{}}_muatStatusKuis(){if(!this.appsScriptUrl||!this.studentId||!this.kdMateri)return;const t=`${this.appsScriptUrl}${this.appsScriptUrl.includes("?")?"&":"?"}action=getQuizLock&studentId=${encodeURIComponent(this.studentId)}&kdMateri=${encodeURIComponent(this.kdMateri)}`;return fetch(t,{method:"GET",mode:"cors"}).then(e=>e.json()).then(e=>{e&&(this._terkunci=!1,this._pernahIkut=typeof e.best=="number"&&e.best!=null,this._bestSkor=typeof e.best=="number"?e.best:null,!this.allowRetake&&e.locked&&(this._terkunci=!0,this._selesai=!1,this._skor=this._bestSkor))}).catch(()=>{}).finally(()=>this.requestUpdate())}_ulangiKuis(){this._selesai=!1,this._terkunci=!1,this._kunci=!1,this._habisWaktu=!1,this._skor=null,this._muatStatusKuis(),this._mulaiLatihan()}updated(t){super.updated(t),t.has("soalFileUrl")&&this.soalFileUrl&&this._muatSoalDariFile(this.soalFileUrl)}async _muatSoalDariFile(t){try{const e=await fetch(t);if(!e.ok)throw new Error("HTTP "+e.status);const i=await e.json();if(!Array.isArray(i))throw new Error("Bukan array JSON");this.questions=i,this._pesan=""}catch(e){this._pesan="Gagal memuat file soal: "+e.message}}_onWaktuHabis(){const t=this.shadowRoot&&this.shadowRoot.querySelector("kuis-ledakan");t&&t._screen!=="result"&&typeof t._selesaiKuis=="function"&&t._selesaiKuis(),this._selesai=!0,this._habisWaktu=!0}_onKuisLog(t){t.detail&&t.detail.payload&&typeof t.detail.payload.score=="number"&&(this._skor=t.detail.payload.score,this._selesai=!0,this.maxRetake&&(this._attemptKe++,this._saveAttemptCounter()),this._muatStatusKuis())}async _mulaiLatihan(){if(!this.studentId){this.requestUpdate();return}this._terkunci=!1,this._mulai=!0,await this.updateComplete;const t=this.shadowRoot&&this.shadowRoot.querySelector("kuis-ledakan"),e=this.shadowRoot&&this.shadowRoot.querySelector("timer-kuis");t&&typeof t._onStartClick=="function"&&t._onStartClick(),e&&typeof e.start=="function"&&e.start()}static get styles(){return[super.styles,R`
    ...
    `}_renderPantauanGuru(){const t=this._serverData.roster||[];if(t.length===0)return d`
      ...
      <div class="grid-heatmap">
        ${t.map(s=>{const r=this._num(s.nilaiAkhir),o=r>=75?"lvl-high":r>=60?"lvl-mid":"lvl-low",u=r>=75?{cls:"badge-good",txt:`${s.emoji||"\u2705"} LULUS`}:r>=60?{cls:"badge-warn",txt:`${s.emoji||"\u26A0\uFE0F"} PROSES`}:{cls:"badge-bad",txt:`${s.emoji||"\u{1F4ED}"} REMEDI`},c=(s.nama||"?").trim().charAt(0).toUpperCase(),g=["#4f46e5","#0891b2","#059669","#d97706","#db2777","#7c3aed"][(s.absen||"0").toString().length%6];return d`
            <div class="card-siswa ${o}">
              <div class="student-head">
                <div class="avatar-circle" style="background:${g};">${c}</div>
                <div>
...
`)}_eksporNilai(t){const e=this._filterPeringkat(this._buildPeringkat());if(!e.length){this._note="Belum ada baris untuk diekspor.",this.requestUpdate();return}const i="peringkat-bimbingan-"+String(this._peringkatKelas||this.kelas||"semua").replace(/[^a-zA-Z0-9-_]/g,"");if(t==="copas"){this._copasTSV=this._csvKerangka(e,"	"),this._note="Kotak TSV siap disalin \u2014 paste langsung ke Google Sheets / Excel.",this.requestUpdate();return}if(t==="csv"){const a="\uFEFF"+this._csvKerangka(e,",");this._downloadBlob(`${i}.csv`,a,"text/csv;charset=utf-8;")}else{const{headers:a,grid:s}=this._rowPeringkatKeCSV(e),r=a.map(c=>`<th>${this._hs(c)}</th>`).join(""),o=s.map(c=>`<tr>${c.map(g=>`<td>${this._hs(g)}</td>`).join("")}</tr>`).join(""),u=`<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel"><head><meta charset="utf-8"><!--[if gte mso 9]><xml><x:ExcelWorkbook><x:ExcelWorksheets><x:ExcelWorksheet><x:Name>Peringkat</x:Name><x:WorksheetOptions><x:DisplayGridlines/></x:WorksheetOptions></x:ExcelWorksheet></x:ExcelWorksheets></x:ExcelWorkbook></xml><![endif]--></head><body><table><thead><tr>${r}</tr></thead><tbody>${o}</tbody></table></body></html>`;this._downloadBlob(`${i}.xls`,u,"application/vnd.ms-excel;charset=utf-8;")}this._note=`\u2705 Ekspor ${t.toUpperCase()} selesai (${e.length} siswa).`,this.requestUpdate()}_downloadBlob(t,e,i){const a=new Blob([e],{type:i}),s=URL.createObjectURL(a),r=document.createElement("a");r.href=s,r.download=t,document.body.appendChild(r),r.click(),document.body.removeChild(r),setTimeout(()=>URL.revokeObjectURL(s),1500)}_hs(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}_renderHasilSiswa(){const t=this._serverData.siswa;if(!t)return d`
      ...
      `;const e=this._num(t.kehadiran),i=this._num(t.ulanganHarian&&(t.ulanganHarian.average||t.ulanganHarian.highest)||0),a=this._num(t.uts&&t.uts.highest||0),s=this._num(t.uas&&t.uas.highest||0),r=this._num(t.sikap),o=this._num(t.keterampilan),u=Math.round(parseFloat(t.nilaiAkhir)||0),c=String(t.grade||"-"),g=Math.max(0,Math.min(100,u))*3.6,_=[{label:"Kehadiran",value:e,unit:"%"},{label:"Rata-rata UH",value:i,unit:""},{label:"Skor UTS",value:a,unit:""},{label:"Skor UAS",value:s,unit:""},{label:"Sikap",value:r,unit:""},{label:"Keterampilan",value:o,unit:""}];return d`
      <h2 style="margin-top: 0; color: #1e293b;">🎯 Hasil & Nilai Evaluasi Anda</h2>
